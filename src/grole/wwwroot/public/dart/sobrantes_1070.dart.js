...
["sobrantes.dart", "sobrantes.dart", , K, {
llenaGrid: function() {
  W.HttpRequest_getString("/rest/sobrantes", null, null).then$1(new K.llenaGrid_closure());
},
...
main: function() {
  ...
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new K.main_closure()), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
},
...
llenaGrid_closure: {"": "Closure;",
  call$1: function(Data) {
    var pLista, tableLista, t1, t2, item, tr, t3, td, t4, t5, btn, t6, btnEliminar;
    ...
    for (t1 = J.get$iterator$ax(pLista), t2 = J.getInterceptor$x(tableLista); t1.moveNext$0();) {
      ...
      tr.id = "tr" + H.S(J.toString$0(t3.$index(item, "id")));
      ...
      t5.add$1(t5, td);
      td = document.createElement("td", null);
      td.textContent = t3.$index(item, "activo");
      t5 = t4.get$children(tr);
      t5.add$1(t5, td);
      btn = W.Element_Element$html("<button class='btn'><i class='icon-edit'></i></button>", null, null);
      t5 = J.getInterceptor$x(btn);
      t5.set$id(btn, "btnEditar" + H.S(J.toString$0(t3.$index(item, "id"))));
      t5.get$onClick(btn).listen$1(new K.llenaGrid__closure(item));
      td = document.createElement("td", null);
      t5 = J.getInterceptor$x(td);
      t6 = t5.get$children(td);
      t6.add$1(t6, btn);
      t6 = t4.get$children(tr);
      t6.add$1(t6, td);
      btnEliminar = W.Element_Element$html("<button class='btn'><i class='icon-trash'></i></button>", null, null);
      t6 = J.getInterceptor$x(btnEliminar);
      t6.set$id(btnEliminar, "btnEliminar" + H.S(J.toString$0(t3.$index(item, "id"))));
      t6.get$onClick(btnEliminar).listen$1(new K.llenaGrid__closure0(item));
      t5 = t5.get$children(td);
      t5.add$1(t5, btnEliminar);
...
llenaGrid__closure: {"": "Closure;item_0",
  call$1: function(_) {
    J.set$href$x(C.Window_methods.get$location(window), "/sobrantes/" + H.S(J.$index$asx(this.item_0, "id")));
  }
},

llenaGrid__closure0: {"": "Closure;item_1",
  call$1: function(_) {
    var t1;
    if (window.confirm("\u00bfEliminar Formula de Producci\u00f3n?") === true) {
      t1 = this.item_1;
      W.HttpRequest_request("/rest/sobrantes/eliminar/" + H.S(J.$index$asx(t1, "id")), "DELETE", null, null, null, null, "", null).then$1(new K.llenaGrid___closure(t1));
    }
  }
},

llenaGrid___closure: {"": "Closure;item_2",
  call$1: function(ARequest) {
    var t1 = "#tr" + H.S(J.toString$0(J.$index$asx(this.item_2, "id")));
...
main_closure: {"": "Closure;",
  call$1: function(_) {
    J.set$href$x(C.Window_methods.get$location(window), "/sobrantes/0");
  }
}},
1],
]);
...
//# sourceMappingURL=sobrantes.dart.js.map
//@ sourceMappingURL=sobrantes.dart.js.map
