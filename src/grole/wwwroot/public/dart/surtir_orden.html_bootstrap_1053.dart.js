...
Produccion$fromMap: function(AMapa) {
  var t1 = $.Observable_$_nextHashCode + 1;
  $.Observable_$_nextHashCode = t1;
  t1 = new M.Produccion(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t1);
...
OrdenMP: {"": "Observable;_OrdenPP$__$id,_OrdenPP$__$id_orden,_OrdenPP$__$producto,_OrdenPP$__$codigosap<,_OrdenPP$__$descripcion,_OrdenPP$__$kilos,_OrdenPP$__$surtido<,_OrdenPP$__$producido,_OrdenPP$__$rendimiento,_OrdenPP$__$costo_salida,_OrdenPP$__$importe_salida,_OrdenPP$__$saldo_sap,$$_observers,$$_changes,hashCode",
  get$id: function(_) {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this, 1, "id");
...
OrdenMP$FromMap: function(AMap) {
  var t1 = $.Observable_$_nextHashCode + 1;
  $.Observable_$_nextHashCode = t1;
  t1 = new T.OrdenMP(null, null, null, null, null, null, null, null, null, null, null, null, null, null, t1);
...
Element: {"": "Node;className%,style=,tagName=",
...
InputElement: {"": "HtmlElement;name=,type=,value%", $isInputElement: true, $isElement: true, $isNode: true, $isEventTarget: true, "%": "HTMLInputElement"},
...
seleccionar_salida: function() {
  ...
  $.Observable_$_nextHashCode = t1;
  pOrdenPP = new T.OrdenMP(null, null, null, null, null, null, null, null, null, null, null, null, null, null, t1);
...
GeneraSalidaSap: function() {
  ...
  if (!J.$eq(J.get$value$x(document.querySelector("#mPassword")), "soles123")) {
...
init_autogenerated: function() {
  var __root, __html0, __html1, __html2, __html3, __html4, __t, t1, __e2, t2, __e85, t3, __e86, __e88, __e90, __e92;
  ...
  if (1 >= t2.length)
    throw H.ioore(t2, 1);
  t2 = J.get$nodes$x(t2[1]);
  __t.listen$2(J.get$onClick$x(J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(t2.$index(t2, 3)), 11)), 7)), 1)), 1)), 1)), 11)), 0)), new V.init_autogenerated_closure4());
  t2 = new W._ChildNodeListLazy(__root)._this.childNodes;
  if (1 >= t2.length)
    throw H.ioore(t2, 1);
  t2 = J.get$nodes$x(t2[1]);
  ...
  t2 = new Z.Modal(null, null, false, false, t2, null, null, H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), new F.ScopedCssMapper(H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null))), null, null, null, H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)));
  t2.set$host(t2, __e86);
  t1.push(new V.ComponentItem(t2));
  t2 = new W._ChildNodeListLazy(__root)._this.childNodes;
  if (13 >= t2.length)
    throw H.ioore(t2, 13);
  __e88 = t2[13];
  t2 = J.get$nodes$x(__e88);
  ...
  t3.Css3TransitionEffect$2("-webkit-transform", t2);
  t3 = new Z.Modal(null, null, false, false, t3, null, null, H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), new F.ScopedCssMapper(H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null))), null, null, null, H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)));
  t3.set$host(t3, __e88);
  t1.push(new V.ComponentItem(t3));
  t3 = new W._ChildNodeListLazy(__root)._this.childNodes;
  if (15 >= t3.length)
    throw H.ioore(t3, 15);
  __e90 = t3[15];
  t3 = J.get$nodes$x(__e90);
...
init_autogenerated_closure5: {"": "Closure;__html0_0",
  call$3: function($$list, $$index, __t) {
    var item, __e24, t1, t2, __e8, __binding7, __e10, __binding9, __e12, __binding11, __e14, __binding13, __e16, __binding15, __e18, __binding17, __e20, __binding19, __e22, __binding21;
    item = J.$index$asx($$list, $$index);
    __e24 = J.clone$1$x(this.__html0_0, true);
    t1 = J.getInterceptor$x(__e24);
    t2 = t1.get$nodes(__e24)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e8 = t2.$index(t2, 1);
    ...
    t1 = t1.get$nodes(__e24)._this.childNodes;
    if (1 >= t1.length)
      throw H.ioore(t1, 1);
    t1 = J.get$nodes$x(t1[1]);
    __t.listen$2(J.get$onClick$x(J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(t1.$index(t1, 17)), 0)), 0)), new V.init_autogenerated__closure7(item));
    J.add$1$ax(J.get$nodes$x(__t), __e24);
  },
  $isFunction: true
},
...
init_autogenerated__closure4: {"": "Closure;item_6",
  call$0: function() {
    var t1 = T.NumberFormat_NumberFormat("###0.00", null);
    return t1.format$1(t1, this.item_6.get$saldo_sap());
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated__closure5: {"": "Closure;item_7",
  call$0: function() {
    var t1 = T.NumberFormat_NumberFormat("###0.00", null);
    return t1.format$1(t1, this.item_7.get$costo_salida());
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated__closure6: {"": "Closure;item_8",
  call$0: function() {
    var t1 = T.NumberFormat_NumberFormat("###0.00", null);
    return t1.format$1(t1, this.item_8.get$importe_salida());
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated_closure8: {"": "Closure;__html1_10",
  call$3: function($$list, $$index, __t) {
    var item, __e50, t1, t2, __e28, __binding27, __e30, __binding29, __e32, __binding31, __e34, __binding33, __e36, __binding35, __e38, __binding37, __e40, __binding39, __e42, __binding41, __e44, __binding43, __e46, __binding45, __e48, __binding47;
    item = J.$index$asx($$list, $$index);
    __e50 = J.clone$1$x(this.__html1_10, true);
    t1 = J.getInterceptor$x(__e50);
    t2 = t1.get$nodes(__e50)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e28 = t2.$index(t2, 1);
    __binding27 = __t.contentBind$2(new V.init_autogenerated__closure8(item), false);
    J.add$1$ax(J.get$nodes$x(__e28), __binding27);
    t2 = t1.get$nodes(__e50)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    ...
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e38 = t2.$index(t2, 11);
    __binding37 = __t.contentBind$2(new V.init_autogenerated__closure13(item), false);
    J.addAll$1$ax(J.get$nodes$x(__e38), [__binding37, document.createTextNode("%")]);
    t2 = t1.get$nodes(__e50)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e40 = J.$index$asx(J.get$nodes$x(t2.$index(t2, 13)), 0);
    __binding39 = __t.contentBind$2(new V.init_autogenerated__closure14(item), false);
    t2 = J.getInterceptor$x(__e40);
    J.add$1$ax(t2.get$nodes(__e40), __binding39);
    __t.listen$2(t2.get$onClick(__e40), new V.init_autogenerated__closure15(item));
    t2 = t1.get$nodes(__e50)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e42 = t2.$index(t2, 15);
    __binding41 = __t.contentBind$2(new V.init_autogenerated__closure16(item), false);
    J.add$1$ax(J.get$nodes$x(__e42), __binding41);
    t2 = t1.get$nodes(__e50)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e44 = t2.$index(t2, 17);
    __binding43 = __t.contentBind$2(new V.init_autogenerated__closure17(item), false);
    J.add$1$ax(J.get$nodes$x(__e44), __binding43);
    t2 = t1.get$nodes(__e50)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e46 = t2.$index(t2, 19);
    ...
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e48 = t2.$index(t2, 21);
    __binding47 = __t.contentBind$2(new V.init_autogenerated__closure19(item), false);
    J.add$1$ax(J.get$nodes$x(__e48), __binding47);
    t1 = t1.get$nodes(__e50)._this.childNodes;
    if (1 >= t1.length)
      throw H.ioore(t1, 1);
    t1 = J.get$nodes$x(t1[1]);
    __t.listen$2(J.get$onClick$x(J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(t1.$index(t1, 23)), 0)), 0)), new V.init_autogenerated__closure20(item));
    J.add$1$ax(J.get$nodes$x(__t), __e50);
  },
  $isFunction: true
},

init_autogenerated__closure8: {"": "Closure;item_11",
  call$0: function() {
    return this.item_11.get$clave_producto();
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated__closure9: {"": "Closure;item_12",
  call$0: function() {
    return this.item_12.get$codigosap();
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated__closure10: {"": "Closure;item_13",
  call$0: function() {
    return this.item_13.get$nombre_producto();
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated__closure11: {"": "Closure;item_14",
  call$0: function() {
    var t1 = T.NumberFormat_NumberFormat("###0.00", null);
    return t1.format$1(t1, this.item_14.get$programado());
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated__closure12: {"": "Closure;item_15",
  call$0: function() {
    var t1 = T.NumberFormat_NumberFormat("###0.00", null);
    return t1.format$1(t1, this.item_15.get$producido());
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated__closure13: {"": "Closure;item_16",
  call$0: function() {
    var t1 = T.NumberFormat_NumberFormat("###0.00", null);
    return t1.format$1(t1, this.item_16.get$porcentaje());
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated__closure15: {"": "Closure;item_18",
  call$1: function($$event) {
    V.detalleProducido(this.item_18);
  },
  $isFunction: true
},
...
init_autogenerated__closure16: {"": "Closure;item_19",
  call$0: function() {
    var t1 = T.NumberFormat_NumberFormat("###0.00", null);
    return t1.format$1(t1, this.item_19.get$costo_maquila());
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated__closure17: {"": "Closure;item_20",
  call$0: function() {
    var t1 = T.NumberFormat_NumberFormat("###0.00", null);
    return t1.format$1(t1, this.item_20.get$importe_maquila());
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated__closure18: {"": "Closure;item_21",
  call$0: function() {
    var t1 = T.NumberFormat_NumberFormat("###0.00", null);
    return t1.format$1(t1, this.item_21.get$valor_rescate());
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated__closure19: {"": "Closure;item_22",
  call$0: function() {
    var t1 = T.NumberFormat_NumberFormat("###0.00", null);
    return t1.format$1(t1, this.item_22.get$importe_rescate());
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated_closure13: {"": "Closure;__html2_24",
  call$3: function($$list, $$index, __t) {
    var item, __e63, t1, t2, __e56, __binding55, __e58, __binding57, __e60, __binding59, __e62, __binding61;
    item = J.$index$asx($$list, $$index);
    __e63 = J.clone$1$x(this.__html2_24, true);
    t1 = J.getInterceptor$x(__e63);
    t2 = t1.get$nodes(__e63)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e56 = t2.$index(t2, 1);
    __binding55 = __t.contentBind$2(new V.init_autogenerated__closure21(item), false);
    J.add$1$ax(J.get$nodes$x(__e56), __binding55);
    t2 = t1.get$nodes(__e63)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e58 = t2.$index(t2, 3);
    __binding57 = __t.contentBind$2(new V.init_autogenerated__closure22(item), false);
    J.add$1$ax(J.get$nodes$x(__e58), __binding57);
    t2 = t1.get$nodes(__e63)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e60 = t2.$index(t2, 5);
    __binding59 = __t.contentBind$2(new V.init_autogenerated__closure23(item), false);
    J.add$1$ax(J.get$nodes$x(__e60), __binding59);
    t1 = t1.get$nodes(__e63)._this.childNodes;
    if (1 >= t1.length)
      throw H.ioore(t1, 1);
    t1 = J.get$nodes$x(t1[1]);
    __e62 = t1.$index(t1, 7);
    __binding61 = __t.contentBind$2(new V.init_autogenerated__closure24(item), false);
    J.add$1$ax(J.get$nodes$x(__e62), __binding61);
    J.add$1$ax(J.get$nodes$x(__t), __e63);
  },
  $isFunction: true
},

init_autogenerated__closure21: {"": "Closure;item_25",
  call$0: function() {
    return this.item_25.get$tarimaOrigen();
  },
  $isFunction: true,
  $is_void_: true
},

init_autogenerated__closure22: {"": "Closure;item_26",
  call$0: function() {
    return this.item_26.get$producto();
  },
  $isFunction: true,
  $is_void_: true
},

init_autogenerated__closure23: {"": "Closure;item_27",
  call$0: function() {
    return this.item_27.get$codigoBarras();
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated__closure24: {"": "Closure;item_28",
  call$0: function() {
    var t1 = T.NumberFormat_NumberFormat("#,##0.00", null);
    return t1.format$1(t1, this.item_28.get$peso());
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated_closure16: {"": "Closure;__html3_29",
  call$3: function($$list, $$index, __t) {
    var item, __e74, t1, t2, __e67, __binding66, __e69, __binding68, __e71, __binding70, __e73, __binding72;
    item = J.$index$asx($$list, $$index);
    __e74 = J.clone$1$x(this.__html3_29, true);
    t1 = J.getInterceptor$x(__e74);
    t2 = t1.get$nodes(__e74)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e67 = t2.$index(t2, 1);
    __binding66 = __t.contentBind$2(new V.init_autogenerated__closure25(item), false);
    J.add$1$ax(J.get$nodes$x(__e67), __binding66);
    t2 = t1.get$nodes(__e74)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e69 = t2.$index(t2, 3);
    __binding68 = __t.contentBind$2(new V.init_autogenerated__closure26(item), false);
    J.add$1$ax(J.get$nodes$x(__e69), __binding68);
    t2 = t1.get$nodes(__e74)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e71 = t2.$index(t2, 5);
    __binding70 = __t.contentBind$2(new V.init_autogenerated__closure27(item), false);
    J.add$1$ax(J.get$nodes$x(__e71), __binding70);
    t1 = t1.get$nodes(__e74)._this.childNodes;
    if (1 >= t1.length)
      throw H.ioore(t1, 1);
    t1 = J.get$nodes$x(t1[1]);
    __e73 = t1.$index(t1, 7);
    __binding72 = __t.contentBind$2(new V.init_autogenerated__closure28(item), false);
    J.add$1$ax(J.get$nodes$x(__e73), __binding72);
    J.add$1$ax(J.get$nodes$x(__t), __e74);
  },
  $isFunction: true
},

init_autogenerated__closure25: {"": "Closure;item_30",
  call$0: function() {
    return this.item_30.get$tarimaOrigen();
  },
  $isFunction: true,
  $is_void_: true
},

init_autogenerated__closure26: {"": "Closure;item_31",
  call$0: function() {
    return this.item_31.get$producto();
  },
  $isFunction: true,
  $is_void_: true
},

init_autogenerated__closure27: {"": "Closure;item_32",
  call$0: function() {
    return this.item_32.get$codigoBarras();
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated__closure28: {"": "Closure;item_33",
  call$0: function() {
    var t1 = T.NumberFormat_NumberFormat("#,##0.00", null);
    return t1.format$1(t1, this.item_33.get$peso());
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated_closure19: {"": "Closure;__html4_34",
  call$3: function($$list, $$index, __t) {
    var item, __e83, t1, t2, __e78, __binding77, __e80, __binding79, __e82, __binding81;
    item = J.$index$asx($$list, $$index);
    __e83 = J.clone$1$x(this.__html4_34, true);
    t1 = J.getInterceptor$x(__e83);
    t2 = t1.get$nodes(__e83)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e78 = t2.$index(t2, 1);
    __binding77 = __t.contentBind$2(new V.init_autogenerated__closure29(item), false);
    J.add$1$ax(J.get$nodes$x(__e78), __binding77);
    t2 = t1.get$nodes(__e83)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e80 = J.$index$asx(J.get$nodes$x(t2.$index(t2, 3)), 0);
    __binding79 = __t.contentBind$2(new V.init_autogenerated__closure30(item), false);
    t2 = J.getInterceptor$x(__e80);
    J.add$1$ax(t2.get$nodes(__e80), __binding79);
    __t.listen$2(t2.get$onClick(__e80), new V.init_autogenerated__closure31(item));
    t1 = t1.get$nodes(__e83)._this.childNodes;
    if (1 >= t1.length)
      throw H.ioore(t1, 1);
    t1 = J.get$nodes$x(t1[1]);
    __e82 = t1.$index(t1, 5);
    ...
    J.add$1$ax(J.get$nodes$x(__t), __e83);
  },
  $isFunction: true
},

init_autogenerated__closure29: {"": "Closure;item_35",
  call$0: function() {
    return this.item_35.get$tarimaOrigen();
  },
  $isFunction: true,
  $is_void_: true
},

init_autogenerated__closure30: {"": "Closure;item_36",
  call$0: function() {
    return this.item_36.get$cajas();
  },
  $isFunction: true,
  $is_void_: true
},

init_autogenerated__closure31: {"": "Closure;item_37",
  call$1: function($$event) {
    V.detalladoTarima(this.item_37.get$tarimaOrigen());
  },
  $isFunction: true
},
...
init_autogenerated__closure32: {"": "Closure;item_38",
  call$0: function() {
    var t1 = T.NumberFormat_NumberFormat("#,##0.00", null);
    return t1.format$1(t1, this.item_38.get$kilos());
  },
  $isFunction: true,
  $is_void_: true
},
