...
// Classes
$$.destino = {"": "Object;clave@,nombredestino@"};

$$.agregar_anon = {"": "Closure;p_destino_0,req_1",
  call$1: function(data) {
    ...
    if (t1.readyState === 4) {
      ...
      t2 = false;
    if (t2) {
      t2 = $.$index$asx($.parse(t1.responseText, null), "clave");
      t3 = this.p_destino_0;
      t3.clave = t2;
      $.add$1$ax($.get$lista_destino(), t3);
      $.dispatch();
      $.set$value$x($.query$1$x(document, "#clave"), "1");
      $.set$value$x($.query$1$x(document, "#nombredestino"), "");
      $.focus$0$x($.query$1$x(document, "#nombredestino"));
    }
  },
  $isFunction: true
};

$$.agregar_anon0 = {"": "Closure;p_destino_2",
  call$1: function(x) {
    return $.$eq(x.get$clave(), this.p_destino_2.clave);
  },
  $isFunction: true
};
...
$$.init_autogenerated_anon1 = {"": "Closure;__html0_0",
  call$1: function(__t) {
    $.add$1$ax(__t, $.clone$1$x(this.__html0_0, true));
  },
  $isFunction: true
};
...
$$.init_autogenerated_anon2 = {"": "Closure;",
  call$0: function() {
    return $.permite_edicion;
  },
  $isFunction: true
};

$$.init_autogenerated_anon3 = {"": "Closure;__html1_1,__html2_2,__html3_3",
  call$1: function(__t) {
    var __e7 = $.clone$1$x(this.__html1_1, true);
    __t.conditional$3($.query$1$x(__e7, "#__e-6"), new $.init_autogenerated__anon1(), new $.init_autogenerated__anon2(this.__html2_2, this.__html3_3));
    $.add$1$ax(__t, __e7);
  },
  $isFunction: true
};
...
$$.init_autogenerated__anon2 = {"": "Closure;__html2_4,__html3_5",
  call$1: function(__t) {
    var __e5, t1;
    __e5 = $.clone$1$x(this.__html2_4, true);
    t1 = $.getInterceptor$x(__e5);
    __t.listen$2($.get$onClick$x(t1.query$1(__e5, "#btnAgregar")), new $.init_autogenerated___anon3());
    __t.conditional$3(t1.query$1(__e5, "#__e-4"), new $.init_autogenerated___anon4(), new $.init_autogenerated___anon5(this.__html3_5));
    $.add$1$ax(__t, __e5);
  },
  $isFunction: true
};
...
$$.init_autogenerated___anon4 = {"": "Closure;",
  call$0: function() {
    return $.modo_insercion !== true;
  },
  $isFunction: true
};

$$.init_autogenerated___anon5 = {"": "Closure;__html3_6",
  call$1: function(__t) {
    var __e3 = $.clone$1$x(this.__html3_6, true);
    __t.listen$2($.get$onClick$x(__e3), new $.init_autogenerated____anon1());
    $.add$1$ax(__t, __e3);
  },
  $isFunction: true
};

$$.init_autogenerated____anon1 = {"": "Closure;",
  call$1: function($$event) {
    $.set$value$x($.query$1$x(document, "#clave"), "1");
    $.set$value$x($.query$1$x(document, "#nombredestino"), "");
    $.focus$0$x($.query$1$x(document, "#nombredestino"));
    $.modo_insercion = true;
    $.set$value$x($.query$1$x(document, "#btnAgregar"), "Agregar");
  },
  $isFunction: true
};
...
$$.init_autogenerated_anon4 = {"": "Closure;",
  call$0: function() {
    return $.get$lista_destino();
  },
  $isFunction: true
};

$$.init_autogenerated_anon5 = {"": "Closure;__html4_7,__html5_8,__html6_9",
  call$2: function(item, __t) {
    var __e18 = $.clone$1$x(this.__html4_7, true);
    __t.conditional$3(__e18, new $.init_autogenerated__anon(), new $.init_autogenerated__anon0(this.__html5_8, this.__html6_9, item));
    $.addAll$1$ax(__t, [document.createTextNode("\n          "), __e18, document.createTextNode("\n        ")]);
  },
  $isFunction: true
};
...
$$.init_autogenerated__anon0 = {"": "Closure;__html5_10,__html6_11,item_12",
  call$1: function(__t) {
    var __e17, t1, __e10, t2, __binding9, t3, __e12, __binding11;
    __e17 = $.clone$1$x(this.__html5_10, true);
    t1 = $.getInterceptor$x(__e17);
    __e10 = t1.query$1(__e17, "#__e-10");
    t2 = this.item_12;
    __binding9 = __t.contentBind$2(new $.init_autogenerated___anon(t2), false);
    t3 = $.get$nodes$x(__e10);
    t3.add$1(t3, __binding9);
    __e12 = t1.query$1(__e17, "#__e-12");
    __binding11 = __t.contentBind$2(new $.init_autogenerated___anon0(t2), false);
    t3 = $.get$nodes$x(__e12);
    t3.add$1(t3, __binding11);
    __t.conditional$3(t1.query$1(__e17, "#__e-16"), new $.init_autogenerated___anon1(), new $.init_autogenerated___anon2(this.__html6_11, t2));
    $.add$1$ax(__t, __e17);
  },
  $isFunction: true
};

$$.init_autogenerated___anon = {"": "Closure;item_13",
  call$0: function() {
    return this.item_13.get$clave();
  },
  $isFunction: true
};

$$.init_autogenerated___anon0 = {"": "Closure;item_14",
  call$0: function() {
    return this.item_14.get$nombredestino();
  },
  $isFunction: true
};
...
$$.init_autogenerated___anon1 = {"": "Closure;",
  call$0: function() {
    return $.modo_insercion === true && $.permite_edicion === true;
  },
  $isFunction: true
};

$$.init_autogenerated___anon2 = {"": "Closure;__html6_15,item_16",
  call$1: function(__t) {
    var __e15, t1, t2, t3;
    __e15 = $.clone$1$x(this.__html6_15, true);
    t1 = $.getInterceptor$x(__e15);
    t2 = $.get$onClick$x(t1.query$1(__e15, "#__e-13"));
    t3 = this.item_16;
    __t.listen$2(t2, new $.init_autogenerated____anon(t3));
    __t.listen$2($.get$onClick$x(t1.query$1(__e15, "#__e-14")), new $.init_autogenerated____anon0(t3));
    $.add$1$ax(__t, __e15);
  },
  $isFunction: true
};

$$.init_autogenerated____anon = {"": "Closure;item_17",
  call$1: function($$event) {
    $.eliminar(this.item_17);
  },
  $isFunction: true
};

$$.init_autogenerated____anon0 = {"": "Closure;item_18",
  call$1: function($$event) {
    $.despliega_clase(this.item_18);
...
$$._ConstantMapKeyIterable = {"": "Iterable;_liblib7$_map",
  get$iterator: function(_) {
...
$$._JsSerializer = {"": "_Serializer;_nextFreeRefId,_visited",
  ...
  visitNativeJsSendPort$1: function(port) {
    return ["sendport", $globalState.currentManagerId, port._isolateId, port._receivePort.get$_liblib3$_id()];
  },
  visitIsolateSink$1: function(sink) {
...
$$._ForwardingStreamSubscription = {"": "_BaseStreamSubscription;_stream,_unsubscribeOnError,_liblib4$_subscription,_liblib4$_onData,_onError,_onDone",
  ...
  _ForwardingStreamSubscription$5: function(_stream, onData, onError, onDone, _unsubscribeOnError) {
    ...
    this._liblib4$_subscription = this._stream._liblib4$_source.listen$3$onDone$onError(t1, this.get$_handleDone(), t2);
  }
};
...
$$._HashMapTable = {"": "_HashTable;_table,_capacity,_entryCount,_deletedCount,_modificationCount,_container",
  ...
  _liblib1$_value$1: function(offset) {
    var t1, t3;
    if (typeof offset !== "number")
      return this._liblib1$_value$1$bailout(1, offset);
    t1 = this._table;
    if (typeof t1 !== "object" || t1 === null || (t1.constructor !== Array || !!t1.immutable$list) && !t1.$isJavaScriptIndexingBehavior())
      return this._liblib1$_value$1$bailout(2, offset, t1);
    t3 = offset + 1;
    if (t3 !== (t3 | 0))
      throw $.iae(t3);
  ...
  _liblib1$_value$1$bailout: function(state0, offset, t1) {
    switch (state0) {
      case 0:
      case 1:
        state0 = 0;
...
$$.HashMap = {"": "Object;_hashTable<",
  ...
  $index: function(_, key) {
    ...
    if ($.$ge$n(offset, 0))
      return t1._liblib1$_value$1(offset);
    return;
  },
  ...
  remove$1: function(_, key) {
    ...
    if ($.$lt$n(offset, 0))
      return;
    oldValue = t1._liblib1$_value$1(offset);
  ...
  forEach$1: function(_, action) {
    ...
    for (t2 = table.length, offset = 0; offset < t2; offset += entrySize) {
      ...
      if (!t1._isFree$1(entry)) {
        action.call$2(entry, t1._liblib1$_value$1(offset));
...
$$.LinkedHashMap = {"": "Object;_hashTable<",
  ...
  forEach$1: function(_, action) {
    ...
    t1 = this._hashTable;
    modificationCount = t1._modificationCount;
    offset = t1._liblib1$_next$1(0);
    if (typeof offset !== "number")
      return this.forEach$1$bailout(1, action, t1, modificationCount, offset);
    for (; !$.$eq(offset, 0); offset = t1._liblib1$_next$1(offset)) {
      action.call$2(t1._key$1(offset), t1._liblib1$_value$1(offset));
      t1._checkModification$1(modificationCount);
    }
  },
  forEach$1$bailout: function(state0, action, t1, modificationCount, offset) {
    for (; $.$eq(offset, 0) !== true; offset = t1._liblib1$_next$1(offset)) {
      action.call$2(t1._key$1(offset), t1._liblib1$_value$1(offset));
      t1._checkModification$1(modificationCount);
    }
  },
...
$$.LinkedHashSet = {"": "Collection;_table",
  ...
  forEach$1: function(_, action) {
    ...
    offset = this._table._liblib1$_next$1(0);
    if (typeof offset !== "number")
    ...
    for (; !$.$eq(offset, 0);) {
      ...
      offset = this._table._liblib1$_next$1(offset);
    }
  },
...
$$._LinkedHashTable = {"": "_HashTable;_table,_capacity,_entryCount,_deletedCount,_modificationCount,_container",
  ...
  _liblib1$_next$1: function(offset) {
    var t1, t3;
    if (typeof offset !== "number")
      return this._liblib1$_next$1$bailout(1, offset);
    t1 = this._table;
    if (typeof t1 !== "object" || t1 === null || (t1.constructor !== Array || !!t1.immutable$list) && !t1.$isJavaScriptIndexingBehavior())
      return this._liblib1$_next$1$bailout(2, offset, t1);
    t3 = offset + 1;
    if (t3 !== (t3 | 0))
      throw $.iae(t3);
    if (t3 < 0 || t3 >= t1.length)
  ...
  _liblib1$_next$1$bailout: function(state0, offset, t1) {
    switch (state0) {
      case 0:
      case 1:
        state0 = 0;
...
$$._LinkedHashTableIterator = {"": "Object;_hashTable<",
  moveNext$0: function() {
    ...
    this._offset = t1._liblib1$_next$1(this._offset);
    return true;
  },
  get$current: function() {
    return this._liblib1$_current;
...
$$.ListQueue = {"": "Collection;_table,_liblib1$_head,_liblib1$_tail,_modificationCount",
  get$iterator: function(_) {
  ...
  forEach$1: function(_, action) {
    ...
    for (i = this._liblib1$_head; i !== this._liblib1$_tail; i0 = (i + 1 & this._table.length - 1) >>> 0, i = i0) {
      t1 = this._table;
      if (i < 0 || i >= t1.length)
        throw $.ioore(i);
      action.call$1(t1[i]);
  ...
  _filterWhere$2: function(test, removeMatching) {
    ...
    index = this._liblib1$_head;
    modificationCount = this._modificationCount;
    for (i = index; !$.$eq(i, this._liblib1$_tail);) {
      t1 = this._table;
      if (i !== (i | 0))
        throw $.iae(i);
      if (i < 0 || i >= t1.length)
  ...
  _grow$0: function() {
    ...
    $.JSArray_methods.setRange$4(newTable, split, this._liblib1$_head, this._table, 0);
    this._liblib1$_head = 0;
  ...
  _writeToList$1: function(target) {
    ...
    if (t1) {
      ...
      $.JSArray_methods.setRange$4(target, firstPartSize, this._liblib1$_tail, this._table, 0);
...
$$._FrozenElementListIterator = {"": "Object;_liblib6$_list,_liblib6$_index,_current",
  moveNext$0: function() {
    var nextIndex, t1;
    nextIndex = $.$add$ns(this._liblib6$_index, 1);
    ...
    this._liblib6$_index = t1.get$length(t1);
    this._current = null;
    return false;
  },
  get$current: function() {
...
$$._WrappedList = {"": "Object;_liblib6$_list",
  get$iterator: function(_) {
    return $._WrappedIterator$($.get$iterator$ax(this._liblib6$_list));
  },
  map$1: function(_, f) {
    return $.map$1$ax(this._liblib6$_list, f);
  },
  where$1: function(_, f) {
    return $.where$1$ax(this._liblib6$_list, f);
  },
  contains$1: function(_, element) {
    return $.contains$1$asx(this._liblib6$_list, element);
  },
  get$contains: function(receiver) {
    return new $.BoundClosure$i1(this, "contains$1", receiver);
  },
  forEach$1: function(_, f) {
    $.forEach$1$ax(this._liblib6$_list, f);
  },
  toList$1$growable: function(_, growable) {
    return $.List_List$from(this._liblib6$_list, growable);
  },
  toList$0: function($receiver) {
    return this.toList$1$growable($receiver, true);
  },
  get$length: function(_) {
    return $.get$length$asx(this._liblib6$_list);
  },
  elementAt$1: function(_, index) {
    return $.elementAt$1$ax(this._liblib6$_list, index);
  },
  add$1: function(_, element) {
    $.add$1$ax(this._liblib6$_list, element);
  },
  addAll$1: function(_, elements) {
    $.addAll$1$ax(this._liblib6$_list, elements);
  },
  remove$1: function(_, element) {
  ...
  $index: function(_, index) {
    return $.$index$asx(this._liblib6$_list, index);
  },
  $indexSet: function(_, index, value) {
    $.$indexSet$ax(this._liblib6$_list, index, value);
  },
  removeLast$0: function(_) {
    return $.removeLast$0$ax(this._liblib6$_list);
  },
  sublist$2: function(_, start, end) {
    return $.sublist$2$ax(this._liblib6$_list, start, end);
  },
  sublist$1: function($receiver, start) {
    return this.sublist$2($receiver, start, null);
  },
...
$$._AttributeClassSet = {"": "CssClassSet;_liblib8$_element",
  readClasses$0: function() {
    var t1, classname, s, trimmed;
    t1 = $.get$attributes$x(this._liblib8$_element);
  ...
  writeClasses$1: function(s) {
    var t1 = $.get$attributes$x(this._liblib8$_element);
...
$$.LinkedListNode = {"": "Object;_previous?,_next?,_list<,_value",
  get$next: function() {
    return this._next;
  },
  ...
  remove$0: function(_) {
    ...
    if (t1 == null)
      return;
    t1._liblib$_length = t1._liblib$_length - 1;
    t1 = this._previous;
    t2 = this._next;
    if (t1 != null)
      t1.set$_next(t2);
...
$$.LinkedList = {"": "Iterable;_head,_tail,_liblib$_length",
  get$length: function(_) {
...
$$.LinkedListIterator = {"": "Object;_copy,_list<,_liblib$_current,_pos",
  get$current: function() {
  ...
  moveNext$0: function() {
    ...
    do {
      ...
      if (t1 < t3) {
        ...
        if (t1 < 0 || t1 >= t3)
          throw $.ioore(t1);
        t4 = $.$eq(t2[t1].get$_list(), this._list) !== true;
        t1 = t4;
      } else
        t1 = false;
    } while (t1);
...
$$.Template = {"": "TemplateItem;node<,children>,nodes>",
  ...
  loop$4$isTemplateElement: function(_, template, exp, iterSetup, isTemplateElement) {
    var t1 = isTemplateElement ? $.LoopTemplate$(template, exp, iterSetup) : $.LoopTemplateInAttribute$(template, exp, iterSetup);
...
$$.PlaceholderTemplate = {"": "Template;",
  ...
  insert$0: function(_) {
    ...
    if (t2 > 0) {
      t3 = this.node;
      $parent = t3.parentNode;
      reference = t3.nextSibling;
...
$$.LoopTemplate_insert_anon = {"": "Closure;this_0",
  call$1: function(e) {
    ...
    t1 = this.this_0;
    $.PlaceholderTemplate.prototype.remove$0.call(t1, t1);
    for (t2 = $.get$iterator$ax($.get$newValue$x(e)); t2.moveNext$0();)
...
$$.LoopTemplateInAttribute_insert_anon = {"": "Closure;this_0",
  call$1: function(e) {
    ...
    t2 = $.get$nodes$x(t1.get$node());
    t2.clear$0(t2);
    t2 = $.getInterceptor$x(t1);
    $.clear$0$ax(t2.get$nodes(t1));
    for (t3 = $.get$iterator$ax($.get$newValue$x(e)); t3.moveNext$0();)
      t1.iterSetup$2(t3.get$current(), t1);
    $.Template.prototype.create$0.call(t1);
    t3 = $.get$nodes$x(t1.get$node());
    t3.addAll$1(t3, t2.get$nodes(t1));
...
$.modificar = function() {
  $.permite_edicion = $.permite_edicion !== true;
  $.modo_insercion = true;
  if ($.permite_edicion === true) {
    $.set$value$x($.query$1$x(document, "#btnPermiteEdicion"), "Restringir");
    var t1 = $.get$classes$x($.query$1$x(document, "#tdatos"));
    t1.clear$0(t1);
    t1 = $.get$classes$x($.query$1$x(document, "#tdatos"));
    t1.add$1(t1, "tabla_datos_edicion");
  } else {
    $.set$value$x($.query$1$x(document, "#btnPermiteEdicion"), "Modificar");
    t1 = $.get$classes$x($.query$1$x(document, "#tdatos"));
    t1.clear$0(t1);
    t1 = $.get$classes$x($.query$1$x(document, "#tdatos"));
    t1.add$1(t1, "tabla_datos");
  }
};

$.destino$ = function() {
  return new $.destino(null, null);
};

$.llena_lista = function(data) {
  var p_lista, i, item;
  $.lista_destino = $.List_List($);
  p_lista = $.parse(data, null);
  if (typeof p_lista !== "string" && (typeof p_lista !== "object" || p_lista === null || p_lista.constructor !== Array && !p_lista.$isJavaScriptIndexingBehavior()))
    return $.llena_lista$bailout(1, p_lista);
  for (i = 0; i <= p_lista.length - 1; ++i) {
    item = $.destino$();
    if (i >= p_lista.length)
      throw $.ioore(i);
    item.clave = $.$index$asx(p_lista[i], "clave");
    if (i >= p_lista.length)
      throw $.ioore(i);
    item.nombredestino = $.$index$asx(p_lista[i], "destino");
    $.add$1$ax($.get$lista_destino(), item);
  }
  $.dispatch();
};

$.llena_lista$bailout = function(state0, p_lista) {
  var t1, i, item;
  for (t1 = $.getInterceptor$asx(p_lista), i = 0; $.JSNumber_methods.$le(i, $.$sub$n(t1.get$length(p_lista), 1)); ++i) {
    item = $.destino$();
    item.clave = $.$index$asx(t1.$index(p_lista, i), "clave");
    item.nombredestino = $.$index$asx(t1.$index(p_lista, i), "destino");
    $.add$1$ax($.get$lista_destino(), item);
  }
  $.dispatch();
};

$.obtener_entidad = function() {
  var p_destino = $.destino$();
  p_destino.clave = $.int_parse($.get$value$x($.query$1$x(document, "#clave")), null, null);
  p_destino.nombredestino = $.get$value$x($.query$1$x(document, "#nombredestino"));
  return p_destino;
};

$.obtener_entidad_mapa = function() {
  var p_map = $.HashMap$();
  p_map.$indexSet(p_map, "clave", $.get$value$x($.query$1$x(document, "#clave")));
  p_map.$indexSet(p_map, "destino", $.get$value$x($.query$1$x(document, "#nombredestino")));
  return p_map;
};

$.agregar = function() {
  var p_destino, req, t1;
  p_destino = $.obtener_entidad();
  if ($.$eq($.get$length$asx(p_destino.nombredestino), 0) === true) {
    $.alert$1$x(window, "Se necesita capturar el campo nombredestino");
    $.focus$0$x($.query$1$x(document, "#nombredestino"));
  }
  req = new XMLHttpRequest();
  t1 = $.getInterceptor$x(req);
  if ($.$eq($.get$value$x($.query$1$x(document, "#btnAgregar")), "Agregar") === true) {
    t1.open$2(req, "POST", "/rest/destinos/destino_insertar");
    t1.setRequestHeader$2(req, "Content-type", "application/json");
    t1.send$1(req, $._JsonStringifier_stringify($.obtener_entidad_mapa()));
    t1.get$onReadyStateChange(req).listen$1(new $.agregar_anon(p_destino, req));
  } else {
    t1.open$2(req, "PUT", "/rest/destinos/destino_actualizar");
    t1.setRequestHeader$2(req, "Content-type", "application/json");
    t1.send$1(req, $._JsonStringifier_stringify($.obtener_entidad_mapa()));
    $.actualiza_destino($.$index$asx($.toList$0$ax($.where$1$ax($.get$lista_destino(), new $.agregar_anon0(p_destino))), 0), p_destino);
    $.set$value$x($.query$1$x(document, "#btnAgregar"), "Agregar");
    $.set$value$x($.query$1$x(document, "#clave"), "1");
    $.set$value$x($.query$1$x(document, "#nombredestino"), "");
    $.focus$0$x($.query$1$x(document, "#nombredestino"));
...
$.actualiza_destino = function(p_destino_tmp, p_destino) {
  p_destino_tmp.set$clave(p_destino.clave);
  p_destino_tmp.set$nombredestino(p_destino.nombredestino);
};

$.eliminar = function(a_destino) {
  var req, t1, p_map;
  if ($.confirm$1$x(window, "\u00bfEliminar registro?") === true) {
    req = new XMLHttpRequest();
    t1 = $.getInterceptor$x(req);
    t1.open$2(req, "DELETE", "/rest/destinos/destino_eliminar");
    t1.setRequestHeader$2(req, "Content-type", "application/json");
    p_map = $.HashMap$();
    p_map.$indexSet(p_map, "clave", a_destino.get$clave());
    t1.send$1(req, $._JsonStringifier_stringify(p_map));
    $.remove$1$ax($.get$lista_destino(), a_destino);
  }
};

$.despliega_clase = function(a_destino) {
  var t1 = $.toString$0(a_destino.get$clave());
  $.set$value$x($.query$1$x(document, "#clave"), t1);
  t1 = $.toString$0(a_destino.get$nombredestino());
  $.set$value$x($.query$1$x(document, "#nombredestino"), t1);
  $.focus$0$x($.query$1$x(document, "#nombredestino"));
  $.set$value$x($.query$1$x(document, "#btnAgregar"), "Editar");
};

$.init_autogenerated = function() {
  var _root, __html0, __html1, __html2, __html3, __html4, __html5, __html6, __t, t1;
  _root = $.get$body$x(document);
  __html0 = $._ElementFactoryProvider_createElement_html("<th template=\"\" instantiate=\"if modo_insercion\"></th>");
  __html1 = $._ElementFactoryProvider_createElement_html("<tr template=\"\" instantiate=\"if permite_edicion\">\n            <th style=\"display:none;\"><input type=\"text\" id=\"clave\" value=\"0\" disabled=\"disabled\"></th>\n            <th><input type=\"text\" id=\"nombredestino\" value=\"\"></th>\n            <th id=\"__e-6\" style=\"display:none\"></th>\n          </tr>");
  __html2 = $._ElementFactoryProvider_createElement_html("<th template=\"\" instantiate=\"if permite_edicion\"><input type=\"button\" id=\"btnAgregar\" value=\"Agregar\"><template id=\"__e-4\"></template></th>");
  __html3 = $._ElementFactoryProvider_createElement_html("<input type=\"button\" id=\"btnCancelar\" value=\"Cancelar\">");
  __html4 = $._ElementFactoryProvider_createElement_html("<tr style=\"display:none\"></tr>");
  __html5 = $._ElementFactoryProvider_createElement_html("<tr template=\"\" instantiate=\"if modo_insercion\">\n            <td style=\"display:none;\" id=\"__e-10\"></td>\n            <td id=\"__e-12\"></td>\n            <td id=\"__e-16\" style=\"display:none\"></td>\n          </tr>");
  __html6 = $._ElementFactoryProvider_createElement_html("<td template=\"\" instantiate=\"if modo_insercion &amp;&amp; permite_edicion\"><a href=\"#\" class=\"boton_eliminar\" id=\"__e-13\">x</a>&nbsp;&nbsp;<a href=\"#\" class=\"boton_editar\" id=\"__e-14\">m</a></td>");
  __t = $.Template$(_root);
  t1 = $.getInterceptor$x(_root);
  __t.listen$2($.get$onClick$x(t1.query$1(_root, "#btnPermiteEdicion")), new $.init_autogenerated_anon());
  __t.conditional$3(t1.query$1(_root, "#__e-1"), new $.init_autogenerated_anon0(), new $.init_autogenerated_anon1(__html0));
  __t.conditional$3(t1.query$1(_root, "#__e-8"), new $.init_autogenerated_anon2(), new $.init_autogenerated_anon3(__html1, __html2, __html3));
  __t.loop$4$isTemplateElement(__t, t1.query$1(_root, "#__e-19"), new $.init_autogenerated_anon4(), new $.init_autogenerated_anon5(__html4, __html5, __html6), false);
  __t.create$0();
  __t.insert$0(__t);
};
...
$.main = function() {
  $.useObservers = false;
  $.HttpRequest_getString("/rest/destinos/destino_obtener_lista", null, null).then$1($.llena_lista);
  $.init_autogenerated();
};
...
$._LinkedHashTableKeyIterator$ = function(hashTable) {
  return new $._LinkedHashTableKeyIterator(hashTable, hashTable._modificationCount, hashTable._liblib1$_next$1(0), null);
};
...
$._LinkedHashTableValueIterator$ = function(hashTable, _valueIndex) {
  return new $._LinkedHashTableValueIterator(_valueIndex, hashTable, hashTable._modificationCount, hashTable._liblib1$_next$1(0), null);
};
...
$._ElementFactoryProvider_createElement_html = function(html) {
  ...
  if (match != null) {
    ...
    if ($.Device_isIE() === true && $.CONSTANT7.containsKey$1(tag))
...
$.llena_lista.call$1 = $.llena_lista;
$.llena_lista.$name = "llena_lista";
...
$.CONSTANT6 = new $.EventStreamProvider("click");
...
$.CONSTANT7 = new $.ConstantMap(9, {caption: null, col: null, colgroup: null, tbody: null, td: null, tfoot: null, th: null, thead: null, tr: null}, $.CONSTANT15);
...
$.CONSTANT8 = new $.ConstantMap(12, {body: "html", head: "html", caption: "table", td: "tr", th: "tr", colgroup: "table", col: "colgroup", tr: "tbody", tbody: "table", tfoot: "table", thead: "table", track: "audio"}, $.CONSTANT14);
$.CONSTANT9 = new $.EventStreamProvider("readystatechange");
$.CONSTANT5 = new $.CloseToken();
$.CONSTANT11 = new $.EventStreamProvider("load");
$.JSInt_methods = $.JSInt.prototype;
$.CONSTANT10 = new $.EventStreamProvider("error");
...
Isolate.$lazy($, "lista_destino", "lista_destino", "get$lista_destino", function() {
  return $.List_List($);
});
...
$.$defineNativeClass("Element", {"": "$$dom_children:children=,id=,innerHtml:innerHTML},tagName=",
...
//@ sourceMappingURL=destinos.html_bootstrap.dart.js.map
