...
["dart.async", "dart:async", , P, {
  ...
  _AsyncCompleter: {
    ...
    }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 15, 4]
  },
  _Future: {
...
["", "uso_empaque_orden.dart", , N, {
  "^": "",
  agregarFila: function(AItem) {
    var pCantidadEntregada, pCosto, tr, td, t1, pUsado, exception;
    tr = document.createElement("tr", null);
    tr.id = H.S(J.$index$asx(AItem, "id"));
    td = document.createElement("td", null);
    td.textContent = J.$index$asx(AItem, "codigosap");
    t1 = J.getInterceptor$x(tr);
    t1.get$children(tr).add$1(0, td);
    td = document.createElement("td", null);
    td.textContent = J.$index$asx(AItem, "nombre");
    t1.get$children(tr).add$1(0, td);
    pUsado = J.toDouble$0$n(J.$index$asx(AItem, "usado"));
    t1.get$children(tr).add$1(0, td);
    td = document.createElement("td", null);
    td.textContent = C.JSNumber_methods.toStringAsFixed$1(pUsado, 2);
    J.set$textAlign$x(td.style, "right");
    t1.get$children(tr).add$1(0, td);
    pCantidadEntregada = 0;
    try {
      pCantidadEntregada = J.toDouble$0$n(J.$index$asx(AItem, "cantidad_entregada"));
    } catch (exception) {
      H.unwrapException(exception);
      pCantidadEntregada = 0;
    }
    ...
    td = document.createElement("td", null);
    td.textContent = J.toStringAsFixed$1$n(pCantidadEntregada, 2);
    J.set$textAlign$x(td.style, "right");
    t1.get$children(tr).add$1(0, td);
    td = document.createElement("td", null);
    td.textContent = J.toStringAsFixed$1$n(J.$sub$n(pCantidadEntregada, pUsado), 2);
    J.set$textAlign$x(td.style, "right");
    t1.get$children(tr).add$1(0, td);
    pCosto = 0;
    try {
      pCosto = J.toDouble$0$n(J.$index$asx(AItem, "costo_empaque"));
    } catch (exception) {
      H.unwrapException(exception);
      pCosto = 0;
    }
    ...
    td = document.createElement("td", null);
    td.textContent = J.toStringAsFixed$1$n(pCosto, 2);
    J.set$textAlign$x(td.style, "right");
    t1.get$children(tr).add$1(0, td);
    td = document.createElement("td", null);
    td.textContent = J.toStringAsFixed$1$n(J.$mul$ns(pCosto, pUsado), 2);
    J.set$textAlign$x(td.style, "right");
    t1.get$children(tr).add$1(0, td);
    t1 = J.get$tBodies$x($.get$tablaUsoEmpaque())._list;
    if (0 >= t1.length)
      return H.ioore(t1, 0);
    J.add$1$ax(J.get$children$x(t1[0]), tr);
  },
  consultar: function() {
    W.HttpRequest_getString("/rest/obtener_uso_empaque_orden/" + H.S(J.get$value$x($.get$inpOrden())), null, null).then$1(new N.consultar_closure());
  },
  init: function() {
    var t1 = J.get$onClick$x($.get$btnConsultar());
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new N.init_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  },
  main: [function() {
    N.init();
  ...
  consultar_closure: {
    ...
    call$1: function(Data) {
      var item, pLista, t1, t2, t3, exception;
      pLista = C.JsonCodec_null_null.decode$1(Data);
      $.pTotalCantidadUsada = 0;
      $.pTotalDiferencia = 0;
      $.pTotalGeneral = 0;
      $.pTotalCantidadEntregada = 0;
      t1 = J.get$tBodies$x($.get$tablaUsoEmpaque())._list;
      if (0 >= t1.length)
        return H.ioore(t1, 0);
      ...
      for (t1 = J.get$iterator$ax(pLista); t1.moveNext$0();) {
        item = t1.get$current();
        N.agregarFila(item);
        $.pTotalCantidadUsada = $.pTotalCantidadUsada + J.toDouble$0$n(J.$index$asx(item, "usado"));
        try {
          t2 = $.pTotalCantidadEntregada;
          t3 = J.$index$asx(item, "cantidad_entregada");
          if (typeof t3 !== "number")
            return H.iae(t3);
          $.pTotalCantidadEntregada = t2 + t3;
        } catch (exception) {
          H.unwrapException(exception);
          $.pTotalCantidadEntregada = $.pTotalCantidadEntregada + 0;
        }

        t2 = $.pTotalCantidadUsada;
        $.pTotalDiferencia = t2 - t2;
        try {
          t2 = $.pTotalGeneral;
          t3 = J.$mul$ns(J.$index$asx(item, "usado"), J.$index$asx(item, "costo_empaque"));
          if (typeof t3 !== "number")
            return H.iae(t3);
          $.pTotalGeneral = t2 + t3;
        } catch (exception) {
          H.unwrapException(exception);
          $.pTotalGeneral = $.pTotalGeneral + 0;
        }

      }
      J.set$innerHtml$x($.get$spanTotalUsoEmpaque(), C.JSNumber_methods.toStringAsFixed$1($.pTotalCantidadUsada, 2));
      J.set$innerHtml$x($.get$spanTotalCantidadEntregada(), C.JSNumber_methods.toStringAsFixed$1($.pTotalCantidadEntregada, 2));
      J.set$innerHtml$x($.get$spanTotalDiferencia(), C.JSNumber_methods.toStringAsFixed$1($.pTotalDiferencia, 2));
      J.set$innerHtml$x($.get$spanTotalGeneral(), C.JSNumber_methods.toStringAsFixed$1($.pTotalGeneral, 2));
    }
  },
  init_closure: {
    "^": "Closure:11;",
...
Isolate.$lazy($, "inpOrden", "inpOrden", "get$inpOrden", function() {
  return document.querySelector("#inpOrden");
});
Isolate.$lazy($, "tablaUsoEmpaque", "tablaUsoEmpaque", "get$tablaUsoEmpaque", function() {
  return document.querySelector("#tablaUsoEmpaque");
});
Isolate.$lazy($, "btnConsultar", "btnConsultar", "get$btnConsultar", function() {
  return document.querySelector("#btnConsultar");
});
Isolate.$lazy($, "spanTotalUsoEmpaque", "spanTotalUsoEmpaque", "get$spanTotalUsoEmpaque", function() {
  return document.querySelector("#spanTotalUsoEmpaque");
});
Isolate.$lazy($, "spanTotalCantidadEntregada", "spanTotalCantidadEntregada", "get$spanTotalCantidadEntregada", function() {
  return document.querySelector("#spanTotalCantidadEntregada");
});
Isolate.$lazy($, "spanTotalDiferencia", "spanTotalDiferencia", "get$spanTotalDiferencia", function() {
  return document.querySelector("#spanTotalDiferencia");
});
Isolate.$lazy($, "spanTotalGeneral", "spanTotalGeneral", "get$spanTotalGeneral", function() {
  return document.querySelector("#spanTotalGeneral");
});
// Native classes
...
//# sourceMappingURL=uso_empaque_orden.dart.js.map
//@ sourceMappingURL=uso_empaque_orden.dart.js.map
