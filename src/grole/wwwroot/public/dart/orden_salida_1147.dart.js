...
MR:[function(a){return J.kI(a)},"$1","Cz",2,0,7],
...
J.Fc($.Zz(),z.t(a,"tipo"))
J.Fc($.xi(),J.AG(z.t(a,"peso_camion")))
J.Fc($.TV(),J.AG(z.t(a,"tarima_1")))
J.Fc($.xc(),J.AG(z.t(a,"tarima_2")))
J.Fc($.hP(),J.AG(z.t(a,"dias_produccion")))
...
vJ:function(){var z=P.L5(null,null,null,null,null)
z.u(0,"id",J.AG($.Nc))
...
z.u(0,"tarimas",$.O1())
z.u(0,"tipo",J.Vm($.Zz()))
z.u(0,"peso_camion",H.IH(J.Vm($.xi()),new M.Qn()))
z.u(0,"tarima_1",H.Hp(J.Vm($.TV()),null,new M.UY()))
z.u(0,"tarima_2",H.Hp(J.Vm($.xc()),null,new M.Zy()))
z.u(0,"dias_produccion",J.Vm($.hP()))
...
z=null}return z},
pB:function(){var z=M.vJ()
if(z==null){window.alert($.xY)
...
I.$lazy($,"inpPesoCamion","JU","xi",function(){return document.querySelector("#inpPesoCamion")})
I.$lazy($,"inpTarima1","nU","TV",function(){return document.querySelector("#inpTarima1")})
I.$lazy($,"inpTarima2","Cr","xc",function(){return document.querySelector("#inpTarima2")})
I.$lazy($,"inpDiasProduccion","AF","hP",function(){return document.querySelector("#inpDiasProduccion")})
