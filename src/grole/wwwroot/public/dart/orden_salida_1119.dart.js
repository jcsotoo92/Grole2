...
["intl", "package:intl/intl.dart", , T, {
  ...
  NumberFormat: {
    ...
    static: {NumberFormat_NumberFormat: function(newPattern, locale) {
      ...
      }, "call$1", "NumberFormat_localeExists$closure", 2, 0, 12]}
  },
...
["", "orden_salida.dart", , M, {
  "": "",
  agregaFila: function(AItem, AEditable) {
    var pTabla, tr, t1, td, t2, t3, t4, pCumplimientoS, btnEliminar, t5, t6, btnEditar, t7;
    $.get$Detalle().push(AItem);
    pTabla = document.querySelector("#tablaDetalle");
    tr = document.createElement("tr", null);
    t1 = J.getInterceptor$asx(AItem);
    tr.id = "tr" + H.S(t1.$index(AItem, "id"));
    td = document.createElement("td", null);
    td.textContent = t1.$index(AItem, "producto");
    ...
    t3.add$1(t3, td);
    td = document.createElement("td", null);
    td.textContent = J.toString$0(t1.$index(AItem, "cajas"));
    J.set$textAlign$x(td.style, "right");
    t3 = t2.get$children(tr);
    t3.add$1(t3, td);
    td = document.createElement("td", null);
    t3 = $.get$pNumberFormat();
    td.textContent = t3.format$1(t3, t1.$index(AItem, "kilos"));
    J.set$textAlign$x(td.style, "right");
    t3 = t2.get$children(tr);
    t3.add$1(t3, td);
    td = document.createElement("td", null);
    td.textContent = J.toString$0(t1.$index(AItem, "cajas_surtidas"));
    J.set$textAlign$x(td.style, "right");
    t3 = t2.get$children(tr);
    t3.add$1(t3, td);
    td = document.createElement("td", null);
    t3 = $.get$pNumberFormat();
    td.textContent = t3.format$1(t3, t1.$index(AItem, "kilos_surtidos"));
    J.set$textAlign$x(td.style, "right");
    t3 = t2.get$children(tr);
    t3.add$1(t3, td);
    t3 = t1.$index(AItem, "cajas_surtidas");
    t1 = t1.$index(AItem, "cajas");
    if (typeof t3 !== "number")
      return t3.$div();
    if (typeof t1 !== "number")
      return H.iae(t1);
    t4 = $.get$pNumberFormat();
    pCumplimientoS = t4.format$1(t4, t3 / t1 * 100) + "%";
    td = document.createElement("td", null);
    td.textContent = pCumplimientoS;
    J.set$textAlign$x(td.style, "right");
    t1 = t2.get$children(tr);
    t1.add$1(t1, td);
    if (AEditable) {
      btnEliminar = W.Element_Element$html("<button class='btn'><i class='icon-trash'></i></button>", null, null);
      t1 = J.getInterceptor$x(btnEliminar);
      t3 = t1.get$onClick(btnEliminar);
      t4 = t3._eventType;
      t5 = t3._useCapture;
      t6 = new W._EventStreamSubscription(0, t3._target, t4, W._wrapZone(new M.agregaFila_closure(AItem, tr)), t5);
      t6.$builtinTypeInfo = [H.getTypeArgumentByIndex(t3, 0)];
      t3 = t6._onData;
      if (t3 != null && t6._pauseCount <= 0)
        J.addEventListener$3$x(t6._target, t4, t3, t5);
      J.set$marginLeft$x(t1.get$style(btnEliminar), "5px");
      td = document.createElement("td", null);
      t1 = J.getInterceptor$x(td);
      t3 = t1.get$children(td);
      t3.add$1(t3, btnEliminar);
      btnEditar = W.Element_Element$html("<button class='btn'><i class='icon-edit'></i></button>", null, null);
      t3 = J.getInterceptor$x(btnEditar);
      t4 = t3.get$onClick(btnEditar);
      t5 = t4._eventType;
      t6 = t4._useCapture;
      t7 = new W._EventStreamSubscription(0, t4._target, t5, W._wrapZone(new M.agregaFila_closure0(AItem)), t6);
      t7.$builtinTypeInfo = [H.getTypeArgumentByIndex(t4, 0)];
      t4 = t7._onData;
      if (t4 != null && t7._pauseCount <= 0)
        J.addEventListener$3$x(t7._target, t5, t4, t6);
      J.set$marginLeft$x(t3.get$style(btnEditar), "5px");
      t1 = t1.get$children(td);
      t1.add$1(t1, btnEditar);
      t2 = t2.get$children(tr);
      t2.add$1(t2, td);
    }
    t1 = J.get$tBodies$x(pTabla)._list;
    if (0 >= t1.length)
      return H.ioore(t1, 0);
    J.add$1$ax(J.get$children$x(t1[0]), tr);
  },
  despliegaEntidad: function(AItem) {
    var t1, t2, p_total_cajas, p_total_cajas_surtidas, p_total_kilos, p_total_kilos_surtidos, item, t3, t4, p_cumplimiento, pCumplimientoS;
    t1 = J.getInterceptor$asx(AItem);
    H.interceptedTypeCast(document.querySelector("#inpDestino"), "$isInputElement").value = J.toString$0(t1.$index(AItem, "nombre_destino"));
    H.interceptedTypeCast(document.querySelector("#inpDescripcion"), "$isInputElement").value = J.toString$0(t1.$index(AItem, "descripcion"));
    H.interceptedTypeCast(document.querySelector("#inpFechaEmbarque"), "$isInputElement").value = J.substring$2$s(H.stringTypeCast(t1.$index(AItem, "fecha_embarque")), 8, 10) + "/" + J.substring$2$s(H.stringTypeCast(t1.$index(AItem, "fecha_embarque")), 5, 7) + "/" + J.substring$2$s(H.stringTypeCast(t1.$index(AItem, "fecha_embarque")), 0, 4);
    H.interceptedTypeCast(document.querySelector("#inpValidaProductos"), "$isSelectElement").value = t1.$index(AItem, "valida_productos");
    J.set$value$x(H.interceptedTypeCast(document.querySelector("#inpClaveCliente"), "$isHiddenInputElement"), J.toString$0(t1.$index(AItem, "destino")));
    H.interceptedTypeCast(document.querySelector("#spanFolio"), "$isSpanElement").textContent = J.toString$0(t1.$index(AItem, "id"));
    H.interceptedTypeCast(document.querySelector("#spanEstado"), "$isSpanElement").textContent = t1.$index(AItem, "estado");
    H.interceptedTypeCast(document.querySelector("#inpIdUsuario"), "$isInputElement").textContent = J.toString$0(t1.$index(AItem, "id_usuario"));
    if (J.$eq(t1.$index(AItem, "estado"), "Cerrado"))
      J.set$display$x(H.interceptedTypeCast(document.querySelector("#btnGuardar"), "$isButtonElement").style, "none");
    for (t2 = J.get$iterator$ax(t1.$index(AItem, "detalle")), p_total_cajas = 0, p_total_cajas_surtidas = 0, p_total_kilos = 0, p_total_kilos_surtidos = 0; t2.moveNext$0();) {
      item = t2.get$current();
      t3 = J.getInterceptor$asx(item);
      if ((J.$gt$n(t3.$index(item, "cajas_surtidas"), 0) || J.$gt$n(t3.$index(item, "kilos_surtidos"), 0)) && !J.$eq(t1.$index(AItem, "estado"), "Cerrado"))
        J.set$display$x(H.interceptedTypeCast(document.querySelector("#btnCerrar"), "$isButtonElement").style, "inline");
      M.agregaFila(item, !J.$eq(t3.$index(item, "origen"), "tarima"));
      t4 = t3.$index(item, "cajas");
      if (typeof t4 !== "number")
        return H.iae(t4);
      p_total_cajas += t4;
      t4 = t3.$index(item, "cajas_surtidas");
      if (typeof t4 !== "number")
        return H.iae(t4);
      p_total_cajas_surtidas += t4;
      t4 = t3.$index(item, "kilos");
      if (typeof t4 !== "number")
        return H.iae(t4);
      p_total_kilos += t4;
      t3 = t3.$index(item, "kilos_surtidos");
      if (typeof t3 !== "number")
        return H.iae(t3);
      p_total_kilos_surtidos += t3;
    }
    p_cumplimiento = p_total_cajas_surtidas / p_total_cajas * 100;
    if (isNaN(p_cumplimiento))
      p_cumplimiento = 0;
    t1 = $.get$pNumberFormat();
    pCumplimientoS = t1.format$1(t1, p_cumplimiento) + "%";
    H.interceptedTypeCast(document.querySelector("#spanCumplimiento"), "$isSpanElement").textContent = pCumplimientoS;
    H.interceptedTypeCast(document.querySelector("#spanTotalCajas"), "$isSpanElement").textContent = C.JSNumber_methods.toString$0(p_total_cajas);
    H.interceptedTypeCast(document.querySelector("#spanTotalCajasSurtidas"), "$isSpanElement").textContent = C.JSNumber_methods.toString$0(p_total_cajas_surtidas);
    t1 = H.interceptedTypeCast(document.querySelector("#spanTotalKilos"), "$isSpanElement");
    t2 = $.get$nf();
    t1.textContent = t2.format$1(t2, p_total_kilos);
    t2 = H.interceptedTypeCast(document.querySelector("#spanTotalKilosSurtidos"), "$isSpanElement");
    t1 = $.get$nf();
    t2.textContent = t1.format$1(t1, p_total_kilos_surtidos);
  },
  llenaListaTarimasOrden: function() {
    W.HttpRequest_getString("/rest/salidas/obtener_lista_tarimas_orden_salida/" + H.S($.idOrdenSalida), null, null).then$1(new M.llenaListaTarimasOrden_closure());
  },
  obtenerOrdenSalida: function() {
    var t1 = H.Primitives_parseInt(J.get$value$x(H.interceptedTypeCast(document.querySelector("#inpFolio"), "$isHiddenInputElement")), null, null);
    $.idOrdenSalida = t1;
    W.HttpRequest_getString("/rest/salidas/orden_salida_obtener/" + H.S(t1), null, null).then$1(new M.obtenerOrdenSalida_closure()).then$1(new M.obtenerOrdenSalida_closure0());
  },
  guardarOrdenSalida: function() {
    var pResult = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
    pResult.$indexSet(pResult, "id", J.toString$0($.idOrdenSalida));
    pResult.$indexSet(pResult, "descripcion", H.interceptedTypeCast(document.querySelector("#inpDescripcion"), "$isInputElement").value);
    pResult.$indexSet(pResult, "fecha_embarque", H.interceptedTypeCast(document.querySelector("#inpFechaEmbarque"), "$isInputElement").value);
    pResult.$indexSet(pResult, "valida_productos", H.interceptedTypeCast(document.querySelector("#inpValidaProductos"), "$isSelectElement").value);
    pResult.$indexSet(pResult, "destino", H.Primitives_parseInt(J.get$value$x(H.interceptedTypeCast(document.querySelector("#inpClaveCliente"), "$isHiddenInputElement")), null, null));
    pResult.$indexSet(pResult, "id_usuario", H.interceptedTypeCast(document.querySelector("#inpIdUsuario"), "$isInputElement").value);
    pResult.$indexSet(pResult, "estado", "Nuevo");
    pResult.$indexSet(pResult, "detalle", $.get$Detalle());
    pResult.$indexSet(pResult, "tarimas", $.get$ListaTarimas());
    if (J.trim$0$s(pResult.$index(pResult, "descripcion")).length === 0) {
      $.lastErrorMessage = "Necesita capturar la descripci\u00f3n";
      pResult = null;
    }
    if ($.get$Detalle().length === 0) {
      $.lastErrorMessage = "No se han capturado producto";
      pResult = null;
    }
    if (pResult == null) {
      window.alert($.lastErrorMessage);
      return;
    }
    W.HttpRequest_request("/rest/salidas/orden_salida_insertar", "POST", null, null, null, null, C.C_JsonCodec.encode$1(pResult), null).then$1(new M.guardarOrdenSalida_closure());
  },
  limpiaEditores: function() {
    H.interceptedTypeCast(document.querySelector("#inpProducto"), "$isInputElement").value = "";
    H.interceptedTypeCast(document.querySelector("#inpDescripcionProducto"), "$isInputElement").value = "";
    H.interceptedTypeCast(document.querySelector("#inpCajas"), "$isInputElement").value = "1";
    H.interceptedTypeCast(document.querySelector("#inpKilos"), "$isInputElement").value = "0";
  },
  despliegaProductoFila: function(AItem) {
    var t1, t2, tr, t3;
    t1 = J.getInterceptor$asx(AItem);
    t2 = "#tr" + H.S(t1.$index(AItem, "id"));
    tr = document.querySelector(t2);
    t2 = J.get$cells$x(tr)._list;
    if (0 >= t2.length)
      return H.ioore(t2, 0);
    t2[0].textContent = t1.$index(AItem, "producto");
    t2 = H.setRuntimeTypeInfo(new W._WrappedList(tr.cells), [W.TableCellElement])._list;
    if (1 >= t2.length)
      return H.ioore(t2, 1);
    t2[1].textContent = t1.$index(AItem, "descripcion");
    t2 = H.setRuntimeTypeInfo(new W._WrappedList(tr.cells), [W.TableCellElement])._list;
    if (2 >= t2.length)
      return H.ioore(t2, 2);
    t2[2].textContent = J.toString$0(t1.$index(AItem, "cajas"));
    t2 = H.setRuntimeTypeInfo(new W._WrappedList(tr.cells), [W.TableCellElement])._list;
    if (3 >= t2.length)
      return H.ioore(t2, 3);
    t2 = t2[3];
    t3 = $.get$pNumberFormat();
    t2.textContent = t3.format$1(t3, t1.$index(AItem, "kilos"));
  },
  agregar: function() {
    if (J.$gt$n(J.get$length$asx($.get$ListaTarimas()), 0)) {
      window.alert("No se pueden agregar productos s ya se agregaron tarimas");
      return;
    }
    M.limpiaEditores();
    R.modal("mdlAgregar");
    H.interceptedTypeCast(document.querySelector("#inpProducto"), "$isInputElement").focus();
  },
  onBlurProducto: function() {
    var pProducto = H.interceptedTypeCast(document.querySelector("#inpProducto"), "$isInputElement").value;
    if (J.trim$0$s(pProducto).length > 0)
      W.HttpRequest_getString("/rest/productos/obtener_descripcion/" + pProducto, null, null).then$1(new M.onBlurProducto_closure());
  },
  onBlurProductoConsultaTarimas: function() {
    var pProducto = J.get$value$x($.get$inpClavePtoTarima());
    if (J.trim$0$s(pProducto).length > 0)
      W.HttpRequest_getString("/rest/productos/obtener_descripcion/" + pProducto, null, null).then$1(new M.onBlurProductoConsultaTarimas_closure());
  },
  agregarProducto: function() {
    var pMapa, exception, t1;
    pMapa = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
    J.$indexSet$ax(pMapa, "id", $.indice);
    $.indice = $.indice + 1;
    J.$indexSet$ax(pMapa, "producto", J.trim$0$s(H.interceptedTypeCast(document.querySelector("#inpProducto"), "$isInputElement").value));
    J.$indexSet$ax(pMapa, "descripcion", H.interceptedTypeCast(document.querySelector("#inpDescripcionProducto"), "$isInputElement").value);
    try {
      J.$indexSet$ax(pMapa, "cajas", H.Primitives_parseInt(H.interceptedTypeCast(document.querySelector("#inpCajas"), "$isInputElement").value, null, null));
    } catch (exception) {
      H.unwrapException(exception);
      J.$indexSet$ax(pMapa, "cajas", -1);
    }

    try {
      J.$indexSet$ax(pMapa, "kilos", H.Primitives_parseDouble(H.interceptedTypeCast(document.querySelector("#inpKilos"), "$isInputElement").value, null));
    } catch (exception) {
      H.unwrapException(exception);
      J.$indexSet$ax(pMapa, "kilos", -1);
    }

    J.$indexSet$ax(pMapa, "cajas_surtidas", 0);
    J.$indexSet$ax(pMapa, "kilos_surtidos", 0);
    if (J.$eq(J.get$length$asx(J.$index$asx(pMapa, "producto")), 0) || J.$eq(J.$index$asx(pMapa, "producto"), "")) {
      window.alert("Error, el producto no es v\u00e1lido");
      H.interceptedTypeCast(document.querySelector("#inpCajas"), "$isInputElement").focus();
      return;
    }
    if (J.$lt$n(J.$index$asx(pMapa, "cajas"), 0)) {
      window.alert("Error, el n\u00famero de cajas no es v\u00e1lido");
      H.interceptedTypeCast(document.querySelector("#inpCajas"), "$isInputElement").focus();
      return;
    }
    if (J.$lt$n(J.$index$asx(pMapa, "kilos"), 0)) {
      window.alert("Error, el n\u00famero de kilos no es v\u00e1lido");
      H.interceptedTypeCast(document.querySelector("#inpKilos"), "$isInputElement").focus();
      return;
    }
    if (J.$gt$n(J.$index$asx(pMapa, "cajas"), 0) && J.$gt$n(J.$index$asx(pMapa, "kilos"), 0)) {
      window.alert("Error, solo uno cajas o kilos puede ser mayor a cero, ambos no");
      H.interceptedTypeCast(document.querySelector("#inpCajas"), "$isInputElement").focus();
      return;
    }
    if (J.$eq(J.$index$asx(pMapa, "cajas"), 0) && J.$eq(J.$index$asx(pMapa, "kilos"), 0)) {
      window.alert("Error, debe poner cajas o kilos con un valor mayor a cero");
      H.interceptedTypeCast(document.querySelector("#inpCajas"), "$isInputElement").focus();
      return;
    }
    t1 = $.get$Detalle();
    t1.toString;
    t1 = H.setRuntimeTypeInfo(new H.WhereIterable(t1, new M.agregarProducto_closure(pMapa)), [null]);
    if (P.List_List$from(t1, true, H.getRuntimeTypeArgument(t1, "IterableBase", 0)).length > 0) {
      window.alert("Error, el producto ya se encuentra en la lista");
      M.limpiaEditores();
      H.interceptedTypeCast(document.querySelector("#inpProducto"), "$isInputElement").focus();
      return;
    }
    M.agregaFila(pMapa, true);
    M.limpiaEditores();
    H.interceptedTypeCast(document.querySelector("#inpProducto"), "$isInputElement").focus();
  },
  cerrarOrden: function() {
    var pUrl, pData;
    if (window.confirm("\u00bfCerrar la orden de salida?") === true) {
      pUrl = "/rest/salidas/cambiar_estado/" + H.S($.idOrdenSalida);
      pData = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
      pData.$indexSet(pData, "estado", "Cerrado");
      W.HttpRequest_request(pUrl, "PUT", null, null, null, null, C.C_JsonCodec.encode$1(pData), null).then$1(new M.cerrarOrden_closure()).then$1(new M.cerrarOrden_closure0());
    }
  },
  agregarTarimas: function() {
    if (J.$eq(J.get$length$asx($.get$ListaTarimas()), 0) && $.get$Detalle().length > 0) {
      window.alert("No se pueden agregar tarimas porque ya existen productos");
      return;
    }
    R.modal("mdlConsultaTarimas");
    $.get$inpClavePtoTarima().focus();
  },
  llenaCamaras: function() {
    W.HttpRequest_getString("/camaras/obtener_lista", null, null).then$1(new M.llenaCamaras_closure());
  },
  agregaTarimaDetalle: function(ATarima) {
    var item, t1, exception, pItem, t2;
    item = null;
    try {
      t1 = $.get$Detalle();
      t1.toString;
      t1 = H.setRuntimeTypeInfo(new H.WhereIterable(t1, new M.agregaTarimaDetalle_closure(ATarima)), [null]);
      item = C.JSArray_methods.get$first(P.List_List$from(t1, true, H.getRuntimeTypeArgument(t1, "IterableBase", 0)));
    } catch (exception) {
      H.unwrapException(exception);
      item = null;
    }
    ...
    if (item == null) {
      pItem = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
      pItem.$indexSet(pItem, "id", $.indice);
      $.indice = $.indice + 1;
      pItem.$indexSet(pItem, "producto", J.$index$asx(ATarima, "producto"));
      pItem.$indexSet(pItem, "descripcion", J.$index$asx(ATarima, "descripcion"));
      pItem.$indexSet(pItem, "cajas", J.$index$asx(ATarima, "cajas"));
      pItem.$indexSet(pItem, "kilos", J.$index$asx(ATarima, "kilos"));
      pItem.$indexSet(pItem, "cajas_surtidas", 0);
      pItem.$indexSet(pItem, "kilos_surtidos", 0);
      pItem.$indexSet(pItem, "origen", "tarima");
      M.agregaFila(pItem, false);
    } else {
      J.$indexSet$ax(item, "producto", J.$index$asx(ATarima, "producto"));
      J.$indexSet$ax(item, "descripcion", J.$index$asx(ATarima, "descripcion"));
      t1 = item;
      t2 = J.getInterceptor$asx(t1);
      t2.$indexSet(t1, "cajas", J.$add$ns(t2.$index(t1, "cajas"), J.$index$asx(ATarima, "cajas")));
      t1 = item;
      t2 = J.getInterceptor$asx(t1);
      t2.$indexSet(t1, "kilos", J.$add$ns(t2.$index(t1, "kilos"), J.$index$asx(ATarima, "kilos")));
      J.$indexSet$ax(item, "origen", "tarima");
      M.despliegaProductoFila(item);
    }
  },
  remueveTarimaDetalle: function(ATarima) {
    var t1, t2, item, exception, t3;
    t1 = {};
    t1.item_0 = null;
    try {
      t2 = $.get$Detalle();
      t2.toString;
      t2 = H.setRuntimeTypeInfo(new H.WhereIterable(t2, new M.remueveTarimaDetalle_closure(ATarima)), [null]);
      item = C.JSArray_methods.get$first(P.List_List$from(t2, true, H.getRuntimeTypeArgument(t2, "IterableBase", 0)));
      t1.item_0 = item;
      t2 = item;
    } catch (exception) {
      H.unwrapException(exception);
    ...
    if (t2 != null) {
      J.$indexSet$ax(t2, "producto", J.$index$asx(ATarima, "producto"));
      J.$indexSet$ax(t1.item_0, "descripcion", J.$index$asx(ATarima, "descripcion"));
      t2 = t1.item_0;
      t3 = J.getInterceptor$asx(t2);
      t3.$indexSet(t2, "cajas", J.$sub$n(t3.$index(t2, "cajas"), J.$index$asx(ATarima, "cajas")));
      t2 = t1.item_0;
      t3 = J.getInterceptor$asx(t2);
      t3.$indexSet(t2, "kilos", J.$sub$n(t3.$index(t2, "kilos"), J.$index$asx(ATarima, "kilos")));
      M.despliegaProductoFila(t1.item_0);
      if (J.$eq(J.$index$asx(t1.item_0, "cajas"), 0) && J.$le$n(J.$index$asx(t1.item_0, "kilos"), 1)) {
        t2 = $.get$Detalle();
        t2.toString;
        H.IterableMixinWorkaround_removeWhereList(t2, new M.remueveTarimaDetalle_closure0(t1));
        t1 = "#tr" + H.S(J.$index$asx(t1.item_0, "id"));
        J.remove$0$ax(document.querySelector(t1));
      }
    }
  },
  llenaTablaConsultaTarimas: function() {
    var t1 = J.get$tBodies$x($.get$tablaConsultaTarimas())._list;
    if (0 >= t1.length)
      return H.ioore(t1, 0);
    J.clear$0$ax(J.get$children$x(t1[0]));
    W.HttpRequest_getString("/rest/salidas/obtener_consulta_tarimas/" + H.S(J.get$value$x($.get$inpCamaras())) + "/" + H.S(J.get$value$x($.get$inpClavePtoTarima())) + "/" + H.S($.idOrdenSalida), null, null).then$1(new M.llenaTablaConsultaTarimas_closure());
  },
  init: function() {
    var t1, t2;
    t1 = H.interceptedTypeCast(document.querySelector("#btnGuardar"), "$isButtonElement");
    t1.toString;
    t2 = C.EventStreamProvider_click._eventType;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, t2, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.init_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = H.interceptedTypeCast(document.querySelector("#btnCancelar"), "$isButtonElement");
    t1.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, t2, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.init_closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = H.interceptedTypeCast(document.querySelector("#btnAgregar"), "$isButtonElement");
    t1.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, t2, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.init_closure1()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = H.interceptedTypeCast(document.querySelector("#btnAgregarTarimas"), "$isButtonElement");
    t1.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, t2, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.init_closure2()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = $.get$btnCosultarTarimas();
    t1.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, t2, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.init_closure3()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = $.get$btnCancelarCosultarTarimas();
    t1.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, t2, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.init_closure4()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = H.interceptedTypeCast(document.querySelector("#inpProducto"), "$isInputElement");
    t1.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, C.EventStreamProvider_blur._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.init_closure5()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onBlur$x($.get$inpClavePtoTarima());
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.init_closure6()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = H.interceptedTypeCast(document.querySelector("#btnAgregarProducto"), "$isInputElement");
    t1.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, t2, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.init_closure7()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = H.interceptedTypeCast(document.querySelector("#btnCancelarCaptura"), "$isInputElement");
    t1.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, t2, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.init_closure8()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = H.interceptedTypeCast(document.querySelector("#btnCancelarEdicion"), "$isInputElement");
    t1.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, t2, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.init_closure9()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = H.interceptedTypeCast(document.querySelector("#btnCerrar"), "$isButtonElement");
    t1.toString;
    t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, t2, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new M.init_closure10()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    M.llenaCamaras();
  },
  main: [function() {
    M.init();
    M.obtenerOrdenSalida();
  }, "call$0", "main$closure", 0, 0, 1],
  agregaFila_closure: {
    "": "Closure:15;AItem_0,tr_1",
    call$1: function(_) {
      var t1;
      if (window.confirm("\u00bfEliminar registro?") === true) {
        t1 = $.get$Detalle();
        t1.toString;
        H.IterableMixinWorkaround_removeWhereList(t1, new M.agregaFila__closure1(this.AItem_0));
        J.remove$0$ax(this.tr_1);
      }
    }
  },
  agregaFila__closure1: {
    "": "Closure:26;AItem_2",
    call$1: function(x) {
      return J.$eq(J.$index$asx(x, "id"), J.$index$asx(this.AItem_2, "id"));
    }
  },
  agregaFila_closure0: {
    "": "Closure:15;AItem_3",
    call$1: function(_) {
      var t1, t2, pMapaTmp, btnEditarProducto;
      t1 = $.get$Detalle();
      t2 = this.AItem_3;
      t1.toString;
      t1 = H.setRuntimeTypeInfo(new H.WhereIterable(t1, new M.agregaFila__closure(t2)), [null]);
      pMapaTmp = C.JSArray_methods.get$first(P.List_List$from(t1, true, H.getRuntimeTypeArgument(t1, "IterableBase", 0)));
      t1 = J.getInterceptor$asx(pMapaTmp);
      H.interceptedTypeCast(document.querySelector("#inpProductoEdicion"), "$isInputElement").value = t1.$index(pMapaTmp, "producto");
      H.interceptedTypeCast(document.querySelector("#inpDescripcionProductoEdicion"), "$isInputElement").value = t1.$index(pMapaTmp, "descripcion");
      H.interceptedTypeCast(document.querySelector("#inpCajasEdicion"), "$isInputElement").value = J.toString$0(t1.$index(pMapaTmp, "cajas"));
      H.interceptedTypeCast(document.querySelector("#inpKilosEdicion"), "$isInputElement").value = J.toString$0(t1.$index(pMapaTmp, "kilos"));
      R.modal("mdlEditar");
      H.interceptedTypeCast(document.querySelector("#inpCajasEdicion"), "$isInputElement").focus();
      H.interceptedTypeCast(document.querySelector("#inpCajasEdicion"), "$isInputElement").select();
      t1 = $.EventoBotonEditar;
      if (t1 != null)
        t1.cancel$0();
      btnEditarProducto = H.interceptedTypeCast(document.querySelector("#btnEditarProducto"), "$isInputElement");
      btnEditarProducto.toString;
      t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(btnEditarProducto, C.EventStreamProvider_click._eventType, false), [null]);
      t1 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.agregaFila__closure0(t2)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)]);
      t1._tryResume$0();
      $.EventoBotonEditar = t1;
    }
  },
  agregaFila__closure: {
    "": "Closure:26;AItem_4",
    call$1: function(x) {
      return J.$eq(J.$index$asx(x, "id"), J.$index$asx(this.AItem_4, "id"));
    }
  },
  agregaFila__closure0: {
    "": "Closure:15;AItem_5",
    call$1: function(_) {
      var pCajas, pKilos, exception, t1, pMapa;
      pCajas = 0;
      pKilos = 0;
      try {
        pCajas = H.Primitives_parseInt(H.interceptedTypeCast(document.querySelector("#inpCajasEdicion"), "$isInputElement").value, null, null);
      } catch (exception) {
        H.unwrapException(exception);
        pCajas = -1;
      }
      ...
      try {
        pKilos = H.Primitives_parseDouble(H.interceptedTypeCast(document.querySelector("#inpKilosEdicion"), "$isInputElement").value, null);
      } catch (exception) {
        H.unwrapException(exception);
        pKilos = -1;
      }
      ...
      if (J.$lt$n(pKilos, 0)) {
        window.alert("Error, el n\u00famero de kilos no es v\u00e1lido");
        H.interceptedTypeCast(document.querySelector("#inpKilosEdicion"), "$isInputElement").focus();
        return;
      }
      if (J.$gt$n(pCajas, 0) && J.$gt$n(pKilos, 0)) {
        window.alert("Error, solo uno cajas o kilos puede ser mayor a cero, ambos no");
        H.interceptedTypeCast(document.querySelector("#inpCajasEdicion"), "$isInputElement").focus();
        return;
      }
      if (J.$eq(pCajas, 0) && J.$eq(pKilos, 0)) {
        window.alert("Error, debe poner cajas o kilos con un valor mayor a cero");
        H.interceptedTypeCast(document.querySelector("#inpCajasEdicion"), "$isInputElement").focus();
        return;
      }
      t1 = $.get$Detalle();
      t1.toString;
      t1 = H.setRuntimeTypeInfo(new H.WhereIterable(t1, new M.agregaFila___closure(this.AItem_5)), [null]);
      pMapa = C.JSArray_methods.get$first(P.List_List$from(t1, true, H.getRuntimeTypeArgument(t1, "IterableBase", 0)));
      t1 = J.getInterceptor$ax(pMapa);
      t1.$indexSet(pMapa, "cajas", pCajas);
      t1.$indexSet(pMapa, "kilos", pKilos);
      M.despliegaProductoFila(pMapa);
      R.cierra_modal("mdlEditar");
    }
  },
  agregaFila___closure: {
    "": "Closure:26;AItem_6",
    call$1: function(x) {
      return J.$eq(J.$index$asx(x, "id"), J.$index$asx(this.AItem_6, "id"));
    }
  },
  llenaListaTarimasOrden_closure: {
    "": "Closure:0;",
    call$1: function(Data) {
      $.ListaTarimas = C.C_JsonCodec.decode$1(Data);
    }
  },
  obtenerOrdenSalida_closure: {
    "": "Closure:0;",
    call$1: function(Data) {
      M.despliegaEntidad(C.C_JsonCodec.decode$1(Data));
    }
  },
  obtenerOrdenSalida_closure0: {
    "": "Closure:15;",
    call$1: function(_) {
      M.llenaListaTarimasOrden();
    }
  },
  guardarOrdenSalida_closure: {
    "": "Closure:27;",
    call$1: function(ARequest) {
      var pResult, t1;
      pResult = C.C_JsonCodec.decode$1(J.get$responseText$x(ARequest));
      t1 = J.getInterceptor$asx(pResult);
      window.alert(t1.$index(pResult, "mensaje"));
      if (t1.$index(pResult, "error") === true)
        return;
      else
        J.set$href$x(C.Window_methods.get$location(window), "/salidas");
    }
  },
  onBlurProducto_closure: {
    "": "Closure:15;",
    call$1: function(data) {
      var pMap, t1;
      ...
      if (!J.$eq(t1.$index(pMap, "clave"), "0")) {
        H.interceptedTypeCast(document.querySelector("#inpDescripcionProducto"), "$isInputElement").value = t1.$index(pMap, "descripcion");
        H.interceptedTypeCast(document.querySelector("#inpCajas"), "$isInputElement").focus();
      } else {
  ...
  onBlurProductoConsultaTarimas_closure: {
    "": "Closure:15;",
    call$1: function(data) {
      var pMap, t1;
      pMap = C.C_JsonCodec.decode$1(data);
      ...
      t1.$index(pMap, "clave");
      if (!J.$eq(t1.$index(pMap, "clave"), "0")) {
        J.set$value$x($.get$inpNombrePtoTarima(), t1.$index(pMap, "descripcion"));
        $.get$inpCamaras().focus();
      } else {
        window.alert("No existe el producto");
        $.get$inpClavePtoTarima().focus();
        J.set$value$x($.get$inpNombrePtoTarima(), "");
      }
    }
  },
  agregarProducto_closure: {
    "": "Closure:26;pMapa_0",
    call$1: function(x) {
      var t1 = this.pMapa_0;
      return J.$eq(J.$index$asx(x, "producto"), t1.$index(t1, "producto"));
    }
  },
  cerrarOrden_closure: {
    "": "Closure:15;",
  ...
  cerrarOrden_closure0: {
    "": "Closure:27;",
    call$1: function(ARequest) {
      W.HttpRequest_request("/rest/salidas/crear_salida_embarques/" + H.S($.idOrdenSalida), "POST", null, null, null, null, "_", null).then$1(new M.cerrarOrden__closure());
    }
  },
  cerrarOrden__closure: {
    "": "Closure:27;",
    call$1: function(ARequest) {
      var pResult = C.C_JsonCodec.decode$1(J.get$responseText$x(ARequest));
      window.alert(J.$index$asx(pResult, "mensaje"));
      J.set$display$x(H.interceptedTypeCast(document.querySelector("#btnGuardar"), "$isButtonElement").style, "none");
      J.set$display$x(H.interceptedTypeCast(document.querySelector("#btnCerrar"), "$isButtonElement").style, "none");
      H.interceptedTypeCast(document.querySelector("#spanEstado"), "$isSpanElement").textContent = "Cerrado";
    }
  },
  llenaCamaras_closure: {
    "": "Closure:0;",
    call$1: function(Data) {
      var t1, item, t2, t3;
      for (t1 = J.get$iterator$ax(C.C_JsonCodec.decode$1(Data)); t1.moveNext$0();) {
        item = t1.get$current();
        t2 = J.get$children$x($.get$inpCamaras());
        t3 = J.getInterceptor$asx(item);
        t2.add$1(t2, W.Element_Element$html("<option value=\"" + H.S(t3.$index(item, "id")) + "\">" + H.S(t3.$index(item, "descripcion")) + "</option>", null, null));
      }
    }
  },
  agregaTarimaDetalle_closure: {
    "": "Closure:26;ATarima_0",
    call$1: function(x) {
      return J.$eq(J.$index$asx(x, "producto"), J.$index$asx(this.ATarima_0, "producto"));
    }
  },
  remueveTarimaDetalle_closure: {
    "": "Closure:26;ATarima_1",
    call$1: function(x) {
      return J.$eq(J.$index$asx(x, "producto"), J.$index$asx(this.ATarima_1, "producto"));
    }
  },
  remueveTarimaDetalle_closure0: {
    "": "Closure:26;box_0",
    call$1: function(x) {
      return J.$eq(J.$index$asx(x, "id"), J.$index$asx(this.box_0.item_0, "id"));
    }
  },
  llenaTablaConsultaTarimas_closure: {
    "": "Closure:0;",
    call$1: function(Data) {
      var t1, t2, item, tr, t3, chkFolio, t4, t5, td;
      for (t1 = J.get$iterator$ax(C.C_JsonCodec.decode$1(Data)), t2 = C.EventStreamProvider_click._eventType; t1.moveNext$0();) {
        item = t1.get$current();
        tr = document.createElement("tr", null);
        t3 = J.getInterceptor$asx(item);
        tr.id = "trt" + H.S(t3.$index(item, "folio"));
        chkFolio = W.InputElement_InputElement("checkbox");
        t4 = J.where$1$ax($.get$ListaTarimas(), new M.llenaTablaConsultaTarimas__closure(item));
        t4 = t4.get$length(t4);
        if (typeof t4 !== "number")
          return t4.$gt();
        if (t4 > 0)
          J.set$checked$x(chkFolio, true);
        chkFolio.toString;
        t4 = new W._ElementEventStreamImpl(chkFolio, t2, false);
        t4.$builtinTypeInfo = [null];
        t5 = new W._EventStreamSubscription(0, chkFolio, t2, W._wrapZone(new M.llenaTablaConsultaTarimas__closure0(item, chkFolio)), false);
        t5.$builtinTypeInfo = [H.getTypeArgumentByIndex(t4, 0)];
        t4 = t5._onData;
        if (t4 != null && t5._pauseCount <= 0)
          J.addEventListener$3$x(t5._target, t2, t4, false);
        td = document.createElement("td", null);
        t4 = J.get$children$x(td);
        t4.add$1(t4, chkFolio);
        t4 = J.getInterceptor$x(tr);
        t5 = t4.get$children(tr);
        t5.add$1(t5, td);
        td = document.createElement("td", null);
        td.textContent = H.S(t3.$index(item, "folio"));
        t5 = t4.get$children(tr);
        t5.add$1(t5, td);
        td = document.createElement("td", null);
        td.textContent = H.S(t3.$index(item, "descripcion"));
        t5 = t4.get$children(tr);
        t5.add$1(t5, td);
        td = document.createElement("td", null);
        td.textContent = H.S(t3.$index(item, "cajas"));
        t5 = t4.get$children(tr);
        t5.add$1(t5, td);
        td = document.createElement("td", null);
        t5 = $.get$pNumberFormat();
        td.textContent = t5.format$1(t5, t3.$index(item, "kilos"));
        t4 = t4.get$children(tr);
        t4.add$1(t4, td);
        t4 = J.get$tBodies$x($.get$tablaConsultaTarimas())._list;
        if (0 >= t4.length)
          return H.ioore(t4, 0);
  ...
  llenaTablaConsultaTarimas__closure: {
    "": "Closure:28;item_0",
    call$1: function(x) {
      return J.$eq(x, J.$index$asx(this.item_0, "folio"));
    }
  },
  llenaTablaConsultaTarimas__closure0: {
    "": "Closure:15;item_1,chkFolio_2",
    call$1: function(_) {
      var t1 = this.item_1;
      if (J.get$checked$x(this.chkFolio_2) === true) {
        J.add$1$ax($.get$ListaTarimas(), J.$index$asx(t1, "folio"));
        M.agregaTarimaDetalle(t1);
      } else {
        J.removeWhere$1$ax($.get$ListaTarimas(), new M.llenaTablaConsultaTarimas___closure(t1));
        M.remueveTarimaDetalle(t1);
      }
    }
  },
  llenaTablaConsultaTarimas___closure: {
    "": "Closure:28;item_3",
    call$1: function(x) {
      return J.$eq(x, J.$index$asx(this.item_3, "folio"));
    }
  },
  init_closure: {
    "": "Closure:15;",
    call$1: function(_) {
      M.guardarOrdenSalida();
    }
  },
  init_closure0: {
    "": "Closure:15;",
    call$1: function(_) {
      if (window.confirm("\u00bfCancelar captura de salida?") === true)
        J.set$href$x(C.Window_methods.get$location(window), "/salidas");
    }
  },
  init_closure1: {
  ...
  init_closure3: {
    "": "Closure:15;",
    call$1: function(_) {
      M.llenaTablaConsultaTarimas();
    }
  },
  init_closure4: {
    "": "Closure:15;",
    call$1: function(_) {
      R.cierra_modal("mdlConsultaTarimas");
    }
  },
  init_closure5: {
    "": "Closure:15;",
  ...
  init_closure6: {
    "": "Closure:15;",
    call$1: function(_) {
      M.onBlurProductoConsultaTarimas();
    }
  },
  init_closure7: {
    "": "Closure:15;",
...
Isolate.$lazy($, "Detalle", "Detalle", "get$Detalle", function() {
  return H.setRuntimeTypeInfo([], [P.Map]);
});
Isolate.$lazy($, "pNumberFormat", "pNumberFormat", "get$pNumberFormat", function() {
  return T.NumberFormat_NumberFormat("#,##0.00", null);
});
Isolate.$lazy($, "inpClavePtoTarima", "inpClavePtoTarima", "get$inpClavePtoTarima", function() {
  return document.querySelector("#inpClavePtoTarima");
});
Isolate.$lazy($, "btnCosultarTarimas", "btnCosultarTarimas", "get$btnCosultarTarimas", function() {
  return document.querySelector("#btnCosultarTarimas");
});
Isolate.$lazy($, "btnCancelarCosultarTarimas", "btnCancelarCosultarTarimas", "get$btnCancelarCosultarTarimas", function() {
  return document.querySelector("#btnCancelarCosultarTarimas");
});
Isolate.$lazy($, "inpNombrePtoTarima", "inpNombrePtoTarima", "get$inpNombrePtoTarima", function() {
  return document.querySelector("#inpNombrePtoTarima");
});
Isolate.$lazy($, "inpCamaras", "inpCamaras", "get$inpCamaras", function() {
  return document.querySelector("#inpCamaras");
});
Isolate.$lazy($, "tablaConsultaTarimas", "tablaConsultaTarimas", "get$tablaConsultaTarimas", function() {
  return document.querySelector("#tablaConsultaTarimas");
});
Isolate.$lazy($, "ListaTarimas", "ListaTarimas", "get$ListaTarimas", function() {
  return H.setRuntimeTypeInfo([], [J.JSInt]);
});
Isolate.$lazy($, "nf", "nf", "get$nf", function() {
  return T.NumberFormat_NumberFormat("###,###.00", null);
});
// Native classes
...
//# sourceMappingURL=orden_salida.dart.js.map
//@ sourceMappingURL=orden_salida.dart.js.map
