...
["", "ordern_de_produccion.dart", , Q, {
  ...
  ObtenerEntidad: function() {
    var pOrdenProduccion, exception;
    pOrdenProduccion = new M.OrdenProduccion(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    J.set$id$x(pOrdenProduccion, H.Primitives_parseInt(J.get$value$x(H.interceptedTypeCast(document.querySelector("#id"), "$isHiddenInputElement")), null, null));
    pOrdenProduccion.set$id_usuario(H.Primitives_parseInt(H.interceptedTypeCast(document.querySelector("#id_usuario"), "$isInputElement").value, null, null));
    pOrdenProduccion.set$id_tipo(H.Primitives_parseInt(J.get$value$x(H.interceptedTypeCast(document.querySelector("#id_tipo"), "$isHiddenInputElement")), null, null));
    pOrdenProduccion.set$descripcion(H.interceptedTypeCast(document.querySelector("#id_orden"), "$isInputElement").value);
    pOrdenProduccion.set$fecha(H.interceptedTypeCast(document.querySelector("#fecha"), "$isInputElement").value);
    pOrdenProduccion.set$lote_produccion(H.interceptedTypeCast(document.querySelector("#lote_produccion"), "$isInputElement").value);
    pOrdenProduccion.set$estado(H.interceptedTypeCast(document.querySelector("#spanEstado"), "$isSpanElement").textContent);
    pOrdenProduccion.set$clase(H.Primitives_parseInt(H.interceptedTypeCast(document.querySelector("#inpClase"), "$isSelectElement").value, null, null));
    pOrdenProduccion.set$validar_productos(H.interceptedTypeCast(document.querySelector("#inpValida"), "$isSelectElement").value);
    try {
      pOrdenProduccion.set$pedimento(H.Primitives_parseInt(H.interceptedTypeCast(document.querySelector("#inpPedimento"), "$isInputElement").value, null, null));
    } catch (exception) {
      H.unwrapException(exception);
      pOrdenProduccion.set$pedimento(0);
    }

    pOrdenProduccion.set$valida_surtido_antes_producir(H.interceptedTypeCast(document.querySelector("#inpValidaSurtido"), "$isSelectElement").value);
    pOrdenProduccion.set$FolioEmpaque($.pFolioEmpaque);
    return pOrdenProduccion;
  },
  guardar: function() {
    var t1, p_map, pData, headers, pUrl, pMethod;
    t1 = Q.ObtenerEntidad();
    $.POrdenProduccion = t1;
    if (J.trim$0$s(t1.descripcion).length === 0) {
    ...
    p_map.$indexSet(p_map, "salida_empaque", t1.FolioEmpaque);
  ...
  main: [function() {
    ...
    t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(btnCancelar, t1, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Q.main_closure15()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = J.get$onBlur$x(document.querySelector("#mClave"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Q.main_closure16()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = document.querySelector("#anchorFolioEmpaque");
    t2.toString;
    t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t2, t1, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Q.main_closure17()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = document.querySelector("#btnEmpaqueAceptar");
    t2.toString;
    t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t2, t1, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Q.main_closure18()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = document.querySelector("#btnCerrarEmpaque");
    t2.toString;
    t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t2, t1, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Q.main_closure19()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = document.querySelector("#btnCerrarEmpaque2");
    t2.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t2, t1, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Q.main_closure20()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    P.Timer_Timer(C.Duration_0, new Q.main_closure21());
  ...
  ObtenerOrdenProduccion___closure0: {
    ...
    call$1: function(Data) {
      ...
      J.setInnerHtml$1$x(H.interceptedTypeCast(document.querySelector("#anchorFolioEmpaque"), "$isAnchorElement"), J.toString$0(t1.FolioEmpaque));
      $.pFolioEmpaque = t1.FolioEmpaque;
      return;
    }
  },
  ...
  main_closure17: {
    ...
    call$1: function(_) {
      R.modal("mdlEmpaque");
      H.interceptedTypeCast(document.querySelector("#inpEmpaque"), "$isInputElement").value = J.toString$0($.pFolioEmpaque);
      H.interceptedTypeCast(document.querySelector("#inpEmpaque"), "$isInputElement").focus();
      H.interceptedTypeCast(document.querySelector("#inpEmpaque"), "$isInputElement").select();
    }
  },
  main_closure18: {
    "": "Closure:15;",
    call$1: function(_) {
      var pFolioEmpaqueTmp = H.Primitives_parseInt(H.interceptedTypeCast(document.querySelector("#inpEmpaque"), "$isInputElement").value, null, new Q.main__closure());
      if (J.$ge$n(pFolioEmpaqueTmp, 0)) {
        $.pFolioEmpaque = pFolioEmpaqueTmp;
        H.interceptedTypeCast(document.querySelector("#anchorFolioEmpaque"), "$isAnchorElement").textContent = J.toString$0($.pFolioEmpaque);
        R.cierra_modal("mdlEmpaque");
      } else {
        window.alert("El folio de empaque no es v\u00e1lido");
        H.interceptedTypeCast(document.querySelector("#inpEmpaque"), "$isInputElement").focus();
        H.interceptedTypeCast(document.querySelector("#inpEmpaque"), "$isInputElement").select();
      }
    }
