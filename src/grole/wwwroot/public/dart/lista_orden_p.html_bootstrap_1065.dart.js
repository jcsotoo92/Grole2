...
OrdenProduccion: {"": "Observable;_LibOrdenProduccion$__$id,_LibOrdenProduccion$__$fecha,_LibOrdenProduccion$__$id_usuario,_LibOrdenProduccion$__$id_usuario_embarques,_LibOrdenProduccion$__$id_tipo,_LibOrdenProduccion$__$descripcion,_LibOrdenProduccion$__$kilos_produccion,_LibOrdenProduccion$__$rendimiento,_LibOrdenProduccion$__$estado,_LibOrdenProduccion$__$lote_produccion,_LibOrdenProduccion$__$clase,_LibOrdenProduccion$__$nombre_clase,_LibOrdenProduccion$__$folio_sap,_LibOrdenProduccion$__$usuario,$$_observers,$$_changes,hashCode",
  get$id: function(_) {
  ...
  get$fecha: function() {
    ...
    return this._LibOrdenProduccion$__$fecha;
  },
  get$id_usuario: function() {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this, 1, "id_usuario");
    return this._LibOrdenProduccion$__$id_usuario;
  },
  get$id_usuario_embarques: function() {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this, 1, "id_usuario_embarques");
    return this._LibOrdenProduccion$__$id_usuario_embarques;
  },
  get$id_tipo: function() {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this, 1, "id_tipo");
    return this._LibOrdenProduccion$__$id_tipo;
  },
  get$descripcion: function() {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this, 1, "descripcion");
    return this._LibOrdenProduccion$__$descripcion;
  },
  get$kilos_produccion: function() {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this, 1, "kilos_produccion");
    return this._LibOrdenProduccion$__$kilos_produccion;
  },
  get$rendimiento: function() {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this, 1, "rendimiento");
    return this._LibOrdenProduccion$__$rendimiento;
  },
  get$estado: function() {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this, 1, "estado");
    return this._LibOrdenProduccion$__$estado;
  },
  set$estado: function(value) {
    var t1 = this.$$_observers;
    if (t1 != null && t1._head != null)
      T.notifyChange(this, 1, "estado", this._LibOrdenProduccion$__$estado, value);
    this._LibOrdenProduccion$__$estado = value;
  },
  get$lote_produccion: function() {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this, 1, "lote_produccion");
    return this._LibOrdenProduccion$__$lote_produccion;
  },
  get$nombre_clase: function() {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this, 1, "nombre_clase");
    return this._LibOrdenProduccion$__$nombre_clase;
  },
  get$folio_sap: function() {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this, 1, "folio_sap");
    return this._LibOrdenProduccion$__$folio_sap;
  },
  get$usuario: function() {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this, 1, "usuario");
    return this._LibOrdenProduccion$__$usuario;
  },
  ToJson$0: function() {
    var p_map = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
    p_map.$indexSet(p_map, "id", this.get$id(this));
    p_map.$indexSet(p_map, "fecha", this.get$fecha());
    p_map.$indexSet(p_map, "id_usuario", this.get$id_usuario());
    p_map.$indexSet(p_map, "id_usuario_embarques", this.get$id_usuario_embarques());
    p_map.$indexSet(p_map, "id_tipo", this.get$id_tipo());
    p_map.$indexSet(p_map, "descripcion", this.get$descripcion());
    p_map.$indexSet(p_map, "kilos_produccion", this.get$kilos_produccion());
    p_map.$indexSet(p_map, "rendimiento", this.get$rendimiento());
    p_map.$indexSet(p_map, "estado", this.get$estado());
    p_map.$indexSet(p_map, "lote_produccion", J.toString$0(this.get$lote_produccion()));
    p_map.$indexSet(p_map, "nombre_clase", this.get$nombre_clase());
    p_map.$indexSet(p_map, "folio_sap", this.get$folio_sap());
    return P.stringify(p_map, null);
  },
  $isOrdenProduccion: true
}}],
...
["bootstrap", "lista_orden_p.html_bootstrap.dart", , Y, {
main0: function() {
  $.useObservers = true;
  K.main();
  K.init_autogenerated();
}},
1],
...
_ForwardingStreamSubscription: {"": "_BufferingStreamSubscription;_stream,_async$_subscription,_onData,_onError,_onDone,_zone,_state,_pending",
  _async$_add$1: function(data) {
    if ((this._state & 2) !== 0)
      return;
...
ShowHide__populateState: function(element) {
  var t1, currentValues, computedStyle, tagDefaultDisplay, t2, localDisplay, computedDisplay, inferredState;
  ...
  t2 = $.get$ShowHide__defaultDisplays();
  t2.putIfAbsent$2(t2, t1.get$tagName(element), new Y.ShowHide__populateState_closure(tagDefaultDisplay));
...
DateFormat: {"": "Object;_locale,_intl$_pattern,_formatFieldsPrivate",
  ...
  addPattern$2: function(inputPattern, separator) {
    ...
    t2 = this._locale;
    t1.toString;
    if (J.containsKey$1$x(J.$eq(t2, "en_US") ? t1.fallbackData : t1._throwException$0(), inputPattern) !== true)
...
["lista_orden_p_html", "lista_orden_p.dart", , K, {
llena_lista_consulta: function(data) {
  var t1, p_lista, pClase, i, item, t2;
  t1 = $.get$ListaOrdenP();
  t1.set$length(t1, 0);
  p_lista = P.parse(data, null);
  if (typeof p_lista !== "string" && (typeof p_lista !== "object" || p_lista === null || p_lista.constructor !== Array && !H.isJsIndexable(p_lista, p_lista[init.dispatchPropertyName])))
    return K.llena_lista_consulta$bailout(1, p_lista);
  pClase = J.get$value$x(document.querySelector("#inpClase"));
  window.localStorage.setItem("Clase", pClase);
  for (i = 0; i <= p_lista.length - 1; ++i) {
    t1 = $.Observable_$_nextHashCode + 1;
    $.Observable_$_nextHashCode = t1;
    item = new M.OrdenProduccion(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t1);
    t1 = J.$index$asx(p_lista[i], "id");
    t2 = item.$$_observers;
    if (t2 != null && t2._head != null)
      T.notifyChange(item, 1, "id", item._LibOrdenProduccion$__$id, t1);
    item._LibOrdenProduccion$__$id = t1;
    if (i >= p_lista.length)
      throw H.ioore(p_lista, i);
    t1 = J.$index$asx(p_lista[i], "descripcion");
    t2 = item.$$_observers;
    if (t2 != null && t2._head != null)
      T.notifyChange(item, 1, "descripcion", item._LibOrdenProduccion$__$descripcion, t1);
    item._LibOrdenProduccion$__$descripcion = t1;
    if (i >= p_lista.length)
      throw H.ioore(p_lista, i);
    t1 = J.$index$asx(p_lista[i], "fecha");
    t2 = item.$$_observers;
    if (t2 != null && t2._head != null)
      T.notifyChange(item, 1, "fecha", item._LibOrdenProduccion$__$fecha, t1);
    item._LibOrdenProduccion$__$fecha = t1;
    t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(item, 1, "fecha");
    t1 = J.substring$2$s(item._LibOrdenProduccion$__$fecha, 0, 10);
    t2 = item.$$_observers;
    if (t2 != null && t2._head != null)
      T.notifyChange(item, 1, "fecha", item._LibOrdenProduccion$__$fecha, t1);
    item._LibOrdenProduccion$__$fecha = t1;
    if (i >= p_lista.length)
      throw H.ioore(p_lista, i);
    t1 = J.$index$asx(p_lista[i], "lote_produccion");
    t2 = item.$$_observers;
    if (t2 != null && t2._head != null)
      T.notifyChange(item, 1, "lote_produccion", item._LibOrdenProduccion$__$lote_produccion, t1);
    item._LibOrdenProduccion$__$lote_produccion = t1;
    if (i >= p_lista.length)
      throw H.ioore(p_lista, i);
    t1 = J.$index$asx(p_lista[i], "nombre_clase");
    t2 = item.$$_observers;
    if (t2 != null && t2._head != null)
      T.notifyChange(item, 1, "nombre_clase", item._LibOrdenProduccion$__$nombre_clase, t1);
    item._LibOrdenProduccion$__$nombre_clase = t1;
    if (i >= p_lista.length)
      throw H.ioore(p_lista, i);
    t1 = J.$index$asx(p_lista[i], "estado");
    t2 = item.$$_observers;
    if (t2 != null && t2._head != null)
      T.notifyChange(item, 1, "estado", item._LibOrdenProduccion$__$estado, t1);
    item._LibOrdenProduccion$__$estado = t1;
    if (i >= p_lista.length)
      throw H.ioore(p_lista, i);
    t1 = J.$index$asx(p_lista[i], "clase");
    t2 = item.$$_observers;
    if (t2 != null && t2._head != null)
      T.notifyChange(item, 1, "clase", item._LibOrdenProduccion$__$clase, t1);
    item._LibOrdenProduccion$__$clase = t1;
    if (i >= p_lista.length)
      throw H.ioore(p_lista, i);
    t1 = J.$index$asx(p_lista[i], "folio_sap");
    t2 = item.$$_observers;
    if (t2 != null && t2._head != null)
      T.notifyChange(item, 1, "folio_sap", item._LibOrdenProduccion$__$folio_sap, t1);
    item._LibOrdenProduccion$__$folio_sap = t1;
    if (i >= p_lista.length)
      throw H.ioore(p_lista, i);
    t1 = J.$index$asx(p_lista[i], "usuario");
    t2 = item.$$_observers;
    if (t2 != null && t2._head != null)
      T.notifyChange(item, 1, "usuario", item._LibOrdenProduccion$__$usuario, t1);
    item._LibOrdenProduccion$__$usuario = t1;
    if (J.$gt$n(H.Primitives_parseInt(pClase, null, null), 0)) {
      t1 = $._activeObserver;
      if (t1 != null)
        t1._addRead$3(item, 1, "clase");
      if (J.$eq(item._LibOrdenProduccion$__$clase, H.Primitives_parseInt(pClase, null, null))) {
        t1 = $.get$ListaOrdenP();
        t1.add$1(t1, item);
      }
    } else {
...
llena_lista_consulta$bailout: function(state0, p_lista) {
  var pClase, t1, i, t2, item, t3;
  pClase = J.get$value$x(document.querySelector("#inpClase"));
  window.localStorage.setItem("Clase", pClase);
  t1 = J.getInterceptor$asx(p_lista);
  i = 0;
  while (true) {
    t2 = J.$sub$n(t1.get$length(p_lista), 1);
    if (typeof t2 !== "number")
      throw H.iae(t2);
    if (!(i <= t2))
      break;
    ...
    item = new M.OrdenProduccion(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t2);
    t2 = J.$index$asx(t1.$index(p_lista, i), "id");
    t3 = item.$$_observers;
    if (t3 != null && t3._head != null)
      T.notifyChange(item, 1, "id", item._LibOrdenProduccion$__$id, t2);
    item._LibOrdenProduccion$__$id = t2;
    t2 = J.$index$asx(t1.$index(p_lista, i), "descripcion");
    t3 = item.$$_observers;
    if (t3 != null && t3._head != null)
      T.notifyChange(item, 1, "descripcion", item._LibOrdenProduccion$__$descripcion, t2);
    item._LibOrdenProduccion$__$descripcion = t2;
    t2 = J.$index$asx(t1.$index(p_lista, i), "fecha");
    t3 = item.$$_observers;
    if (t3 != null && t3._head != null)
      T.notifyChange(item, 1, "fecha", item._LibOrdenProduccion$__$fecha, t2);
    item._LibOrdenProduccion$__$fecha = t2;
    t2 = $._activeObserver;
    if (t2 != null)
      t2._addRead$3(item, 1, "fecha");
    t2 = J.substring$2$s(item._LibOrdenProduccion$__$fecha, 0, 10);
    t3 = item.$$_observers;
    if (t3 != null && t3._head != null)
      T.notifyChange(item, 1, "fecha", item._LibOrdenProduccion$__$fecha, t2);
    item._LibOrdenProduccion$__$fecha = t2;
    t2 = J.$index$asx(t1.$index(p_lista, i), "lote_produccion");
    t3 = item.$$_observers;
    if (t3 != null && t3._head != null)
      T.notifyChange(item, 1, "lote_produccion", item._LibOrdenProduccion$__$lote_produccion, t2);
    item._LibOrdenProduccion$__$lote_produccion = t2;
    t2 = J.$index$asx(t1.$index(p_lista, i), "nombre_clase");
    t3 = item.$$_observers;
    if (t3 != null && t3._head != null)
      T.notifyChange(item, 1, "nombre_clase", item._LibOrdenProduccion$__$nombre_clase, t2);
    item._LibOrdenProduccion$__$nombre_clase = t2;
    t2 = J.$index$asx(t1.$index(p_lista, i), "estado");
    t3 = item.$$_observers;
    if (t3 != null && t3._head != null)
      T.notifyChange(item, 1, "estado", item._LibOrdenProduccion$__$estado, t2);
    item._LibOrdenProduccion$__$estado = t2;
    t2 = J.$index$asx(t1.$index(p_lista, i), "clase");
    t3 = item.$$_observers;
    if (t3 != null && t3._head != null)
      T.notifyChange(item, 1, "clase", item._LibOrdenProduccion$__$clase, t2);
    item._LibOrdenProduccion$__$clase = t2;
    t2 = J.$index$asx(t1.$index(p_lista, i), "folio_sap");
    t3 = item.$$_observers;
    if (t3 != null && t3._head != null)
      T.notifyChange(item, 1, "folio_sap", item._LibOrdenProduccion$__$folio_sap, t2);
    item._LibOrdenProduccion$__$folio_sap = t2;
    t2 = J.$index$asx(t1.$index(p_lista, i), "usuario");
    t3 = item.$$_observers;
    if (t3 != null && t3._head != null)
      T.notifyChange(item, 1, "usuario", item._LibOrdenProduccion$__$usuario, t2);
    item._LibOrdenProduccion$__$usuario = t2;
    if (J.$gt$n(H.Primitives_parseInt(pClase, null, null), 0)) {
      t2 = $._activeObserver;
      if (t2 != null)
        t2._addRead$3(item, 1, "clase");
      if (J.$eq(item._LibOrdenProduccion$__$clase, H.Primitives_parseInt(pClase, null, null))) {
        t2 = $.get$ListaOrdenP();
        t2.add$1(t2, item);
      }
...
LlenaOrdenProduccion: function() {
  var pFechaIni, pFechaFin, pFiltro;
  pFechaIni = J.get$value$x(document.querySelector("#fecha"));
  pFechaFin = J.get$value$x(document.querySelector("#fechafin"));
  pFiltro = J.get$value$x(document.querySelector("#filtro"));
  window.localStorage.setItem("FechaInicial", pFechaIni);
  window.localStorage.setItem("FechaFinal", pFechaFin);
  window.localStorage.setItem("Filtro", pFiltro);
  pFechaIni = J.replaceAll$2$s(pFechaIni, "/", "%2F");
  pFechaFin = J.replaceAll$2$s(pFechaFin, "/", "%2F");
  W.HttpRequest_getString("http://localhost:8031/rest/ordenp/OrdenProduccion_obtener_lista/" + pFechaIni + "/" + pFechaFin + "/" + H.S(pFiltro), null, null).then$1(K.llena_lista_consulta$closure);
},

agregar: function() {
  if (!$.editable) {
    window.alert("No tiene derecho a esta opci\u00f3n");
    return;
  }
  W.HttpRequest_getString("http://localhost:8031/rest/dias_ultima_orden/" + H.S(J.get$value$x(document.querySelector("#idUsuario"))), null, null).then$1(new K.agregar_closure());
},

tiene_derecho_modificar: function() {
  return W.HttpRequest_getString("http://localhost:8031/rest/usuarios/usuario_tiene_derecho/5/40", null, null);
},

tiene_derecho_eliminar: function() {
  return W.HttpRequest_getString("http://localhost:8031/rest/usuarios/usuario_tiene_derecho_eliminar_orden/4/40", null, null);
},
...
modificar: function(item) {
  ...
  if (J.$eq(item.get$estado(), "Eliminado")) {
    window.alert("No se puede modificar una orde eliminada");
    return;
  }
  P.Future_Future(K.tiene_derecho_modificar$closure, J.JSString).then$1(new K.modificar_closure(item));
},

surtir: function(item) {
  var pFecha;
  if (J.$eq(item.get$estado(), "Eliminado")) {
    window.alert("No se puede surtir una orden eliminada");
    return;
  }
  pFecha = J.get$value$x(document.querySelector("#fecha"));
  J.set$href$x(C.Window_methods.get$location(window), "http://localhost:8031/surtir_orden?id=" + H.S(J.toString$0(J.get$id$x(item))) + "&fecha=" + H.S(pFecha));
},
...
eliminar: function(item) {
  ...
  if (!J.$eq(item.get$estado(), "Nuevo")) {
    window.alert("No se pueden eliminar Ordenes que no son nuevas");
    return;
  }
  P.Future_Future(K.tiene_derecho_eliminar$closure, J.JSString).then$1(new K.eliminar_closure(item));
},

buscar: function() {
  J.show$0$x(J.get$xtag$x(document.querySelector("#mdlBuscar")));
  J.focus$0$x(document.querySelector("#pFolio"));
},

buscaFolio: function() {
  J.get$xtag$x(document.querySelector("#mdlBuscar")).hide$0();
  W.HttpRequest_getString(C.JSString_methods.$add("http://localhost:8031/rest/ordenp/OrdenProduccion_obtener_lista_folio/", J.get$value$x(document.querySelector("#pFolio"))), null, null).then$1(K.llena_lista_consulta$closure);
},

cambiarEstado: function(AOrdenProduccion) {
  if (!$.editable) {
    window.alert("No tiene derecho a esta opci\u00f3n");
    return;
  }
  W.HttpRequest_getString("http://localhost:8031/rest/puede_cambiar_estado/" + H.S(J.get$value$x(document.querySelector("#idUsuario"))), null, null).then$1(new K.cambiarEstado_closure(AOrdenProduccion));
},

setCambiarEstado: function() {
  var pEstado = J.get$value$x(document.querySelector("#inpEstado"));
  if (J.$eq(pEstado, $.pOrdenProduccion.get$estado())) {
    window.alert("No se puede cambiar al estado actual");
    return;
  }
  W.HttpRequest_request("http://localhost:8031/rest/cambiar_estado_orden_produccion/" + H.S(J.get$id$x($.pOrdenProduccion)) + "/" + H.S(pEstado), "PUT", null, null, null, null, "", null).then$1(new K.setCambiarEstado_closure(pEstado));
},

main: function() {
  var t1, t2;
  $.editable = J.get$value$x(H.interceptedTypeCast(document.querySelector("#inpEditable"), "$isHiddenInputElement")) === "true";
  t1 = J.get$classes$x(document.querySelector("#mdlBuscar"));
  t1.remove$1(t1, "hiden");
  t1 = J.get$classes$x(document.querySelector("#mdlCambiarEstado"));
  t1.remove$1(t1, "hiden");
  if (window.localStorage.getItem("FechaInicial") != null)
    H.interceptedTypeCast(document.querySelector("#fecha"), "$isInputElement").value = window.localStorage.getItem("FechaInicial");
  else {
    t1 = H.interceptedTypeCast(document.querySelector("#fecha"), "$isInputElement");
    ...
    t1.value = t2.format$1(t2, P.DateTime$_now());
  }
  if (window.localStorage.getItem("FechaFinal") != null)
    H.interceptedTypeCast(document.querySelector("#fechafin"), "$isInputElement").value = window.localStorage.getItem("FechaFinal");
  else {
    t1 = H.interceptedTypeCast(document.querySelector("#fechafin"), "$isInputElement");
    t2 = new T.DateFormat(null, null, null);
    t2._locale = T.Intl_verifiedLocale(null, T.DateFormat_localeExists$closure, T.Intl__throwLocaleError$closure);
    t2.addPattern$1("dd/MM/yyyy");
    t1.value = t2.format$1(t2, P.DateTime$_now());
  ...
  if (window.localStorage.getItem("FechaFinal") != null)
    J.set$value$x(document.querySelector("#filtro"), window.localStorage.getItem("Filtro"));
  else
    J.set$value$x(document.querySelector("#filtro"), "Todos");
  W.HttpRequest_getString("http://localhost:8031/rest/clase_ordenp_obtener_lista", null, null).then$1(new K.main_closure());
},

init_autogenerated: function() {
  var __root, __html0, __html1, __t, t1, t2, __e27, t3, __e29;
  __root = $.get$webUIRoot();
  __html0 = W.Element_Element$html("<option template=\"\" repeat=\"item in ListaClases\"></option>", $.get$nullTreeSanitizer(), null);
  __html1 = V.createSafeNode("tbody", H.fillLiteralMap(["template", "", "repeat", "item in ListaOrdenP"], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), "\n              <tr>\n                <td></td>\n                <td></td>\n                <td></td>\n                <td style=\"text-align: center\"></td>\n                <td style=\"text-align: center\"></td>\n                <td style=\"text-align: center\"></td>\n                <td style=\"text-align: center\"></td>\n                <td style=\"text-align: center\"><a class=\"label\">surtir</a>&nbsp;<a class=\"label\">m</a>&nbsp;<a class=\"label\">x</a>&nbsp;<a class=\"label\">c</a></td>\n              </tr>\n            ");
  __t = new V.Template(__root, [], []);
  __root.toString;
  t1 = new W._ChildNodeListLazy(__root)._this.childNodes;
  if (5 >= t1.length)
    throw H.ioore(t1, 5);
  t1 = J.get$nodes$x(t1[5]);
  t2 = __t.children;
  t2.push(new V.LoopTemplate(new K.init_autogenerated_closure(__html0), new K.init_autogenerated_closure0(), null, J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(t1.$index(t1, 3)), 3)), 1)), 7)), 1), [], []));
  t1 = new W._ChildNodeListLazy(__root)._this.childNodes;
  if (5 >= t1.length)
    throw H.ioore(t1, 5);
  t1 = J.get$nodes$x(t1[5]);
  __t.listen$2(J.get$onClick$x(J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(t1.$index(t1, 3)), 3)), 1)), 15)), 3)), new K.init_autogenerated_closure1());
  t1 = new W._ChildNodeListLazy(__root)._this.childNodes;
  if (5 >= t1.length)
    throw H.ioore(t1, 5);
  t1 = J.get$nodes$x(t1[5]);
  __t.listen$2(J.get$onClick$x(J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(t1.$index(t1, 3)), 3)), 3)), 1)), new K.init_autogenerated_closure2());
  t1 = new W._ChildNodeListLazy(__root)._this.childNodes;
  if (5 >= t1.length)
    throw H.ioore(t1, 5);
  t1 = J.get$nodes$x(t1[5]);
  __t.listen$2(J.get$onClick$x(J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(t1.$index(t1, 3)), 3)), 3)), 3)), new K.init_autogenerated_closure3());
  t1 = new W._ChildNodeListLazy(__root)._this.childNodes;
  if (5 >= t1.length)
    throw H.ioore(t1, 5);
  t1 = J.get$nodes$x(t1[5]);
  t2.push(new V.LoopTemplate(new K.init_autogenerated_closure4(__html1), new K.init_autogenerated_closure5(), null, J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(J.$index$asx(J.get$nodes$x(t1.$index(t1, 3)), 3)), 3)), 5)), 3), [], []));
  t1 = new W._ChildNodeListLazy(__root)._this.childNodes;
  if (7 >= t1.length)
    throw H.ioore(t1, 7);
  __e27 = t1[7];
  t1 = J.get$nodes$x(__e27);
  __t.listen$2(J.get$onClick$x(J.$index$asx(J.get$nodes$x(t1.$index(t1, 5)), 3)), new K.init_autogenerated_closure6());
  ...
  t3.set$host(t3, __e27);
  t2.push(new V.ComponentItem(t3));
  t3 = new W._ChildNodeListLazy(__root)._this.childNodes;
  if (9 >= t3.length)
    throw H.ioore(t3, 9);
  __e29 = t3[9];
  t3 = J.get$nodes$x(__e29);
  __t.listen$2(J.get$onClick$x(J.$index$asx(J.get$nodes$x(t3.$index(t3, 5)), 3)), new K.init_autogenerated_closure7());
  ...
  t1.set$host(t1, __e29);
  t2.push(new V.ComponentItem(t1));
  __t.create$0();
  __t.insert$0(__t);
},

Clase: {"": "Object;Id<,Nombre<,Activo,Selected@", $isClase: true},

agregar_closure: {"": "Closure;",
  call$1: function(Data) {
    var pMap, t1;
    pMap = P.parse(Data, null);
    t1 = J.getInterceptor$asx(pMap);
    if (J.$gt$n(t1.$index(pMap, "dias"), 3)) {
      window.alert("No puede crear nuevas ordenes porque hay ordenes abiertas de " + H.S(J.toString$0(t1.$index(pMap, "dias"))) + " de antig\u00fcedad");
      return;
    } else
      J.set$href$x(C.Window_methods.get$location(window), "http://localhost:8031/orden_produccion?id=0");
  },
  $isFunction: true
},

modificar_closure: {"": "Closure;item_0",
  call$1: function(Data) {
    var t1;
    if (P.parse(Data, null) === true) {
      t1 = this.item_0;
      if (!J.$eq(t1.get$estado(), "Cerrado"))
        J.set$href$x(C.Window_methods.get$location(window), "http://localhost:8031/orden_produccion?id=" + H.S(J.toString$0(t1.get$id(t1))));
      else
        window.alert("No se puede modificar una orden cerrada");
    } else
      window.alert("El usuario no tiene derecho a modificar ordenes de producci\u00f3n");
  },
  $isFunction: true
},

eliminar_closure: {"": "Closure;item_0",
  call$1: function(Data) {
    var t1, pUrl, headers;
    if (P.parse(Data, null) === true) {
      if (window.confirm("\u00bfEliminar Orden de Produccion?") === true) {
        t1 = this.item_0;
        pUrl = "http://localhost:8031/rest/ordenp/OrdenProduccion_eliminar/" + H.S(J.toString$0(t1.get$id(t1)));
        ...
        W.HttpRequest_request(pUrl, "DELETE", null, null, headers, null, t1.ToJson$0(), null).then$1(new K.eliminar__closure(t1));
      }
    } else
      window.alert("El usuario no tiene derecho a eliminar ordenes de producci\u00f3n");
  },
  $isFunction: true
},

eliminar__closure: {"": "Closure;item_1",
  call$1: function(request) {
    this.item_1.set$estado("Eliminado");
    return "Eliminado";
  },
  $isFunction: true
},

cambiarEstado_closure: {"": "Closure;AOrdenProduccion_0",
  call$1: function(Data) {
    if (!J.$eq(P.parse(Data, null), "Si")) {
      window.alert("El usuario no tiene derecho a cambiar estados");
      return;
    } else {
      $.pOrdenProduccion = this.AOrdenProduccion_0;
      J.show$0$x(J.get$xtag$x(document.querySelector("#mdlCambiarEstado")));
      J.focus$0$x(document.querySelector("#inpEstado"));
    }
  },
  $isFunction: true
},

setCambiarEstado_closure: {"": "Closure;pEstado_0",
  call$1: function(ARequest) {
    var pMap, t1, t2;
    pMap = P.parse(J.get$responseText$x(ARequest), null);
    t1 = J.getInterceptor$asx(pMap);
    window.alert(t1.$index(pMap, "mensaje"));
    if (J.$eq(t1.$index(pMap, "result"), 0)) {
      t1 = $.get$ListaOrdenP();
      t1.toString;
      t2 = new H.WhereIterable(t1, new K.setCambiarEstado__closure());
      H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "ListMixin", 0)]);
      t2.get$first(t2).set$estado(this.pEstado_0);
    }
    J.get$xtag$x(document.querySelector("#mdlCambiarEstado")).hide$0();
  },
  $isFunction: true
},

setCambiarEstado__closure: {"": "Closure;",
  call$1: function(x) {
    return J.$eq(J.get$id$x(x), J.get$id$x($.pOrdenProduccion));
  },
  $isFunction: true
},
...
main_closure: {"": "Closure;",
  call$1: function(Data) {
    var pLista, t1, item, pClase, t2, t3;
    pLista = P.parse(Data, null);
    t1 = $.get$ListaClases();
    t1.add$1(t1, new K.Clase(0, "Todos", "Si", true));
    for (t1 = J.get$iterator$ax(pLista); t1.moveNext$0();) {
      item = t1.get$current();
      pClase = new K.Clase(null, null, null, null);
      ...
      pClase.Selected = false;
      t2 = $.get$ListaClases();
      t2.add$1(t2, pClase);
      if (window.localStorage.getItem("Clase") != null) {
        t2 = window.localStorage.getItem("Clase");
        t3 = J.toString$0(pClase.Id);
        if (t2 == null ? t3 == null : t2 === t3) {
          t2 = $.get$ListaClases();
          t2.toString;
          t3 = $._activeObserver;
          if (t3 != null)
            t3._addRead$3(t2, 2, 0);
          t2 = t2._list$_list;
          if (0 >= t2.length)
            throw H.ioore(t2, 0);
          t2[0].set$Selected(false);
          pClase.Selected = true;
        }
      }
    }
    K.LlenaOrdenProduccion();
  },
  $isFunction: true
},
...
init_autogenerated_closure: {"": "Closure;__html0_1",
  call$3: function($$list, $$index, __t) {
    var t1, item, __binding0, t2, t3, t4;
    t1 = {};
    item = J.$index$asx($$list, $$index);
    t1.__e1_0 = null;
    t1.__e1_0 = J.clone$1$x(this.__html0_1, true);
    __binding0 = __t.contentBind$2(new K.init_autogenerated__closure(item), false);
    J.get$nodes$x(t1.__e1_0)._this.appendChild(__binding0);
    ...
    J.add$1$ax(t3, new V.DomPropertyBinding(new K.init_autogenerated__closure0(t1), false, new K.init_autogenerated__closure1(item), false, t4, null));
    ...
    J.add$1$ax(t4, new V.DomPropertyBinding(new K.init_autogenerated__closure2(t1), false, new K.init_autogenerated__closure3(item), false, t3, null));
    t1 = t1.__e1_0;
...
init_autogenerated__closure: {"": "Closure;item_2",
  call$0: function() {
    return this.item_2.get$Nombre();
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated__closure1: {"": "Closure;item_3",
  call$0: function() {
    return this.item_3.get$Selected();
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated__closure3: {"": "Closure;item_4",
  call$0: function() {
    return J.toString$0(this.item_4.get$Id());
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated__closure2: {"": "Closure;box_0",
  call$1: function(e) {
    var t1 = this.box_0;
    if (!J.$eq(J.get$value$x(t1.__e1_0), e))
      J.set$value$x(t1.__e1_0, e);
  },
  $isFunction: true
},
...
init_autogenerated_closure5: {"": "Closure;",
  call$0: function() {
    return $.get$ListaOrdenP();
  },
  $isFunction: true,
  $is_void_: true
},

init_autogenerated_closure4: {"": "Closure;__html1_5",
  call$3: function($$list, $$index, __t) {
    var item, __e24, t1, t2, __e7, __binding6, __e9, __binding8, __e11, __binding10, __e13, __binding12, __e15, __binding14, __e17, __binding16, __e19, __binding18;
    item = J.$index$asx($$list, $$index);
    __e24 = J.clone$1$x(this.__html1_5, true);
    ...
    __e7 = t2.$index(t2, 1);
    __binding6 = __t.contentBind$2(new K.init_autogenerated__closure4(item), false);
    J.add$1$ax(J.get$nodes$x(__e7), __binding6);
    t2 = t1.get$nodes(__e24)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e9 = t2.$index(t2, 3);
    __binding8 = __t.contentBind$2(new K.init_autogenerated__closure5(item), false);
    J.add$1$ax(J.get$nodes$x(__e9), __binding8);
    t2 = t1.get$nodes(__e24)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e11 = t2.$index(t2, 5);
    __binding10 = __t.contentBind$2(new K.init_autogenerated__closure6(item), false);
    J.add$1$ax(J.get$nodes$x(__e11), __binding10);
    t2 = t1.get$nodes(__e24)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e13 = t2.$index(t2, 7);
    __binding12 = __t.contentBind$2(new K.init_autogenerated__closure7(item), false);
    J.add$1$ax(J.get$nodes$x(__e13), __binding12);
    t2 = t1.get$nodes(__e24)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e15 = t2.$index(t2, 9);
    __binding14 = __t.contentBind$2(new K.init_autogenerated__closure8(item), false);
    J.add$1$ax(J.get$nodes$x(__e15), __binding14);
    t2 = t1.get$nodes(__e24)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e17 = t2.$index(t2, 11);
    __binding16 = __t.contentBind$2(new K.init_autogenerated__closure9(item), false);
    J.add$1$ax(J.get$nodes$x(__e17), __binding16);
    t2 = t1.get$nodes(__e24)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __e19 = t2.$index(t2, 13);
    __binding18 = __t.contentBind$2(new K.init_autogenerated__closure10(item), false);
    J.add$1$ax(J.get$nodes$x(__e19), __binding18);
    t2 = t1.get$nodes(__e24)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __t.listen$2(J.get$onClick$x(J.$index$asx(J.get$nodes$x(t2.$index(t2, 15)), 0)), new K.init_autogenerated__closure11(item));
    t2 = t1.get$nodes(__e24)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __t.listen$2(J.get$onClick$x(J.$index$asx(J.get$nodes$x(t2.$index(t2, 15)), 2)), new K.init_autogenerated__closure12(item));
    t2 = t1.get$nodes(__e24)._this.childNodes;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = J.get$nodes$x(t2[1]);
    __t.listen$2(J.get$onClick$x(J.$index$asx(J.get$nodes$x(t2.$index(t2, 15)), 4)), new K.init_autogenerated__closure13(item));
    t1 = t1.get$nodes(__e24)._this.childNodes;
    if (1 >= t1.length)
      throw H.ioore(t1, 1);
    t1 = J.get$nodes$x(t1[1]);
    __t.listen$2(J.get$onClick$x(J.$index$asx(J.get$nodes$x(t1.$index(t1, 15)), 6)), new K.init_autogenerated__closure14(item));
...
init_autogenerated__closure5: {"": "Closure;item_7",
  call$0: function() {
    return this.item_7.get$folio_sap();
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated__closure6: {"": "Closure;item_8",
  call$0: function() {
    return this.item_8.get$descripcion();
  },
  $isFunction: true,
  $is_void_: true
},
...
init_autogenerated__closure8: {"": "Closure;item_10",
  call$0: function() {
    return this.item_10.get$usuario();
  },
  $isFunction: true,
  $is_void_: true
},

init_autogenerated__closure9: {"": "Closure;item_11",
  call$0: function() {
    return this.item_11.get$nombre_clase();
  },
  $isFunction: true,
  $is_void_: true
},

init_autogenerated__closure10: {"": "Closure;item_12",
  call$0: function() {
    return this.item_12.get$estado();
  },
  $isFunction: true,
  $is_void_: true
},

init_autogenerated__closure11: {"": "Closure;item_13",
  call$1: function($$event) {
    K.surtir(this.item_13);
  },
  $isFunction: true
},

init_autogenerated__closure12: {"": "Closure;item_14",
  call$1: function($$event) {
    K.modificar(this.item_14);
  },
  $isFunction: true
},

init_autogenerated__closure13: {"": "Closure;item_15",
  call$1: function($$event) {
    K.eliminar(this.item_15);
  },
  $isFunction: true
},

init_autogenerated__closure14: {"": "Closure;item_16",
  call$1: function($$event) {
    K.cambiarEstado(this.item_16);
  },
  $isFunction: true
},
...
createSafeNode: function(tag, attributes, body) {
  ...
  for (t1 = attributes.get$keys(attributes)._map, t1 = new P.LinkedHashMapKeyIterator(t1, t1._modifications, null, null), t1._cell = t1._map._first, t2 = J.getInterceptor$x(node); t1.moveNext$0();) {
...
_HashMapWatcher: {"": "_Watcher;debugName,location,_uniqueId,_getter,_watcher$_callback,_lastValue",
  _watcher$_compare$1: function(currentValue) {
    ...
    keys = J.get$keys$x(this._lastValue);
    t1 = J.getInterceptor$asx(keys);
    t2 = J.getInterceptor$x(currentValue);
    if (t1.get$length(keys) !== J.get$length$asx(t2.get$keys(currentValue)))
      return true;
    ...
    for (; keyIterator.moveNext$0();) {
      ...
      if (t2.containsKey$1(currentValue, key) !== true)
        return true;
      if (!J.$eq(J.$index$asx(this._lastValue, key), t2.$index(currentValue, key)))
        return true;
    }
    return false;
  },
...
_OrderDependantMapWatcher: {"": "_Watcher;debugName,location,_uniqueId,_getter,_watcher$_callback,_lastValue",
  _watcher$_compare$1: function(currentValue) {
    var t1 = J.getInterceptor$x(currentValue);
    return Y._iterablesNotEqual(t1.get$keys(currentValue), J.get$keys$x(this._lastValue)) || Y._iterablesNotEqual(t1.get$values(currentValue), J.get$values$x(this._lastValue));
  },
  _update$1: function(currentValue) {
...
WebComponent: {"": "CustomElement;",
  ...
  composeChildren$0: function() {
    ...
    for (t1 = this._generatedRoots, t2 = t1.get$keys(t1)._map, t2 = new P.LinkedHashMapKeyIterator(t2, t2._modifications, null, null), t2._cell = t2._map._first; t2.moveNext$0();) {
...
_ExpressionObserver: {"": "Object;_id,_expression,_callback,_debugName,_reads,_unobservers,_scheduled,_observable$_value",
  ...
  _addRead$3: function(target, type, key) {
    ...
    t1 = this._reads;
    reads = t1.putIfAbsent$2(t1, target, new T._ExpressionObserver__addRead_closure());
    try {
...
init.globalFunctions.llena_lista_consulta$closure = K.llena_lista_consulta$closure = new H.Closure$1(K.llena_lista_consulta, "llena_lista_consulta$closure");
init.globalFunctions.tiene_derecho_modificar$closure = K.tiene_derecho_modificar$closure = new H.Closure$0(K.tiene_derecho_modificar, "tiene_derecho_modificar$closure");
init.globalFunctions.tiene_derecho_eliminar$closure = K.tiene_derecho_eliminar$closure = new H.Closure$0(K.tiene_derecho_eliminar, "tiene_derecho_eliminar$closure");
...
K.Clase.$isObject = true;
M.OrdenProduccion.$isOrdenProduccion = true;
M.OrdenProduccion.$isObservable = true;
M.OrdenProduccion.$isObject = true;
...
Isolate.$lazy($, "ListaOrdenP", "ListaOrdenP", "get$ListaOrdenP", function() {
  return D.ObservableList$(null, M.OrdenProduccion);
});
Isolate.$lazy($, "ListaClases", "ListaClases", "get$ListaClases", function() {
  return D.ObservableList$(null, K.Clase);
});
...
//# sourceMappingURL=lista_orden_p.html_bootstrap.dart.js.map
//@ sourceMappingURL=lista_orden_p.html_bootstrap.dart.js.map
