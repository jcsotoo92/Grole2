...
["consulta_facturas.dart", "consulta_facturas.dart", , T, {
agregaFila: function(AItem, ATable) {
  var tr, t1, d, td, t2, t3, btn;
  tr = document.createElement("tr", null);
  t1 = J.getInterceptor$asx(AItem);
  tr.id = "tr" + H.S(J.toString$0(t1.$index(AItem, "id")));
  d = P.DateTime_parse(J.substring$2$s(H.stringTypeCast(t1.$index(AItem, "fecha")), 0, 10));
  td = document.createElement("td", null);
  t2 = $.get$df();
  td.textContent = t2.format$1(t2, d);
  t2 = J.getInterceptor$x(tr);
  t3 = t2.get$children(tr);
  t3.add$1(t3, td);
  td = document.createElement("td", null);
  t3 = $.get$nfd();
  td.textContent = t3.format$1(t3, t1.$index(AItem, "id"));
  t3 = t2.get$children(tr);
  t3.add$1(t3, td);
  td = document.createElement("td", null);
  td.textContent = t1.$index(AItem, "nombre_clase");
  t3 = t2.get$children(tr);
  t3.add$1(t3, td);
  td = document.createElement("td", null);
  t3 = $.get$nf();
  td.textContent = t3.format$1(t3, J.toDouble$0$n(t1.$index(AItem, "kilos")));
  t3 = J.get$classes$x(td);
  t3.add$1(t3, "lr");
  t3 = t2.get$children(tr);
  t3.add$1(t3, td);
  td = document.createElement("td", null);
  t3 = $.get$nf();
  td.textContent = t3.format$1(t3, J.toDouble$0$n(t1.$index(AItem, "importe")));
  t3 = J.get$classes$x(td);
  t3.add$1(t3, "lr");
  t3 = t2.get$children(tr);
  t3.add$1(t3, td);
  ...
  t3.set$id(btn, "btnEditar" + H.S(J.toString$0(t1.$index(AItem, "id"))));
  t3.get$onClick(btn).listen$1(new T.agregaFila_closure(AItem));
  td = document.createElement("td", null);
  t3 = J.get$children$x(td);
  t3.add$1(t3, btn);
  t2 = t2.get$children(tr);
  t2.add$1(t2, td);
  t2 = new W._WrappedList(ATable.tBodies);
  t2.$builtinTypeInfo = [W.TableSectionElement];
  t1 = t2._list;
  if (0 >= t1.length)
    throw H.ioore(t1, 0);
...
llenaGrid: function() {
  var pFechaIni, pFechaFin, pClase, pUrl, tableLista, t1;
  ...
  pUrl = "/rest/facturas?fecha_ini=" + pFechaIni + "&fecha_fin=" + pFechaFin + "&clase=" + pClase;
  tableLista = document.querySelector("#gridLista");
  J.clear$0$ax($.get$pLista());
  t1 = J.get$tBodies$x(tableLista)._list;
  if (0 >= t1.length)
    throw H.ioore(t1, 0);
  J.clear$0$ax(J.get$children$x(t1[0]));
  W.HttpRequest_getString(pUrl, null, null).then$1(new T.llenaGrid_closure(tableLista));
},

inicializa: function() {
  var nf, btnConsultar, t1, t2, t3, btnAgregar;
  ...
  W.HttpRequest_getString("/rest/clase_ordenp_obtener_lista", null, null).then$1(new T.inicializa_closure());
  ...
  t2 = new W._ElementEventStreamImpl(btnConsultar, t1, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new T.inicializa_closure0()), t2._useCapture);
  ...
  btnAgregar.toString;
  t1 = new W._ElementEventStreamImpl(btnAgregar, t1, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new T.inicializa_closure1()), t1._useCapture);
...
agregaFila_closure: {"": "Closure;AItem_0",
  call$1: function(_) {
    J.set$href$x(C.Window_methods.get$location(window), "/facturas/" + H.S(J.$index$asx(this.AItem_0, "id")));
  }
},

llenaGrid_closure: {"": "Closure;tableLista_0",
  call$1: function(Data) {
    var t1, t2;
    $.pLista = P._parseJson(Data, new P.JsonDecoder(null)._reviver);
    for (t1 = J.get$iterator$ax($.get$pLista()), t2 = this.tableLista_0; t1.moveNext$0();)
      T.agregaFila(t1.get$current(), t2);
  }
},
...
inicializa_closure: {"": "Closure;",
  call$1: function(Data) {
    ...
    t1 = J.getInterceptor$x(pDeptos);
    t1.insertAdjacentHtml$2(pDeptos, "beforeend", "<option value=\"0\">Todos</option>");
    for (t2 = J.get$iterator$ax(P._parseJson(Data, new P.JsonDecoder(null)._reviver)); t2.moveNext$0();) {
      item = t2.get$current();
      t3 = J.getInterceptor$asx(item);
      t1.insertAdjacentHtml$2(pDeptos, "beforeend", "<option value=\"" + H.S(t3.$index(item, "id")) + "\">" + H.S(t3.$index(item, "clase")) + "</option>");
    }
    T.llenaGrid();
  }
},
...
inicializa_closure1: {"": "Closure;",
  call$1: function(ev) {
    J.set$href$x(C.Window_methods.get$location(window), "/facturas/0");
  }
}},
1],
...
InputElement: {"": "HtmlElement;name=,value=", $isInputElement: true, $isElement: true, $isNode: true, "%": "HTMLInputElement"},
...
Isolate.$lazy($, "nfd", "nfd", "get$nfd", function() {
  return T.NumberFormat_NumberFormat("000000", null);
});
Isolate.$lazy($, "df", "df", "get$df", function() {
...
//# sourceMappingURL=consulta_facturas.dart.js.map
//@ sourceMappingURL=consulta_facturas.dart.js.map
