...
// Classes
$$.granja = {"": "Object;clave@,nombre@"};

$$.agregar_anon = {"": "Closure;p_granja_0,req_1",
  call$1: function(data) {
    ...
    if (t2) {
      t2 = this.p_granja_0;
      t2.clave = $.$index$asx($.parse(t1.responseText, null), "clave");
      $.add$1$ax($.get$lista_granja(), t2);
      $.dispatch();
      $.set$value$x($.query$1$x(document, "#clave"), "1");
      $.set$value$x($.query$1$x(document, "#nombre"), "");
      $.focus$0$x($.query$1$x(document, "#nombre"));
    }
  },
  $isFunction: true
};

$$.agregar_anon0 = {"": "Closure;p_granja_2",
  call$1: function(x) {
    return $.$eq(x.get$clave(), this.p_granja_2.clave);
  },
  $isFunction: true
};
...
$$.init_autogenerated___anon0 = {"": "Closure;item_14",
  call$0: function() {
    return this.item_14.get$nombre();
  },
  $isFunction: true
};
...
$$._ExpressionObserver = {"": "Object;_id<,_expression,_callback,_debugName,_reads,_unobservers,_scheduled@,_liblib2$_value",
  ...
  _observe$0: function() {
    ...
    try {
      ...
      if (typeof t1 === "object" && t1 !== null && (t1.constructor === Array || t1.$isIterable()) && true)
...
$.granja$ = function() {
  return new $.granja(null, null);
};

$.llena_lista = function(data) {
  var p_lista, i, item;
  $.lista_granja = $.List_List($);
  ...
  for (i = 0; i <= p_lista.length - 1; ++i) {
    ...
    if (i >= p_lista.length)
      throw $.ioore(i);
    item.nombre = $.$index$asx(p_lista[i], "nombre");
    $.add$1$ax($.get$lista_granja(), item);
  }
  $.dispatch();
};
...
$.llena_lista$bailout = function(state0, p_lista) {
  ...
  for (t1 = $.getInterceptor$asx(p_lista), i = 0; $.JSNumber_methods.$le(i, $.$sub$n(t1.get$length(p_lista), 1)); ++i) {
    ...
    item.nombre = $.$index$asx(t1.$index(p_lista, i), "nombre");
    $.add$1$ax($.get$lista_granja(), item);
  }
  $.dispatch();
};
...
$.obtener_entidad = function() {
  var p_granja = $.granja$();
  p_granja.clave = $.int_parse($.get$value$x($.query$1$x(document, "#clave")), null, null);
  p_granja.nombre = $.get$value$x($.query$1$x(document, "#nombre"));
  return p_granja;
};
...
$.obtener_entidad_mapa = function() {
  ...
  p_map.$indexSet(p_map, "nombre", $.get$value$x($.query$1$x(document, "#nombre")));
  return p_map;
};

$.agregar = function() {
  var p_granja, req, t1;
  p_granja = $.obtener_entidad();
  if ($.$eq($.get$length$asx(p_granja.nombre), 0) === true) {
    $.alert$1$x(window, "Se necesita capturar el campo nombre");
    $.focus$0$x($.query$1$x(document, "#nombre"));
  }
  req = new XMLHttpRequest();
  t1 = $.getInterceptor$x(req);
  if ($.$eq($.get$value$x($.query$1$x(document, "#btnAgregar")), "Agregar") === true) {
    t1.open$2(req, "POST", "/rest/granjas/granja_insertar");
    t1.setRequestHeader$2(req, "Content-type", "application/json");
    t1.send$1(req, $._JsonStringifier_stringify($.obtener_entidad_mapa()));
    t1.get$onReadyStateChange(req).listen$1(new $.agregar_anon(p_granja, req));
  } else {
    t1.open$2(req, "PUT", "/rest/granjas/granja_actualizar");
    t1.setRequestHeader$2(req, "Content-type", "application/json");
    t1.send$1(req, $._JsonStringifier_stringify($.obtener_entidad_mapa()));
    $.actualiza_granja($.$index$asx($.toList$0$ax($.where$1$ax($.get$lista_granja(), new $.agregar_anon0(p_granja))), 0), p_granja);
    $.set$value$x($.query$1$x(document, "#btnAgregar"), "Agregar");
    $.set$value$x($.query$1$x(document, "#clave"), "1");
    $.set$value$x($.query$1$x(document, "#nombre"), "");
    $.focus$0$x($.query$1$x(document, "#nombre"));
...
$.actualiza_granja = function(p_granja_tmp, p_granja) {
  p_granja_tmp.set$clave(p_granja.clave);
  p_granja_tmp.set$nombre(p_granja.nombre);
};

$.eliminar = function(a_granja) {
  var req, t1, p_map;
  if ($.confirm$1$x(window, "\u00bfEliminar registro?") === true) {
    req = new XMLHttpRequest();
    t1 = $.getInterceptor$x(req);
    t1.open$2(req, "DELETE", "/rest/granjas/granja_eliminar");
    t1.setRequestHeader$2(req, "Content-type", "application/json");
    p_map = $.HashMap$();
    p_map.$indexSet(p_map, "clave", a_granja.get$clave());
    t1.send$1(req, $._JsonStringifier_stringify(p_map));
    $.remove$1$ax($.get$lista_granja(), a_granja);
  }
};

$.despliega_clase = function(a_granja) {
  $.set$value$x($.query$1$x(document, "#clave"), $.toString$0(a_granja.get$clave()));
  $.set$value$x($.query$1$x(document, "#nombre"), $.toString$0(a_granja.get$nombre()));
  $.focus$0$x($.query$1$x(document, "#nombre"));
...
$.init_autogenerated = function() {
  ...
  __html0 = $._ElementFactoryProvider_createElement_html("<th template=\"\" instantiate=\"if modo_insercion || permite_edicion\"></th>");
...
$.main = function() {
  $.useObservers = false;
  $.HttpRequest_getString("/rest/granjas/granja_obtener_lista", null, null).then$1($.llena_lista);
  $.init_autogenerated();
};
...
$.scroll$2$x = function(receiver, a0, a1) {
  return $.getInterceptor$x(receiver).scroll$2(receiver, a0, a1);
};
...
Isolate.$lazy($, "lista_granja", "lista_granja", "get$lista_granja", function() {
  return $.List_List($);
});
...
//@ sourceMappingURL=granjas.html_bootstrap.dart.js.map
