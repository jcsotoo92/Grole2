...
InputElement: {"": "HtmlElement;name=,readOnly},type},value%",
  select$0: function(receiver) {
...
TextAreaElement: {"": "HtmlElement;name=,readOnly},value%",
  select$0: function(receiver) {
    return receiver.select();
  },
  "%": "HTMLTextAreaElement"
...
["detalle_costos_maquila.dart", "detalle_costos_maquila.dart", , M, {
_togleButtons: function(AId) {
  var _tableLista, t1, t2, t3, btnAceptar, btnEditar, btnCancelar, btnEliminar;
  _tableLista = document.querySelector("#gridDetalleCostosMaquila");
...
editCostoMaquilaD: function(ACostoMaquilaD) {
  var t1, t2, tr, t3, pInputProducto, t4, t5, pInputDescripcion, pInputCosto;
  t1 = J.get$tBodies$x(document.querySelector("#gridDetalleCostosMaquila"))._list;
  if (0 >= t1.length)
    throw H.ioore(t1, 0);
  t2 = J.getInterceptor$asx(ACostoMaquilaD);
  tr = J.querySelector$1$x(t1[0], "#tr" + H.S(J.toString$0(t2.$index(ACostoMaquilaD, "id"))));
  M._togleButtons(t2.$index(ACostoMaquilaD, "id"));
  ...
  pInputProducto.id = "inpProducto" + H.S(J.toString$0(t2.$index(ACostoMaquilaD, "id")));
  t3 = J.getInterceptor$x(pInputProducto);
  t3.set$value(pInputProducto, J.toString$0(t2.$index(ACostoMaquilaD, "producto")));
  t4 = t3.get$onBlur(pInputProducto);
  t5 = new W._EventStreamSubscription(0, t4._target, t4._eventType, W._wrapZone(new M.editCostoMaquilaD_closure(ACostoMaquilaD)), t4._useCapture);
  ...
  t5 = J.getInterceptor$x(pInputDescripcion);
  t5.get$value(pInputDescripcion);
  pInputDescripcion.id = "inpDescripcion" + H.S(J.toString$0(t2.$index(ACostoMaquilaD, "id")));
  t5.set$value(pInputDescripcion, t2.$index(ACostoMaquilaD, "descripcion"));
  t5.set$readOnly(pInputDescripcion, true);
  t5 = new W._WrappedList(t1.get$_cells(tr));
  H.setRuntimeTypeInfo(t5, [W.TableCellElement]);
  t5 = t5._list;
  if (1 >= t5.length)
    throw H.ioore(t5, 1);
  J.add$1$ax(J.get$children$x(t5[1]), pInputDescripcion);
  t5 = new W._WrappedList(t1.get$_cells(tr));
  H.setRuntimeTypeInfo(t5, [W.TableCellElement]);
  t5 = t5._list;
  if (2 >= t5.length)
    throw H.ioore(t5, 2);
  t5[2].textContent = "";
  pInputCosto = W.InputElement_InputElement(null);
  pInputCosto.id = "inpCosto" + H.S(J.toString$0(t2.$index(ACostoMaquilaD, "id")));
  J.set$value$x(pInputCosto, J.toString$0(t2.$index(ACostoMaquilaD, "costo")));
  t1 = new W._WrappedList(t1.get$_cells(tr));
  H.setRuntimeTypeInfo(t1, [W.TableCellElement]);
  t1 = t1._list;
  if (2 >= t1.length)
    throw H.ioore(t1, 2);
  J.add$1$ax(J.get$children$x(t1[2]), pInputCosto);
  pInputProducto.focus();
  t3.select$0(pInputProducto);
},

obtenerCosto: function(AId) {
  var t1 = J.where$1$ax($.pLista, new M.obtenerCosto_closure(AId));
  return t1.get$first(t1);
},

editarCosto: function(AId) {
  var puedeAgregar, t1, pProducto, pDescripcion, pCostoS, pCosto, t2, tr;
  puedeAgregar = M.puedeAgregarProducto(AId);
  if (puedeAgregar.length === 0) {
    ...
    pCostoS = H.interceptedTypeCast(document.querySelector("#inpCosto" + H.S(t1.toString$0(AId))), "$isInputElement").value;
    pCosto = M.obtenerCosto(AId);
    t2 = J.getInterceptor$ax(pCosto);
    t2.$indexSet(pCosto, "producto", pProducto);
    t2.$indexSet(pCosto, "descripcion", pDescripcion);
    t2.$indexSet(pCosto, "costo", H.Primitives_parseDouble(pCostoS, null));
    t2.$indexSet(pCosto, "dirty", true);
    t2.$indexSet(pCosto, "deleted", false);
    ...
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2[1].textContent = pDescripcion;
    t2 = new W._WrappedList(t1.get$_cells(tr));
    H.setRuntimeTypeInfo(t2, [W.TableCellElement]);
    t2 = t2._list;
    if (2 >= t2.length)
      throw H.ioore(t2, 2);
    J.clear$0$ax(J.get$children$x(t2[2]));
    t1 = new W._WrappedList(t1.get$_cells(tr));
    H.setRuntimeTypeInfo(t1, [W.TableCellElement]);
    t1 = t1._list;
    if (2 >= t1.length)
      throw H.ioore(t1, 2);
    t1[2].textContent = pCostoS;
    M._togleButtons(AId);
  } else
    window.alert(puedeAgregar);
},

eliminarDetalleCosto: function(AId) {
  var t1, pCosto;
  if (window.confirm("\u00bfEliminar Costo?") === true) {
    t1 = J.where$1$ax($.pLista, new M.eliminarDetalleCosto_closure(AId));
    pCosto = t1.get$first(t1);
    t1 = J.getInterceptor$ax(pCosto);
    t1.$indexSet(pCosto, "deleted", true);
    t1.$indexSet(pCosto, "dirty", true);
    J.remove$0$ax(document.querySelector("#tr" + H.S(J.toString$0(AId))));
  }
},

cancelarEdicion: function(AId) {
  var t1, pCosto, tr, t2, t3;
  t1 = J.where$1$ax($.pLista, new M.cancelarEdicion_closure(AId));
  pCosto = t1.get$first(t1);
  ...
  if (0 >= t2.length)
    throw H.ioore(t2, 0);
  t3 = J.getInterceptor$asx(pCosto);
  t2[0].textContent = t3.$index(pCosto, "producto");
  t2 = new W._WrappedList(t1.get$_cells(tr));
  H.setRuntimeTypeInfo(t2, [W.TableCellElement]);
  t2 = t2._list;
  if (1 >= t2.length)
  ...
  if (1 >= t2.length)
    throw H.ioore(t2, 1);
  t2[1].textContent = t3.$index(pCosto, "descripcion");
  t2 = new W._WrappedList(t1.get$_cells(tr));
  H.setRuntimeTypeInfo(t2, [W.TableCellElement]);
  t2 = t2._list;
  if (2 >= t2.length)
  ...
  if (2 >= t1.length)
    throw H.ioore(t1, 2);
  t1 = t1[2];
  t2 = $.get$pNumberFormat();
  t1.textContent = t2.format$1(t2, t3.$index(pCosto, "costo"));
  M._togleButtons(AId);
},

agregaFila: function(ACosto, AAppend) {
  var tableLista, tr, t1, td, t2, t3, btn, t4;
  tableLista = document.querySelector("#gridDetalleCostosMaquila");
  tr = document.createElement("tr", null);
  t1 = J.getInterceptor$asx(ACosto);
  tr.id = "tr" + H.S(J.toString$0(t1.$index(ACosto, "id")));
  td = document.createElement("td", null);
  td.textContent = t1.$index(ACosto, "producto");
  t2 = J.getInterceptor$x(tr);
  t3 = t2.get$children(tr);
  t3.add$1(t3, td);
  td = document.createElement("td", null);
  td.textContent = t1.$index(ACosto, "descripcion");
  t3 = t2.get$children(tr);
  t3.add$1(t3, td);
  td = document.createElement("td", null);
  t3 = $.get$pNumberFormat();
  td.textContent = t3.format$1(t3, J.toDouble$0$n(t1.$index(ACosto, "costo")));
  t3 = t2.get$children(tr);
  t3.add$1(t3, td);
  btn = W.Element_Element$html("<button class='btn'><i class='icon-edit'></i></button>", null, null);
  t3 = J.getInterceptor$x(btn);
  t3.set$id(btn, "btnEditar" + H.S(J.toString$0(t1.$index(ACosto, "id"))));
  t3.get$onClick(btn).listen$1(new M.agregaFila_closure(ACosto));
  td = document.createElement("td", null);
  ...
  t4.set$id(btn, "btnEliminar" + H.S(J.toString$0(t1.$index(ACosto, "id"))));
  t4.get$onClick(btn).listen$1(new M.agregaFila_closure0(ACosto));
  t4 = t3.get$children(td);
  t4.add$1(t4, btn);
  btn = W.Element_Element$html("<button class='btn oculto'><i class='icon-ok'></i></button>", null, null);
  t4 = J.getInterceptor$x(btn);
  t4.set$id(btn, "btnAceptar" + H.S(J.toString$0(t1.$index(ACosto, "id"))));
  t4.get$onClick(btn).listen$1(new M.agregaFila_closure1(ACosto));
  t4 = t3.get$children(td);
  t4.add$1(t4, btn);
  btn = W.Element_Element$html("<button class='btn oculto edit_btn'><i class='icon-remove'></i></button>", null, null);
  t4 = J.getInterceptor$x(btn);
  t4.set$id(btn, "btnCancelar" + H.S(J.toString$0(t1.$index(ACosto, "id"))));
  t4.get$onClick(btn).listen$1(new M.agregaFila_closure2(ACosto));
...
llenaGrid: function() {
  W.HttpRequest_getString("/rest/maquila/CostoMaquilaD_obtener_lista/" + $.pFolio, null, null).then$2$onError(new M.llenaGrid_closure(), new M.llenaGrid_closure0());
},

limpiaEdits: function() {
  ...
  H.interceptedTypeCast(document.querySelector("#inpCosto"), "$isInputElement").value = "0.00";
  H.interceptedTypeCast(document.querySelector("#inpProducto"), "$isInputElement").focus();
},

puedeAgregarProducto: function(AId) {
  var pClaveProducto, pCostoS, t1, exception;
  pClaveProducto = "";
  t1 = J.getInterceptor$n(AId);
  if (t1.$gt(AId, 0))
    pClaveProducto = t1.toString$0(AId);
  if (J.trim$0$s(H.interceptedTypeCast(document.querySelector("#inpProducto" + H.S(pClaveProducto)), "$isInputElement").value).length === 0) {
    H.interceptedTypeCast(document.querySelector("#inpProducto" + H.S(pClaveProducto)), "$isInputElement").focus();
    return "El producto esta vac\u00edo";
  }
  pCostoS = H.interceptedTypeCast(document.querySelector("#inpCosto" + H.S(pClaveProducto)), "$isInputElement").value;
  try {
    H.Primitives_parseDouble(pCostoS, null);
  } catch (exception) {
    H.unwrapException(exception);
    H.interceptedTypeCast(document.querySelector("#inpCosto" + H.S(pClaveProducto)), "$isInputElement").focus();
    return "El costo inv\u00e1lido";
  }
...
agregarProducto: function() {
  var pPuedeAgregarProducto, pCosto;
  pPuedeAgregarProducto = M.puedeAgregarProducto(0);
  if (pPuedeAgregarProducto.length === 0) {
    pCosto = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
    pCosto.$indexSet(pCosto, "id", $.pIndice);
    $.pIndice = $.pIndice + 1;
    pCosto.$indexSet(pCosto, "id_costo", H.Primitives_parseInt($.pFolio, null, null));
    pCosto.$indexSet(pCosto, "producto", H.interceptedTypeCast(document.querySelector("#inpProducto"), "$isInputElement").value);
    pCosto.$indexSet(pCosto, "descripcion", H.interceptedTypeCast(document.querySelector("#inpDescripcion"), "$isInputElement").value);
    pCosto.$indexSet(pCosto, "costo", H.Primitives_parseDouble(H.interceptedTypeCast(document.querySelector("#inpCosto"), "$isInputElement").value, null));
    pCosto.$indexSet(pCosto, "dirty", true);
    J.add$1$ax($.pLista, pCosto);
    M.agregaFila(pCosto, false);
    M.limpiaEdits();
  } else
    window.alert(pPuedeAgregarProducto);
},

obtenerDescripcionProducto: function(AId) {
  var t1, t2, pProducto;
  t1 = {};
  t1.pClaveProducto_0 = "";
  t2 = J.getInterceptor$n(AId);
  if (t2.$gt(AId, 0))
    t1.pClaveProducto_0 = t2.toString$0(AId);
  pProducto = H.interceptedTypeCast(document.querySelector("#inpProducto" + t1.pClaveProducto_0), "$isInputElement").value;
  if (J.trim$0$s(pProducto).length === 0) {
    H.interceptedTypeCast(document.querySelector("#inpProducto" + t1.pClaveProducto_0), "$isInputElement").value = "";
    return;
  } else
    W.HttpRequest_getString("/rest/productos/obtener_descripcion/" + pProducto, null, null).then$1(new M.obtenerDescripcionProducto_closure(t1));
},

aceptar: function() {
  var t1, pListaTmp, CostoMaquila, data;
  H.interceptedTypeCast(document.querySelector("#btnAceptar"), "$isButtonElement").disabled = true;
  t1 = J.where$1$ax($.pLista, new M.aceptar_closure());
  pListaTmp = t1.toList$0(t1);
  CostoMaquila = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
  CostoMaquila.$indexSet(CostoMaquila, "id", H.Primitives_parseInt($.pFolio, null, null));
  CostoMaquila.$indexSet(CostoMaquila, "fecha", H.interceptedTypeCast(document.querySelector("#inpFecha"), "$isInputElement").value);
  CostoMaquila.$indexSet(CostoMaquila, "fechafinal", H.interceptedTypeCast(document.querySelector("#inpFechaFinal"), "$isInputElement").value);
  CostoMaquila.$indexSet(CostoMaquila, "descripcion", H.interceptedTypeCast(document.querySelector("#inpDescripcionM"), "$isInputElement").value);
  CostoMaquila.$indexSet(CostoMaquila, "activo", H.interceptedTypeCast(document.querySelector("#inpActivo"), "$isSelectElement").value);
  CostoMaquila.$indexSet(CostoMaquila, "detalle", pListaTmp);
  data = P.stringify(CostoMaquila, new P.JsonEncoder(null)._toEncodableFunction);
  P.print(data);
  W.HttpRequest_request("/rest/maquila/CostoMaquilaD_insertar", "POST", "application/json", new M.aceptar_closure0(), null, null, data, null).then$1(new M.aceptar_closure1());
},

cancelar: function() {
  if (window.confirm("\u00bfCancelar Captura?") === true)
    J.set$href$x(C.Window_methods.get$location(window), "/costos_maquila");
},

main: function() {
  var t1, t2, btnAgregar, t3, btnAceptar, btnCancelar;
  $.pFolio = H.interceptedTypeCast(document.querySelector("#folio"), "$isInputElement").value;
  J.set$value$x(document.querySelector("#inpActivo"), H.interceptedTypeCast(document.querySelector("#activo"), "$isInputElement").value);
  M.llenaGrid();
  t1 = J.get$onBlur$x(document.querySelector("#inpProducto"));
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.main_closure()), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
  btnAgregar = document.querySelector("#btnAgregar");
  btnAgregar.toString;
  t2 = C.EventStreamProvider_click._eventType;
  t1 = new W._ElementEventStreamImpl(btnAgregar, t2, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.main_closure0()), t1._useCapture);
  H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t3._tryResume$0();
  btnAceptar = document.querySelector("#btnAceptar");
  btnAceptar.toString;
  t3 = new W._ElementEventStreamImpl(btnAceptar, t2, false);
  H.setRuntimeTypeInfo(t3, [null]);
  t1 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new M.main_closure1()), t3._useCapture);
  ...
  t2 = new W._ElementEventStreamImpl(btnCancelar, t2, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new M.main_closure2()), t2._useCapture);
  H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t1._tryResume$0();
},

editCostoMaquilaD_closure: {"": "Closure;ACostoMaquilaD_0",
  call$1: function(e) {
    M.obtenerDescripcionProducto(J.$index$asx(this.ACostoMaquilaD_0, "id"));
  }
},

obtenerCosto_closure: {"": "Closure;AId_0",
  call$1: function(item) {
    return J.$eq(J.$index$asx(item, "id"), this.AId_0);
  }
},

eliminarDetalleCosto_closure: {"": "Closure;AId_0",
  call$1: function(item) {
    return J.$eq(J.$index$asx(item, "id"), this.AId_0);
  }
},
...
agregaFila_closure: {"": "Closure;ACosto_0",
  call$1: function(_) {
    M.editCostoMaquilaD(this.ACosto_0);
  }
},

agregaFila_closure0: {"": "Closure;ACosto_1",
  call$1: function(_) {
    M.eliminarDetalleCosto(J.$index$asx(this.ACosto_1, "id"));
  }
},

agregaFila_closure1: {"": "Closure;ACosto_2",
  call$1: function(_) {
    M.editarCosto(J.$index$asx(this.ACosto_2, "id"));
  }
},

agregaFila_closure2: {"": "Closure;ACosto_3",
  call$1: function(_) {
    M.cancelarEdicion(J.$index$asx(this.ACosto_3, "id"));
  }
},
...
llenaGrid_closure: {"": "Closure;",
  call$1: function(Data) {
    ...
    for (t1 = J.get$iterator$ax($.pLista); t1.moveNext$0();) {
      ...
      t2.$indexSet(item, "deleted", true);
      M.agregaFila(item, true);
    }
  }
},
...
llenaGrid_closure0: {"": "Closure;",
  call$1: function(ex) {
    return window.alert(J.get$message$x(ex));
  }
},

obtenerDescripcionProducto_closure: {"": "Closure;box_0",
  call$1: function(Data) {
    var pProducto, t1;
    pProducto = P._parseJson(Data, new P.JsonDecoder(null)._reviver);
    t1 = this.box_0;
    H.interceptedTypeCast(document.querySelector("#inpDescripcion" + t1.pClaveProducto_0), "$isInputElement").value = J.$index$asx(pProducto, "descripcion");
    H.interceptedTypeCast(document.querySelector("#inpCosto" + t1.pClaveProducto_0), "$isInputElement").value = "0.00";
    H.interceptedTypeCast(document.querySelector("#inpCosto" + t1.pClaveProducto_0), "$isInputElement").select();
    H.interceptedTypeCast(document.querySelector("#inpCosto" + t1.pClaveProducto_0), "$isInputElement").focus();
  }
},

aceptar_closure: {"": "Closure;",
  call$1: function(item) {
    return J.$eq(J.$index$asx(item, "dirty"), true);
  }
},

aceptar_closure0: {"": "Closure;",
  call$1: function(e) {
  }
},

aceptar_closure1: {"": "Closure;",
...
main_closure: {"": "Closure;",
  call$1: function(e) {
    M.obtenerDescripcionProducto(0);
  }
},
...
// Native classes
J.Interceptor["%"] = "DOMImplementation|MediaError|MediaKeyError|Navigator|SVGAnimatedNumberList";
...
//# sourceMappingURL=detalle_costos_maquila.dart.js.map
//@ sourceMappingURL=detalle_costos_maquila.dart.js.map
