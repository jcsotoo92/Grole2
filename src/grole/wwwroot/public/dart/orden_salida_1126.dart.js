...
["_isolate_helper", "dart:_isolate_helper", , H, {
  ...
  _IsolateContext: {
    ...
    _updateGlobalState$0: function() {
      if (this.ports._length - this.weakPorts._length > 0 || this.isPaused)
...
["intl", "package:intl/intl.dart", , T, {
  ...
  _NumberFormatParser: {
    ...
    parseCharacterAffix$1: function(affix) {
      ...
      if (this.inQuote)
        affix._contents = affix._contents + ch;
      else
        switch (ch) {
          case "#":
          case "0":
...
["", "orden_salida.dart", , M, {
  ...
  agregaFila: function(AItem, AEditable) {
    var pTabla, tr, t1, td, t2, t3, pCumplimientoS, btnEliminar, t4, t5, t6, btnEditar, t7;
    ...
    t2.get$children(tr).add$1(0, td);
    td = document.createElement("td", null);
    td.textContent = $.get$pNumberFormat().format$1(0, t1.$index(AItem, "kilos"));
    J.set$textAlign$x(td.style, "right");
    t2.get$children(tr).add$1(0, td);
    td = document.createElement("td", null);
    ...
    t2.get$children(tr).add$1(0, td);
    td = document.createElement("td", null);
    td.textContent = $.get$pNumberFormat().format$1(0, t1.$index(AItem, "kilos_surtidos"));
    J.set$textAlign$x(td.style, "right");
    t2.get$children(tr).add$1(0, td);
    ...
    if (typeof t1 !== "number")
      return H.iae(t1);
    pCumplimientoS = $.get$pNumberFormat().format$1(0, t3 / t1 * 100) + "%";
    td = document.createElement("td", null);
  ...
  despliegaEntidad: function(AItem) {
    ...
    if (isNaN(p_cumplimiento))
      p_cumplimiento = 0;
    pCumplimientoS = $.get$pNumberFormat().format$1(0, p_cumplimiento) + "%";
    ...
    H.interceptedTypeCast(document.querySelector("#spanTotalKilos"), "$isSpanElement").textContent = $.get$nf().format$1(0, p_total_kilos);
    H.interceptedTypeCast(document.querySelector("#spanTotalKilosSurtidos"), "$isSpanElement").textContent = $.get$nf().format$1(0, p_total_kilos_surtidos);
  },
  ...
  guardarOrdenSalida: function() {
    ...
    pResult.$indexSet(0, "id", J.toString$0($.idOrdenSalida));
    pResult.$indexSet(0, "descripcion", H.interceptedTypeCast(document.querySelector("#inpDescripcion"), "$isInputElement").value);
    pResult.$indexSet(0, "fecha_embarque", H.interceptedTypeCast(document.querySelector("#inpFechaEmbarque"), "$isInputElement").value);
    pResult.$indexSet(0, "valida_productos", H.interceptedTypeCast(document.querySelector("#inpValidaProductos"), "$isSelectElement").value);
    pResult.$indexSet(0, "destino", H.Primitives_parseInt(J.get$value$x(H.interceptedTypeCast(document.querySelector("#inpClaveCliente"), "$isHiddenInputElement")), null, null));
    pResult.$indexSet(0, "id_usuario", H.interceptedTypeCast(document.querySelector("#inpIdUsuario"), "$isInputElement").value);
    pResult.$indexSet(0, "estado", "Nuevo");
    pResult.$indexSet(0, "detalle", $.get$Detalle());
    pResult.$indexSet(0, "tarimas", $.get$ListaTarimas());
    if (J.trim$0$s(pResult.$index(0, "descripcion")).length === 0) {
    ...
    W.HttpRequest_request("/rest/salidas/orden_salida_insertar", "POST", null, null, null, null, C.JsonCodec_null_null.encode$1(pResult), null).then$1(new M.guardarOrdenSalida_closure());
  },
  ...
  despliegaProductoFila: function(AItem) {
    ...
    if (3 >= t2.length)
      return H.ioore(t2, 3);
    t2[3].textContent = $.get$pNumberFormat().format$1(0, t1.$index(AItem, "kilos"));
  },
  agregar: function() {
  ...
  cerrarOrden: function() {
    if (window.confirm("\u00bfCerrar la orden de salida?") === true)
      W.HttpRequest_request("/rest/salidas/crear_salida_embarques/" + H.S($.idOrdenSalida), "POST", null, null, null, null, "_", null).then$1(new M.cerrarOrden_closure());
  },
  ...
  agregaTarimaDetalle: function(ATarima) {
    ...
    if (item == null) {
      ...
      pItem.$indexSet(0, "id", $.indice);
      $.indice = $.indice + 1;
      pItem.$indexSet(0, "producto", J.$index$asx(ATarima, "producto"));
      pItem.$indexSet(0, "descripcion", J.$index$asx(ATarima, "descripcion"));
      pItem.$indexSet(0, "cajas", J.$index$asx(ATarima, "cajas"));
      pItem.$indexSet(0, "kilos", J.$index$asx(ATarima, "kilos"));
      pItem.$indexSet(0, "cajas_surtidas", 0);
      pItem.$indexSet(0, "kilos_surtidos", 0);
      pItem.$indexSet(0, "origen", "tarima");
  ...
  init: function() {
    ...
    t1 = J.get$onClick$x($.get$btnCosultarTarimas());
    ...
    t1 = J.get$onClick$x($.get$btnCancelarCosultarTarimas());
  ...
  llenaListaTarimasOrden_closure: {
    ...
    call$1: function(Data) {
      $.ListaTarimas = C.JsonCodec_null_null.decode$1(Data);
    }
  },
  obtenerOrdenSalida_closure: {
    "^": "Closure:0;",
    call$1: function(Data) {
      M.despliegaEntidad(C.JsonCodec_null_null.decode$1(Data));
    }
  },
  ...
  guardarOrdenSalida_closure: {
    ...
    call$1: function(ARequest) {
      var pResult, t1;
      pResult = C.JsonCodec_null_null.decode$1(J.get$responseText$x(ARequest));
  ...
  agregarProducto_closure: {
    "^": "Closure:25;pMapa_0",
    call$1: function(x) {
      return J.$eq(J.$index$asx(x, "producto"), this.pMapa_0.$index(0, "producto"));
    }
  },
  cerrarOrden_closure: {
    "^": "Closure:26;",
    call$1: function(ARequest) {
      var pResult, t1, pUrl, pData;
      pResult = C.JsonCodec_null_null.decode$1(J.get$responseText$x(ARequest));
      t1 = J.getInterceptor$asx(pResult);
      window.alert(t1.$index(pResult, "mensaje"));
      if (J.$gt$n(t1.$index(pResult, "folio_salida"), 0)) {
        pUrl = "/rest/salidas/cambiar_estado/" + H.S($.idOrdenSalida);
        pData = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
        pData.$indexSet(0, "estado", "Cerrado");
        W.HttpRequest_request(pUrl, "PUT", null, null, null, null, C.JsonCodec_null_null.encode$1(pData), null).then$1(new M.cerrarOrden__closure()).then$1(new M.cerrarOrden__closure0());
      }
    }
  },
  ...
  llenaCamaras_closure: {
    ...
    call$1: function(Data) {
      ...
      for (t1 = J.get$iterator$ax(C.JsonCodec_null_null.decode$1(Data)); t1.moveNext$0();) {
        ...
        J.get$children$x($.get$inpCamaras()).add$1(0, W.Element_Element$html("<option value=\"" + H.S(t2.$index(item, "id")) + "\">" + H.S(t2.$index(item, "descripcion")) + "</option>", null, null));
      }
    }
  },
  agregaTarimaDetalle_closure: {
    "^": "Closure:25;ATarima_0",
    call$1: function(x) {
      return J.$eq(J.$index$asx(x, "producto"), J.$index$asx(this.ATarima_0, "producto"));
    }
  },
  remueveTarimaDetalle_closure: {
    "^": "Closure:25;ATarima_1",
    call$1: function(x) {
  ...
  llenaTablaConsultaTarimas_closure: {
    "^": "Closure:0;",
    call$1: function(Data) {
      var t1, item, tr, t2, chkFolio, t3, t4, t5, t6, td;
      for (t1 = J.get$iterator$ax(C.JsonCodec_null_null.decode$1(Data)); t1.moveNext$0();) {
        item = t1.get$current();
        tr = document.createElement("tr", null);
        t2 = J.getInterceptor$asx(item);
        tr.id = "trt" + H.S(t2.$index(item, "folio"));
        chkFolio = W.InputElement_InputElement("checkbox");
        t3 = J.where$1$ax($.get$ListaTarimas(), new M.llenaTablaConsultaTarimas__closure(item));
        t3 = t3.get$length(t3);
        if (typeof t3 !== "number")
          return t3.$gt();
        if (t3 > 0)
          J.set$checked$x(chkFolio, true);
        t3 = J.get$onClick$x(chkFolio);
        t4 = t3._eventType;
        t5 = t3._useCapture;
        t6 = new W._EventStreamSubscription(0, t3._target, t4, W._wrapZone(new M.llenaTablaConsultaTarimas__closure0(item, chkFolio)), t5);
        t6.$builtinTypeInfo = [H.getTypeArgumentByIndex(t3, 0)];
        t3 = t6._onData;
        if (t3 != null && t6._pauseCount <= 0)
          J.addEventListener$3$x(t6._target, t4, t3, t5);
        td = document.createElement("td", null);
        J.get$children$x(td).add$1(0, chkFolio);
        t3 = J.getInterceptor$x(tr);
        t3.get$children(tr).add$1(0, td);
        td = document.createElement("td", null);
        td.textContent = H.S(t2.$index(item, "folio"));
        t3.get$children(tr).add$1(0, td);
        td = document.createElement("td", null);
        td.textContent = H.S(t2.$index(item, "descripcion"));
        t3.get$children(tr).add$1(0, td);
        td = document.createElement("td", null);
        td.textContent = H.S(t2.$index(item, "cajas"));
        t3.get$children(tr).add$1(0, td);
        td = document.createElement("td", null);
        td.textContent = $.get$pNumberFormat().format$1(0, t2.$index(item, "kilos"));
        t3.get$children(tr).add$1(0, td);
        t3 = J.get$tBodies$x($.get$tablaConsultaTarimas())._list;
        if (0 >= t3.length)
          return H.ioore(t3, 0);
        J.add$1$ax(J.get$children$x(t3[0]), tr);
      }
    }
  },
