...
LlenaOrdenProduccion: function() {
  ...
  W.HttpRequest_getString("/rest/ordenp/OrdenProduccion_obtener_lista/" + pFechaIni + "/" + pFechaFin + "/" + H.S(pFiltro), null, null).then$1(K.llena_lista_consulta$closure);
},

agregar: function() {
  W.HttpRequest_getString("/rest/dias_ultima_orden/" + H.S(J.get$value$x(document.querySelector("#idUsuario"))), null, null).then$1(new K.agregar_closure());
},

tiene_derecho_modificar: function() {
  P.print("aqui..");
  return W.HttpRequest_getString("/rest/usuarios/usuario_tiene_derecho/5/40", null, null);
},

tiene_derecho_eliminar: function() {
  return W.HttpRequest_getString("/rest/usuarios/usuario_tiene_derecho_eliminar_orden/4/40", null, null);
},
...
surtir: function(item) {
  ...
  J.set$href$x(C.Window_methods.get$location(window), "/surtir_orden?id=" + H.S(J.toString$0(J.get$id$x(item))) + "&fecha=" + H.S(pFecha));
},
...
buscaFolio: function() {
  ...
  W.HttpRequest_getString(C.JSString_methods.$add("/rest/ordenp/OrdenProduccion_obtener_lista_folio/", J.get$value$x(document.querySelector("#pFolio"))), null, null).then$1(K.llena_lista_consulta$closure);
},

cambiarEstado: function(AOrdenProduccion) {
  W.HttpRequest_getString("/rest/puede_cambiar_estado/" + H.S(J.get$value$x(document.querySelector("#idUsuario"))), null, null).then$1(new K.cambiarEstado_closure(AOrdenProduccion));
},
...
setCambiarEstado: function() {
  ...
  W.HttpRequest_request("/rest/cambiar_estado_orden_produccion/" + H.S(J.get$id$x($.pOrdenProduccion)) + "/" + H.S(pEstado), "PUT", null, null, null, null, "", null).then$1(new K.setCambiarEstado_closure(pEstado));
},
...
main: function() {
  ...
  W.HttpRequest_getString("/rest/clase_ordenp_obtener_lista", null, null).then$1(new K.main_closure());
},
...
agregar_closure: {"": "Closure;",
  call$1: function(Data) {
    ...
    if (J.$gt$n(t1.$index(pMap, "dias"), 3)) {
      ...
      J.set$href$x(C.Window_methods.get$location(window), "/orden_produccion?id=0");
  },
  $isFunction: true
},
  ...
  call$1: function(Data) {
    ...
    if (P.parse(Data, null) === true) {
      ...
      if (!J.$eq(t1.get$estado(), "Cerrado"))
        J.set$href$x(C.Window_methods.get$location(window), "/orden_produccion?id=" + H.S(J.toString$0(t1.get$id(t1))));
      else
  ...
  call$1: function(Data) {
    ...
    if (P.parse(Data, null) === true) {
      if (window.confirm("\u00bfEliminar Orden de Produccion?") === true) {
        t1 = this.item_0;
        pUrl = "/rest/ordenp/OrdenProduccion_eliminar/" + H.S(J.toString$0(t1.get$id(t1)));
