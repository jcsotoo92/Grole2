...
HttpRequest_request: function(url, method, mimeType, onProgress, requestHeaders, responseType, sendData, withCredentials) {
  ...
  if (onProgress != null) {
    t1 = new W._EventStream(xhr, C.EventStreamProvider_progress._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(onProgress), t1._useCapture);
...
BodyElement: {"": "HtmlElement;",
  get$onBlur: function(receiver) {
    var t1 = new W._ElementEventStreamImpl(receiver, C.EventStreamProvider_blur._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    return t1;
  },
  $isBodyElement: true,
...
InputElement: {"": "HtmlElement;name=,type},value%",
  select$0: function(receiver) {
...
TableCellElement: {"": "HtmlElement;", $isTableCellElement: true, "%": "HTMLTableCellElement|HTMLTableDataCellElement|HTMLTableHeaderCellElement"},

TableElement: {"": "HtmlElement;_tBodies:tBodies=",
...
["detalle_sobrantes.dart", "detalle_sobrantes.dart", , Q, {
_togleButtons: function(AId) {
  var _tableLista, t1, t2, t3, btnAceptar, btnEditar, btnCancelar, btnEliminar;
  _tableLista = document.querySelector("#gridLista");
  t1 = J.getInterceptor$x(_tableLista);
  t2 = t1.get$tBodies(_tableLista)._list;
  if (0 >= t2.length)
    throw H.ioore(t2, 0);
  t3 = J.getInterceptor(AId);
  btnAceptar = J.querySelector$1$x(t2[0], "#btnAceptar" + H.S(t3.toString$0(AId)));
  t2 = new W._WrappedList(t1.get$_tBodies(_tableLista));
  H.setRuntimeTypeInfo(t2, [W.TableSectionElement]);
  t2 = t2._list;
  if (0 >= t2.length)
    throw H.ioore(t2, 0);
  btnEditar = J.querySelector$1$x(t2[0], "#btnEditar" + H.S(t3.toString$0(AId)));
  t2 = new W._WrappedList(t1.get$_tBodies(_tableLista));
  H.setRuntimeTypeInfo(t2, [W.TableSectionElement]);
  t2 = t2._list;
  if (0 >= t2.length)
    throw H.ioore(t2, 0);
  btnCancelar = J.querySelector$1$x(t2[0], "#btnCancelar" + H.S(t3.toString$0(AId)));
  t1 = new W._WrappedList(t1.get$_tBodies(_tableLista));
  H.setRuntimeTypeInfo(t1, [W.TableSectionElement]);
  t1 = t1._list;
  if (0 >= t1.length)
    throw H.ioore(t1, 0);
  btnEliminar = J.querySelector$1$x(t1[0], "#btnEliminar" + H.S(t3.toString$0(AId)));
  J.get$classes$x(btnEditar).toggle$1("oculto");
  J.get$classes$x(btnAceptar).toggle$1("oculto");
  J.get$classes$x(btnCancelar).toggle$1("oculto");
  J.get$classes$x(btnEliminar).toggle$1("oculto");
},

editEntidad: function(AEntidad) {
  var t1, t2, tr, t3, pInputProducto, t4, t5, pInputDescripcion;
  t1 = J.get$tBodies$x(document.querySelector("#gridLista"))._list;
  if (0 >= t1.length)
    throw H.ioore(t1, 0);
  t2 = J.getInterceptor$asx(AEntidad);
  tr = J.querySelector$1$x(t1[0], "#tr" + H.S(J.toString$0(t2.$index(AEntidad, "id"))));
  Q._togleButtons(t2.$index(AEntidad, "id"));
  t1 = J.getInterceptor$x(tr);
  t3 = t1.get$cells(tr)._list;
  if (0 >= t3.length)
    throw H.ioore(t3, 0);
  t3[0].textContent = "";
  pInputProducto = W.InputElement_InputElement(null);
  pInputProducto.id = "inpProducto" + H.S(J.toString$0(t2.$index(AEntidad, "id")));
  t3 = J.getInterceptor$x(pInputProducto);
  t3.set$value(pInputProducto, J.toString$0(t2.$index(AEntidad, "producto")));
  t4 = t3.get$onBlur(pInputProducto);
  t5 = new W._EventStreamSubscription(0, t4._target, t4._eventType, W._wrapZone(new Q.editEntidad_closure(AEntidad)), t4._useCapture);
  H.setRuntimeTypeInfo(t5, [H.getRuntimeTypeArgument(t4, "_EventStream", 0)]);
  t5._tryResume$0();
  t5 = new W._WrappedList(t1.get$_cells(tr));
  H.setRuntimeTypeInfo(t5, [W.TableCellElement]);
  t5 = t5._list;
  if (0 >= t5.length)
    throw H.ioore(t5, 0);
  J.add$1$ax(J.get$children$x(t5[0]), pInputProducto);
  t5 = new W._WrappedList(t1.get$_cells(tr));
  H.setRuntimeTypeInfo(t5, [W.TableCellElement]);
  t5 = t5._list;
  if (1 >= t5.length)
    throw H.ioore(t5, 1);
  t5[1].textContent = "";
  pInputDescripcion = W.InputElement_InputElement(null);
  pInputDescripcion.id = "inpDescripcion" + H.S(J.toString$0(t2.$index(AEntidad, "id")));
  J.set$value$x(pInputDescripcion, J.toString$0(t2.$index(AEntidad, "descripcion")));
  t2 = new W._WrappedList(t1.get$_cells(tr));
  H.setRuntimeTypeInfo(t2, [W.TableCellElement]);
  t2 = t2._list;
  if (0 >= t2.length)
    throw H.ioore(t2, 0);
  J.add$1$ax(J.get$children$x(t2[0]), pInputDescripcion);
  t2 = new W._WrappedList(t1.get$_cells(tr));
  H.setRuntimeTypeInfo(t2, [W.TableCellElement]);
  t2 = t2._list;
  if (1 >= t2.length)
  ...
  if (1 >= t1.length)
    throw H.ioore(t1, 1);
  J.add$1$ax(J.get$children$x(t1[1]), pInputDescripcion);
  pInputProducto.focus();
  t3.select$0(pInputProducto);
},

eliminarEntidad: function(AId) {
  var t1, pLinea;
  if (window.confirm("\u00bfEliminar L\u00ednea?") === true) {
    t1 = J.where$1$ax($.get$pLista(), new Q.eliminarEntidad_closure(AId));
    pLinea = t1.get$first(t1);
    t1 = J.getInterceptor$ax(pLinea);
    t1.$indexSet(pLinea, "deleted", true);
    t1.$indexSet(pLinea, "dirty", true);
    J.remove$0$ax(document.querySelector("#tr" + H.S(J.toString$0(AId))));
  }
},

puedeAgregarEntidad: function(AId) {
  var t1, pProducto, pNombre;
  t1 = J.getInterceptor$n(AId);
  pProducto = t1.$gt(AId, 0) ? t1.toString$0(AId) : "";
  pNombre = H.interceptedTypeCast(document.querySelector("#inpDescripcion" + H.S(pProducto)), "$isInputElement").value;
  if (J.trim$0$s(pNombre).length === 0) {
    H.interceptedTypeCast(document.querySelector("#inpProducto" + pNombre), "$isInputElement").focus();
    return "El producto no puede estar vac\u00edo";
  }
  return "";
},

obtenerEntidad: function(AId) {
  var t1 = J.where$1$ax($.get$pLista(), new Q.obtenerEntidad_closure(AId));
  return t1.get$first(t1);
},

editarEntidad: function(AId) {
  var puedeAgregar, t1, pProducto, pDescripcion, pEntidad, t2, tr;
  puedeAgregar = Q.puedeAgregarEntidad(AId);
  if (puedeAgregar.length === 0) {
    t1 = J.getInterceptor(AId);
    pProducto = H.interceptedTypeCast(document.querySelector("#inpProducto" + H.S(t1.toString$0(AId))), "$isInputElement").value;
    pDescripcion = H.interceptedTypeCast(document.querySelector("#inpDescripcion" + H.S(t1.toString$0(AId))), "$isInputElement").value;
    pEntidad = Q.obtenerEntidad(AId);
    t2 = J.getInterceptor$ax(pEntidad);
    t2.$indexSet(pEntidad, "producto", pProducto);
    t2.$indexSet(pEntidad, "descripcion", pDescripcion);
    t2.$indexSet(pEntidad, "dirty", true);
    t2.$indexSet(pEntidad, "deleted", false);
    tr = document.querySelector("#tr" + H.S(t1.toString$0(AId)));
    t1 = J.getInterceptor$x(tr);
    t2 = t1.get$cells(tr)._list;
    if (0 >= t2.length)
      throw H.ioore(t2, 0);
    J.clear$0$ax(J.get$children$x(t2[0]));
    t2 = new W._WrappedList(t1.get$_cells(tr));
    H.setRuntimeTypeInfo(t2, [W.TableCellElement]);
    t2 = t2._list;
    if (0 >= t2.length)
      throw H.ioore(t2, 0);
    t2[0].textContent = pProducto;
    t2 = new W._WrappedList(t1.get$_cells(tr));
    H.setRuntimeTypeInfo(t2, [W.TableCellElement]);
    t2 = t2._list;
    if (1 >= t2.length)
    ...
    if (1 >= t1.length)
      throw H.ioore(t1, 1);
    t1[1].textContent = pDescripcion;
    Q._togleButtons(AId);
  } else
    window.alert(puedeAgregar);
},

cancelarEdicion: function(AId) {
  var t1, pLinea, tr, t2, t3;
  t1 = J.where$1$ax($.get$pLista(), new Q.cancelarEdicion_closure(AId));
  pLinea = t1.get$first(t1);
  tr = document.querySelector("#tr" + H.S(J.toString$0(AId)));
  t1 = J.getInterceptor$x(tr);
  t2 = t1.get$cells(tr)._list;
  if (0 >= t2.length)
    throw H.ioore(t2, 0);
  ...
  if (0 >= t2.length)
    throw H.ioore(t2, 0);
  t3 = J.getInterceptor$asx(pLinea);
  t2[0].textContent = t3.$index(pLinea, "producto");
  t2 = new W._WrappedList(t1.get$_cells(tr));
  H.setRuntimeTypeInfo(t2, [W.TableCellElement]);
  t2 = t2._list;
  if (1 >= t2.length)
  ...
  if (1 >= t1.length)
    throw H.ioore(t1, 1);
  t1[1].textContent = t3.$index(pLinea, "descripcion");
  Q._togleButtons(AId);
},

agregaFila: function(AEntidad, AAppend) {
  var t1, tableLista, tr, td, t2, t3, btn, t4;
  t1 = J.getInterceptor$ax(AEntidad);
  t1.$indexSet(AEntidad, "dirty", true);
  tableLista = document.querySelector("#gridLista");
  tr = document.createElement("tr", null);
  tr.id = "tr" + H.S(J.toString$0(t1.$index(AEntidad, "id")));
  td = document.createElement("td", null);
  td.textContent = t1.$index(AEntidad, "producto");
  t2 = J.getInterceptor$x(tr);
  t3 = t2.get$children(tr);
  t3.add$1(t3, td);
  td = document.createElement("td", null);
  td.textContent = t1.$index(AEntidad, "descripcion");
  t3 = t2.get$children(tr);
  t3.add$1(t3, td);
  btn = W.Element_Element$html("<button class='btn'><i class='icon-edit'></i></button>", null, null);
  t3 = J.getInterceptor$x(btn);
  t3.set$id(btn, "btnEditar" + H.S(J.toString$0(t1.$index(AEntidad, "id"))));
  t3.get$onClick(btn).listen$1(new Q.agregaFila_closure(AEntidad));
  td = document.createElement("td", null);
  t3 = J.getInterceptor$x(td);
  t4 = t3.get$children(td);
  t4.add$1(t4, btn);
  btn = W.Element_Element$html("<button class='btn edit_btn'><i class='icon-trash'></i></button>", null, null);
  t4 = J.getInterceptor$x(btn);
  t4.set$id(btn, "btnEliminar" + H.S(J.toString$0(t1.$index(AEntidad, "id"))));
  t4.get$onClick(btn).listen$1(new Q.agregaFila_closure0(AEntidad));
  t4 = t3.get$children(td);
  t4.add$1(t4, btn);
  btn = W.Element_Element$html("<button class='btn oculto'><i class='icon-ok'></i></button>", null, null);
  t4 = J.getInterceptor$x(btn);
  t4.set$id(btn, "btnAceptar" + H.S(J.toString$0(t1.$index(AEntidad, "id"))));
  t4.get$onClick(btn).listen$1(new Q.agregaFila_closure1(AEntidad));
  t4 = t3.get$children(td);
  t4.add$1(t4, btn);
  btn = W.Element_Element$html("<button class='btn oculto edit_btn'><i class='icon-remove'></i></button>", null, null);
  t4 = J.getInterceptor$x(btn);
  t4.set$id(btn, "btnCancelar" + H.S(J.toString$0(t1.$index(AEntidad, "id"))));
  t4.get$onClick(btn).listen$1(new Q.agregaFila_closure2(AEntidad));
  t3 = t3.get$children(td);
  t3.add$1(t3, btn);
  t2 = t2.get$children(tr);
  t2.add$1(t2, td);
  t1 = J.getInterceptor$x(tableLista);
  if (AAppend) {
    t1 = t1.get$tBodies(tableLista)._list;
    if (0 >= t1.length)
      throw H.ioore(t1, 0);
    ...
    if (0 >= t1.length)
      throw H.ioore(t1, 0);
    J.insert$2$ax(J.get$children$x(t1[0]), 0, tr);
  }
},

onClaveBlur: function() {
  var pClave = H.interceptedTypeCast(document.querySelector("#inpClave"), "$isInputElement").value;
  if (J.trim$0$s(pClave).length > 0)
    W.HttpRequest_getString("/rest/productos/obtener_descripcion/" + pClave, null, null).then$1(new Q.onClaveBlur_closure());
},

onProductoBlur: function() {
  var pClave = H.interceptedTypeCast(document.querySelector("#inpProducto"), "$isInputElement").value;
  if (J.trim$0$s(pClave).length > 0)
    W.HttpRequest_getString("/rest/productos/obtener_descripcion/" + pClave, null, null).then$1(new Q.onProductoBlur_closure());
},

onEditProductoBlur: function(AId) {
  var t1, pClave;
  t1 = "#inpProducto" + H.S(AId);
  pClave = H.interceptedTypeCast(document.querySelector(t1), "$isInputElement").value;
  if (J.trim$0$s(pClave).length > 0)
    W.HttpRequest_getString("/rest/productos/obtener_descripcion/" + pClave, null, null).then$1(new Q.onEditProductoBlur_closure(AId));
},

ObtenerEntidad: function() {
  var pFolio, pEntidad, t1;
  pFolio = J.get$value$x(H.interceptedTypeCast(document.querySelector("#inpFolio"), "$isHiddenInputElement"));
  pEntidad = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
  pEntidad.$indexSet(pEntidad, "id", pFolio);
  pEntidad.$indexSet(pEntidad, "producto", H.interceptedTypeCast(document.querySelector("#inpClave"), "$isInputElement").value);
  pEntidad.$indexSet(pEntidad, "activo", H.interceptedTypeCast(document.querySelector("#inpActivo"), "$isSelectElement").value);
  t1 = J.where$1$ax($.get$pLista(), new Q.ObtenerEntidad_closure());
  pEntidad.$indexSet(pEntidad, "detalle", t1.toList$0(t1));
  return pEntidad;
},

aceptar: function() {
  var pEntidad, pUrlExiste;
  H.interceptedTypeCast(document.querySelector("#btnAceptar"), "$isButtonElement").disabled = true;
  pEntidad = Q.ObtenerEntidad();
  pUrlExiste = "/rest/existe_sobrantes_producto/" + H.S(pEntidad.$index(pEntidad, "producto"));
  P.print(pUrlExiste);
  W.HttpRequest_getString(pUrlExiste, null, null).then$1(new Q.aceptar_closure(pEntidad));
},

despliegaEntidad: function(AEntidad) {
  var t1, item, t2;
  t1 = J.getInterceptor$asx(AEntidad);
  H.interceptedTypeCast(document.querySelector("#inpClave"), "$isInputElement").value = t1.$index(AEntidad, "producto");
  H.interceptedTypeCast(document.querySelector("#inpDescripcionM"), "$isInputElement").value = t1.$index(AEntidad, "descripcion");
  H.interceptedTypeCast(document.querySelector("#inpActivo"), "$isSelectElement").value = t1.$index(AEntidad, "activo");
  for (t1 = J.get$iterator$ax(t1.$index(AEntidad, "detalle")); t1.moveNext$0();) {
    item = t1.get$current();
    t2 = J.getInterceptor$ax(item);
    t2.$indexSet(item, "dirty", false);
    t2.$indexSet(item, "deleted", false);
    Q.agregaFila(item, true);
  }
},

inicializa: function() {
  var pFolio, pInpClave, t1, t2, t3, pInpProducto, btnAgregar, btnAceptar, btnCancelar;
  pFolio = J.get$value$x(H.interceptedTypeCast(document.querySelector("#inpFolio"), "$isHiddenInputElement"));
  if (J.$gt$n(H.Primitives_parseInt(pFolio, null, null), 0))
    H.interceptedTypeCast(document.querySelector("#inpClave"), "$isInputElement").readOnly = true;
  W.HttpRequest_getString("/rest/sobrantes/" + pFolio, null, null).then$1(new Q.inicializa_closure());
  pInpClave = H.interceptedTypeCast(document.querySelector("#inpClave"), "$isInputElement");
  pInpClave.toString;
  t1 = C.EventStreamProvider_blur._eventType;
  t2 = new W._ElementEventStreamImpl(pInpClave, t1, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Q.inicializa_closure0()), t2._useCapture);
  H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t3._tryResume$0();
  pInpProducto = H.interceptedTypeCast(document.querySelector("#inpProducto"), "$isInputElement");
  pInpProducto.toString;
  t1 = new W._ElementEventStreamImpl(pInpProducto, t1, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Q.inicializa_closure1()), t1._useCapture);
  H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t3._tryResume$0();
  btnAgregar = H.interceptedTypeCast(document.querySelector("#btnAgregar"), "$isButtonElement");
  btnAgregar.toString;
  t3 = C.EventStreamProvider_click._eventType;
  t1 = new W._ElementEventStreamImpl(btnAgregar, t3, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Q.inicializa_closure2()), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
  btnAceptar = document.querySelector("#btnAceptar");
  btnAceptar.toString;
  t2 = new W._ElementEventStreamImpl(btnAceptar, t3, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Q.inicializa_closure3()), t2._useCapture);
  H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t1._tryResume$0();
  btnCancelar = document.querySelector("#btnCancelar");
  btnCancelar.toString;
  t3 = new W._ElementEventStreamImpl(btnCancelar, t3, false);
  H.setRuntimeTypeInfo(t3, [null]);
  t1 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new Q.inicializa_closure4()), t3._useCapture);
...
editEntidad_closure: {"": "Closure;AEntidad_0",
  call$1: function(_) {
    Q.onEditProductoBlur(J.$index$asx(this.AEntidad_0, "id"));
  }
},

eliminarEntidad_closure: {"": "Closure;AId_0",
  call$1: function(item) {
    return J.$eq(J.$index$asx(item, "id"), this.AId_0);
  }
},

obtenerEntidad_closure: {"": "Closure;AId_0",
  call$1: function(item) {
    return J.$eq(J.$index$asx(item, "id"), this.AId_0);
  }
},

cancelarEdicion_closure: {"": "Closure;AId_0",
  call$1: function(item) {
    return J.$eq(J.$index$asx(item, "id"), this.AId_0);
  }
},

agregaFila_closure: {"": "Closure;AEntidad_0",
  call$1: function(_) {
    Q.editEntidad(this.AEntidad_0);
  }
},

agregaFila_closure0: {"": "Closure;AEntidad_1",
  call$1: function(_) {
    Q.eliminarEntidad(J.$index$asx(this.AEntidad_1, "id"));
  }
},

agregaFila_closure1: {"": "Closure;AEntidad_2",
  call$1: function(_) {
    Q.editarEntidad(J.$index$asx(this.AEntidad_2, "id"));
  }
},

agregaFila_closure2: {"": "Closure;AEntidad_3",
  call$1: function(_) {
    Q.cancelarEdicion(J.$index$asx(this.AEntidad_3, "id"));
  }
},

onClaveBlur_closure: {"": "Closure;",
  call$1: function(Data) {
    var pData = P._parseJson(Data, new P.JsonDecoder(null)._reviver);
    H.interceptedTypeCast(document.querySelector("#inpDescripcionM"), "$isInputElement").value = J.$index$asx(pData, "descripcion");
  }
},

onProductoBlur_closure: {"": "Closure;",
  call$1: function(Data) {
    var pData = P._parseJson(Data, new P.JsonDecoder(null)._reviver);
    H.interceptedTypeCast(document.querySelector("#inpDescripcion"), "$isInputElement").value = J.$index$asx(pData, "descripcion");
  }
},

onEditProductoBlur_closure: {"": "Closure;AId_0",
  call$1: function(Data) {
    var pData, t1;
    pData = P._parseJson(Data, new P.JsonDecoder(null)._reviver);
    t1 = "#inpDescripcion" + H.S(this.AId_0);
    H.interceptedTypeCast(document.querySelector(t1), "$isInputElement").value = J.$index$asx(pData, "descripcion");
  }
},

ObtenerEntidad_closure: {"": "Closure;",
  call$1: function(item) {
    return J.$eq(J.$index$asx(item, "dirty"), true);
  }
},

aceptar_closure: {"": "Closure;pEntidad_0",
  call$1: function(Data) {
    var pExiste, t1, pData;
    pExiste = P._parseJson(Data, new P.JsonDecoder(null)._reviver);
    t1 = this.pEntidad_0;
    if ((J.$gt$n(H.Primitives_parseInt(t1.$index(t1, "id"), null, null), 0) ? false : pExiste) === true) {
      window.alert("Ya existe sobrantes de este producto");
      H.interceptedTypeCast(document.querySelector("#btnAceptar"), "$isButtonElement").disabled = false;
      H.interceptedTypeCast(document.querySelector("#inpClave"), "$isInputElement").focus();
      return;
    } else {
      pData = P.stringify(t1, new P.JsonEncoder(null)._toEncodableFunction);
      P.print(pData);
      W.HttpRequest_request("/rest/sobrantes/insertar", "POST", "application/json", new Q.aceptar__closure(), null, null, pData, null).then$1(new Q.aceptar__closure0());
    }
  }
},

aceptar__closure: {"": "Closure;",
  call$1: function(e) {
  }
},

aceptar__closure0: {"": "Closure;",
  call$1: function(ARequest) {
    var pSobrante = P._parseJson(J.get$responseText$x(ARequest), new P.JsonDecoder(null)._reviver);
    window.alert("Se guardo con \u00e9xito, folio " + H.S(J.$index$asx(pSobrante, "id")));
    J.set$href$x(C.Window_methods.get$location(window), "/sobrantes");
  }
},

inicializa_closure: {"": "Closure;",
  call$1: function(Data) {
    $._Entidad = P._parseJson(Data, new P.JsonDecoder(null)._reviver);
    $.pLista = J.$index$asx($._Entidad, "detalle");
    Q.despliegaEntidad($._Entidad);
  }
},

inicializa_closure0: {"": "Closure;",
  call$1: function(_) {
    Q.onClaveBlur();
  }
},

inicializa_closure1: {"": "Closure;",
  call$1: function(_) {
    Q.onProductoBlur();
  }
},

inicializa_closure2: {"": "Closure;",
  call$1: function(_) {
    var pData = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
    pData.$indexSet(pData, "id", $.pId);
    $.pId = $.pId + 1;
    pData.$indexSet(pData, "producto", H.interceptedTypeCast(document.querySelector("#inpProducto"), "$isInputElement").value);
    pData.$indexSet(pData, "descripcion", H.interceptedTypeCast(document.querySelector("#inpDescripcion"), "$isInputElement").value);
    Q.agregaFila(pData, true);
    H.interceptedTypeCast(document.querySelector("#inpProducto"), "$isInputElement").value = "";
    H.interceptedTypeCast(document.querySelector("#inpDescripcion"), "$isInputElement").value = "";
    H.interceptedTypeCast(document.querySelector("#inpProducto"), "$isInputElement").focus();
    J.add$1$ax($.get$pLista(), pData);
  }
},

inicializa_closure3: {"": "Closure;",
  call$1: function(e) {
    Q.aceptar();
  }
},

inicializa_closure4: {"": "Closure;",
  call$1: function(e) {
...
Isolate.$lazy($, "pLista", "pLista", "get$pLista", function() {
  var t1 = P.List_List(null, P.Map);
  H.setRuntimeTypeInfo(t1, [P.Map]);
  return t1;
});
// Native classes
J.Interceptor["%"] = "DOMError|DOMImplementation|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedNumberList";
...
//# sourceMappingURL=detalle_sobrantes.dart.js.map
//@ sourceMappingURL=detalle_sobrantes.dart.js.map
