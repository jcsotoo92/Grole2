...
["dart.async", "dart:async", , P, {
  ...
  Future_Future$delayed_closure: {
    "^": "Closure:11;computation_0,result_1",
    call$0: function() {
      var e, s, exception, t1;
      try {
        this.result_1._complete$1(null);
      } catch (exception) {
        t1 = H.unwrapException(exception);
        e = t1;
        s = new H._StackTrace(exception, null);
...
["dart.dom.html", "dart:html", , W, {
  ...
  HttpRequest_request: function(url, method, mimeType, onProgress, requestHeaders, responseType, sendData, withCredentials) {
    ...
    t1 = new W._EventStream(xhr, "load", false);
    t1.$builtinTypeInfo = [null];
    t3 = new W._EventStreamSubscription(0, xhr, "load", W._wrapZone(new W.HttpRequest_request_closure0(completer, xhr)), false);
    t3.$builtinTypeInfo = [H.getTypeArgumentByIndex(t1, 0)];
    t1 = t3._onData;
    t4 = t1 != null;
    if (t4 && t3._pauseCount <= 0) {
      t3 = t3._target;
      t3.toString;
      if (t4)
        J._addEventListener$3$x(t3, "load", t1, false);
    }
    t1 = new W._EventStream(xhr, "error", false);
    t1.$builtinTypeInfo = [null];
    ...
    if (t4 && t3._pauseCount <= 0) {
      ...
      t3.toString;
      if (t4)
        J._addEventListener$3$x(t3, "error", t1, false);
    }
    if (sendData != null)
      xhr.send(sendData);
    else
...
["intl", "package:intl/intl.dart", , T, {
  ...
  DateFormat: {
    ...
    format$1: function(_, date) {
      ...
      J.forEach$1$ax(t1, new T.DateFormat_format_closure(date, result));
      t1 = result._contents;
      return t1.charCodeAt(0) == 0 ? t1 : t1;
    },
  ...
  NumberFormat: {
    ...
    format$1: function(_, number) {
      ...
      if (number == Infinity || number == -Infinity)
        return H.S(C.JSNumber_methods.get$isNegative(number) ? this._negativePrefix : this._positivePrefix) + this._symbols.INFINITY;
  ...
  _NumberFormatParser: {
    ...
    parse$0: function() {
      var t1, trunk, t2, t3, t4, t5, t6, t7, t8, each;
      t1 = this.format;
      ...
      if (J.$eq(t3 ? J.$index$asx(t2.input, t2.index) : null, ";")) {
        ...
        t4 = J.getInterceptor$asx(trunk);
        t5 = t2.input;
        t6 = J.getInterceptor$asx(t5);
        while (true) {
          t7 = ++t3.index;
          if (t7 >= 0) {
            t8 = t4.get$length(trunk);
            if (typeof t8 !== "number")
              return H.iae(t8);
            t8 = t7 < t8;
            t7 = t8;
          ...
          if (t7 >= 0) {
            ...
            t7 = false;
          each = t7 ? t4.$index(trunk, t3.index) : null;
          t7 = t2.index;
          if (t7 >= 0) {
            t8 = t6.get$length(t5);
            if (typeof t8 !== "number")
            ...
            t7 = false;
          if (!J.$eq(t7 ? t6.$index(t5, t2.index) : null, each)) {
            t7 = t2.index;
            if (t7 >= 0) {
              t8 = t6.get$length(t5);
              if (typeof t8 !== "number")
              ...
              t7 = false;
            t8 = (t7 ? t6.$index(t5, t2.index) : null) != null;
            t7 = t8;
          } else
            t7 = false;
          if (t7)
        ...
        t1._negativePrefix = J.$add$ns(t1._positivePrefix, t1._negativePrefix);
        t1._negativeSuffix = J.$add$ns(t1._negativeSuffix, t1._positiveSuffix);
      }
    },
    ...
    _parseTrunk$0: function() {
      ...
      if (!(J.$lt$n(this.decimalPos, 0) && J.$gt$n(this.digitRightCount, 0))) {
        ...
        t1 = true;
      if (t1)
        throw H.wrapException(P.FormatException$("Malformed pattern \"" + H.S(t2) + "\"", null, null));
      ...
      switch (ch) {
        ...
        case "0":
          if (J.$gt$n(this.digitRightCount, 0))
            throw H.wrapException(P.FormatException$(C.JSString_methods.$add("Unexpected \"0\" in pattern \"", t1.input) + "\"", null, null));
          t2 = this.zeroDigitCount;
          if (typeof t2 !== "number")
            return t2.$add();
...
["", "surtir_orden.dart", , A, {
  ...
  agregaFilaMPrima: function(item) {
    var tableMP, tr, td, t1, btn, t2, t3, t4, t5, t6;
  ...
  agregaFilaProducido: function(item) {
    var tableMP, tr, td, t1, pCajas, t2, t3, t4, t5, t6, pValorRescate, btn;
    ...
    t1.get$children(tr).add$1(0, td);
    pValorRescate = W.Element_Element$html("<a href=\"#\">" + H.S(T.NumberFormat_NumberFormat("#,##0.00", null).format$1(0, item.valor_rescate)) + "</a>", null, null);
  ...
  guardar: function() {
    ...
    if (J.$eq($.get$POrdenProduccion().estado, "Surtido"))
      ...
      pParametros.$indexSet(0, "id_usuario_embarques", H.interceptedTypeCast(document.querySelector("#id_usuario_embarques"), "$isHiddenInputElement").value);
  ...
  agregarFilaDetalleTarima: function(item) {
    var tableDetalleTarima, tr, td, t1, anchorCajas, t2, t3, t4, t5, t6;
  ...
  ActualizaSaldosSap: function() {
    ...
    if (window.confirm("\u00bfActualizar saldos?") === true)
      for (t1 = $.get$ListaOrdenPMP(), t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
        ...
        H.printString(pUrl);
        W.HttpRequest_getString(pUrl, null, null).then$1(new A.ActualizaSaldosSap_closure(item));
      }
  },
  ActualizaCostoSap: function() {
    var t1, pUrl, item, pUrlCosto;
    for (t1 = $.get$ListaOrdenPMP(), t1 = new H.ListIterator(t1, t1.length, 0, null), pUrl = ""; t1.moveNext$0();) {
      ...
      if (J.$gt$n(item.get$surtido(), 0)) {
        ...
        H.printString(pUrl);
        W.HttpRequest_getString(pUrl, null, null).then$1(new A.ActualizaCostoSap_closure(item));
      }
    }
  ...
  main: [function() {
    var t1, anchorDetalleOrdenTarima, anchorSaldoSap;
    $.editable = H.interceptedTypeCast(document.querySelector("#inpEditable"), "$isHiddenInputElement").value === "true";
    ...
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(anchorDetalleOrdenTarima, "click", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new A.main_closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onClick$x(document.querySelector("#btnCerrarDetalleTarima"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new A.main_closure1()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onClick$x(document.querySelector("#cerrarDetalladoCajaTarima"));
    ...
    t1 = J.get$onClick$x(document.querySelector("#btnImprimir"));
    ...
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(anchorSaldoSap, "click", false), [null]);
  ...
  ObtenerOrdenProduccion__closure0: {
    ...
    call$1: function(Data) {
      ...
      if (J.$gt$n($.get$POrdenProduccion().costo_salida, 0)) {
        ...
        pUrlCosto = "http://192.168.0.11/WebFrontEnd/inventarios/ObtenerCostoSalida?Orden=" + H.S(J.toString$0($.IdOrden)) + "&Cuenta=11100030001&Empresa=SolesProd";
        P.print(pUrlCosto);
        W.HttpRequest_getString(pUrlCosto, null, null).then$1(new A.ObtenerOrdenProduccion___closure2());
      }
  ...
  ObtenerOrdenProduccion___closure2: {
    "^": "Closure:0;",
    call$1: function(Data) {
  ...
  ObtenerOrdenProduccion__closure2: {
    "^": "Closure:0;pUrl_2",
    call$1: function(Data) {
      W.HttpRequest_getString(this.pUrl_2, null, null).then$1(new A.ObtenerOrdenProduccion___closure1());
    }
  },
  ...
  ObtenerOrdenProduccion_closure1: {
    "^": "Closure:0;box_1,AId_3",
    call$1: function(Data) {
      var pUrl = "/rest/ordenp/obtener_producido_orden/" + H.S(this.AId_3);
      this.box_1.pUrl_1 = pUrl;
  ...
  ObtenerOrdenProduccion__closure: {
    "^": "Closure:0;",
    call$1: function(Data) {
      var t1, item, pLista, t2, pProduccion, t3, t4, t5, t6, pUrl, pData, headers, exception;
      t1 = {};
      P.print("Producido");
      P.print(Data);
      pLista = C.JsonCodec_null_null.decode$1(Data);
      t1.pTotalProducido_0 = 0;
      for (t2 = J.get$iterator$ax(pLista); t2.moveNext$0();) {
        ...
        if (t3 > 0) {
          ...
          headers = P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, P.String);
          headers.$indexSet(0, "content-type", "application/x-www-form-urlencoded");
          W.HttpRequest_request(pUrl, "POST", null, null, headers, "application/json", pData, null).then$1(new A.ObtenerOrdenProduccion___closure());
        }
      }
      P.Future_Future$delayed(P.Duration$(0, 0, 0, 0, 0, 1), null, null).then$1(new A.ObtenerOrdenProduccion___closure0(t1, pLista));
  ...
  ObtenerOrdenProduccion___closure0: {
    "^": "Closure:13;box_0,pLista_4",
    call$1: function(_) {
      var t1, t2, pProduccion, t3, t4;
      for (t1 = J.get$iterator$ax(this.pLista_4), t2 = this.box_0; t1.moveNext$0();) {
        pProduccion = M.Produccion$fromMap(t1.get$current());
        t3 = $.pTotalImporteMaquila;
        t4 = $.pTotalImporte;
        if (typeof t4 !== "number")
          return H.iae(t4);
        t4 = (t3 + t4 - $.pTotalImporteRescate) / t2.pTotalProducido_0;
        pProduccion.costo_pto_terminado = t4;
        pProduccion.importe = pProduccion.producido * t4;
